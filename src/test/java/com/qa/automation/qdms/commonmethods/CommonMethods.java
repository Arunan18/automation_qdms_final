...
//	String excelPath = "C:\\Users\\volta\\Documents\\Excel.xlsx";
//	String pageName = "Unit";
//	String testCaseID = "TC-UNIT-0021";
//
//	int x = getFirstRowNum(excelPath, pageName, testCaseID);
//	System.out.println(x);
//
//}

	public static void print(String TestCaseName, boolean test) {
		ExtentTest testCase = extent.createTest(TestCaseName);
		if (test == true) {
			testCase.log(Status.INFO, "Correctly Shown ✅");
			testCase.log(Status.PASS, "TEST PASS ✅");
		} else {
			testCase.log(Status.INFO, "TEST FAIL ✅");
			testCase.log(Status.FAIL, "TEST FAIL ✅");
		}
	}
	...
	public static void print(String TestCaseName) {
		...
		testCase.log(Status.INFO, "TEST PASS ✅");
