...
public class EditRoleCloseIconFunctionality extends DriverIntialization {
	...
	public static void addRoleFunctionality() throws InterruptedException {
		...
		if (MasterMainNavigationsTest.clickEmployeeMain) {
			...
			materialMethodes.cancelOrCloseButtonFunction(RolePage.editCloseIcon, RolePage.editPopUP,
