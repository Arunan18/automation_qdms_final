...
* Description
*------------
* Check edit Pnt Equipment Close Button Functionality
***********************************************************************************
*
* Author           :RAHUL.S
...
public class PlantEquipmentEditCloseButtonFunction extends DriverIntialization{
	...
	public static void deleteCancel() {
		...
		testCase = extent.createTest("TC-PLA-EQU-0095--Check edit Plant Equipment Cancel Button Functionality");
		LoginTest.Login();
		if (LoginTest.login) {
		...
		if (MasterMainNavigationsTest.plntEquipmentclick) {
			...
			ActionCommonMethod.actionS(3, 10, PlantEquipmentPage.equipmentTable, "edit", "Master Module.xlsx",
					"Plant Equipment", "TC-PLA-EQU-0095-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(PlantEquipmentPage.closebutton,
					PlantEquipmentPage.editpopup, "CHECKING THE edit CANCEL BUTTON", "CHECKING THE POPUP");
