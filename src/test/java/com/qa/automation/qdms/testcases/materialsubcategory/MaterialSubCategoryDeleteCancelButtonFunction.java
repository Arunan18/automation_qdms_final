...
* Description
*------------
* TC-MATSC-0059--Check Delete Material Sub Category Cancel Button Functionality
***********************************************************************************
*
* Author           :RAHUL.S
...
public class MaterialSubCategoryDeleteCancelButtonFunction extends DriverIntialization {
	...
	public static void deleteCancel() throws InterruptedException {
		...
		testCase = extent.createTest("TC-MATSC-0059--Check Delete Material Sub Category Cancel Button Functionality");
		LoginTest.Login();
		if (LoginTest.login) {
		...
		if (MasterMainNavigationsTest.clicksubCategory) {
			...
			ActionCommonMethod.actionS(2, 5, MaterialSubCategoryPage.materialSubTable, "delete", "Master Module.xlsx",
					"Material Sub Category", "TC-MATSC-0059-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(MaterialSubCategoryPage.deleteCancelButton,
					MaterialSubCategoryPage.deletePopUP, "CHECKING THE DELETE CANCEL BUTTON", "CHECKING THE POPUP");
