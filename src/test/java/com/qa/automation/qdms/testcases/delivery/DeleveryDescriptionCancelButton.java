...
//* Description
//*------------
//*Check "Description" Cancel button Functionality
//***********************************************************************************
//*
//* Author           : Quenthan
...
public class DeleveryDescriptionCancelButton extends DriverIntialization {
@Test
	...
	PageFactory.initElements(driver, aa);
		...
		extent.createTest("TC-DEL-0025:- Check Description Cancel button Functionality");
			LoginTest.Login();  
			contnew=true;
			if (LoginTest.login) {
				...
				if (MasterMainNavigationsTest.clickMaster) {
					...
					if (MasterMainNavigationsTest.clickCustomermain) {
						...
						if (MasterMainNavigationsTest.clickDelivery) {
							PlantEquipmentAddMethods.dataFromPlanEqupment("Delivery", "TC-DEL-0025-01");	
							...
							if (SelectDate.clickDon) {
								...
								materialMethodes.cancelOrCloseButtonFunction(CustomerEditCancelButton.cancelbutton, CustomerEditCancelButton.Modal, 
										"Delivery Description Cancel Button", "Delivery Description");
							}	
