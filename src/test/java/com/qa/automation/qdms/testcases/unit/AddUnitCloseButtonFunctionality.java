...
//* Description
//*------------
//* Add Unit Pop up close Button Functionality 
//* 
//*************************************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-UNIT-0026          26/07/2023   Priyanka     Original
//*************************************************************************************************
...
public class AddUnitCloseButtonFunctionality extends DriverIntialization {
	...
	public static void AddcancleButton() throws InterruptedException {
		...
		if (addbutton) {
			...
			materialMethodes.cancelOrCloseButtonFunction(UnitPage.UnitCloseButton, UnitPage.editpopup,
