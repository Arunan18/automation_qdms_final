...
* ================================================================================================================
*  (9) 	  	          TC-MAT-0107		   	  26/07/2023         Jathu Jana   	   		Original Version
******************************************************************************************************************/
...
public class AddMaterialCancelButtonFunctionality extends DriverIntialization{
...
//			CHECKING ADD MATERIAL CANCEL BUTTON FUNCTIONALITY
			functionality.checkingCancelOrCloseFunctionanlity("➢ Checking Add Material Cancel Button Functionality ",
					MaterialPage.popUpModelFirstButton ,MaterialPage.popUpModel);
