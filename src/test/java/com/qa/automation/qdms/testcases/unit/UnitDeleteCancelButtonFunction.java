...
* Description
*------------
*TC-UNIT-0038--Check Delete Unit "Cancel" Button Functionality
...
public class UnitDeleteCancelButtonFunction extends DriverIntialization {
	...
	public static void deleteCancel() throws InterruptedException {
		...
		if (MasterMainNavigationsTest.clickUnit) {
			...
			ActionCommonMethod.actionS(0, 1, UnitPage.unitTable, "delete", "Master Module.xlsx", "Unit",
					"TC-UNIT-0038-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(UnitPage.deleteCancelButton, UnitPage.deletePopUP,
