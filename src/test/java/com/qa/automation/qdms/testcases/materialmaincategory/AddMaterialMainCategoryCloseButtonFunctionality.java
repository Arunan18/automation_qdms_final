...
* DESCRIPTION
*-----------------------------------------------------------------------------------------------------------------
* Checking Add Material Main Category Close Button Functionality
******************************************************************************************************************
*
* @author 	 : 	Jathu Jana
* 
...
* ================================================================================================================
*  (6) 	  	  		 TC-MATMC-0067		      	  26/07/2023	  	Jathu Jana		Original Version
******************************************************************************************************************/
...
public class AddMaterialMainCategoryCloseButtonFunctionality extends DriverIntialization{
...
//			CHECKING ADD MATERIAL MAIN CATEGORY CLOSE BUTTON FUNCTIONALITY
			functionality.checkingCancelOrCloseFunctionanlity("➢ Checking Add Material Main Category Close Button Functionality ",
					MaterialMainCategoryPage.popUpModelCloseButton ,MaterialMainCategoryPage.popUpModel);
