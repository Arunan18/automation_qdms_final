...
* Description
*------------
*TC-SUPCAT-0045--Check edit Supplier Category Cancel Button Functionality
...
public class EditCancelButtonFunction extends DriverIntialization {
	...
	public static void deleteCancel() throws InterruptedException {
		...
		if (MasterMainNavigationsTest.mainSupplierCategory) {
			...
			ActionCommonMethod.actionS(0, 2, SupplierCategoryPage.supplierCatTable, "edit", "Master Module.xlsx", "Supplier Category",
					"TC-SUPCAT-0045-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(SupplierCategoryPage.cancelbuttonedit, SupplierCategoryPage.editpopup,
