...
//* ================       ====         =====        ========
//*  TC-PLA-EQU-0037     03/04/2023   kajan     rework Version
//*  TC-PLA-EQU-0032     17/07/2023   Priyanka     Updated
//*  TC-PLA-EQU-0033        
//*  TC-PLA-EQU-0034       
//************************************************************************************
...
public class CheckingPlantEquipmentFieldSearchFunctionalityinFirstPageSerialNo extends DriverIntialization {

	PlantEquipmentPage plantEquipment = new PlantEquipmentPage();

	@Test
	public void SearchFunctionalityinSerialNo() throws InterruptedException, IOException {
		...
		if (MasterMainNavigationsTest.plntEquipmentclick) {
			...
			PlantEquipmentAddMethods.dataFromPlanEqupment("Plant Equipment", "TC-PLA-EQU-0032-01");

			EquipmentSearchFuncation.singleSearchMethoid(PlantEquipmentPage.SearchBoxSerialNo, 4,
					PlantEquipmentAddMethods.equipData.get(0), "Serial No  Search Box",
