...
* Description
*------------
*TC-EMP-0101--Check Delete Employee "Cancel" Button Functionality
...
public class EmployeeDeleteCancelButtonFunction extends DriverIntialization {
	...
	public static void deleteCancel() throws InterruptedException {
		...
		testCase = extent.createTest("TC-EMP-0101	Check Delete Employee Cancel Button Functionality");
		LoginTest.Login();
		if (LoginTest.login) {
		...
		if (MasterMainNavigationsTest.clickEmployee) {
			...
			ActionCommonMethod.actionS(4, 9, EmployeePage.employeeTable, "delete", "Master Module.xlsx", "Employee",
					"TC-EMP-0101-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(EmployeePage.deleteCancelButton, EmployeePage.deletePopUP,
