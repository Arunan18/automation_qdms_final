...
* Description
*------------
* TC-MATSC-0059--Check  Material Sub Category edit Close Button Functionality
***********************************************************************************
*
* Author           :RAHUL.S
...
public class MaterialSubCategoryEditCloseBtnFunction extends DriverIntialization{
	...
	public static void deleteCancel() throws InterruptedException {
		...
		testCase = extent.createTest("TC-MATSC-0059--Check  Material Sub Category edit close Button Functionality");
		LoginTest.Login();
		if (LoginTest.login) {
