...
//* Description
//*------------
//* Add Plant Equipment Pop up close Button Functionality 
//* 
//*************************************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-PLA-EQU-0117         26/07/2023   Priyanka     Original
//*************************************************************************************************
...
public class AddPlantEquipmentCloseButtonFunction extends DriverIntialization {
	...
	public static void AddcloseButton() throws InterruptedException {
		...
		if (addbutton) {
			...
			materialMethodes.cancelOrCloseButtonFunction(PlantEquipmentPage.closebut, PlantEquipmentPage.editpopup,
					"ADD PLANT EQUIPMENT CLOSE BUTTON", "ADD PLANT EQUIPMENT POP UP ");
