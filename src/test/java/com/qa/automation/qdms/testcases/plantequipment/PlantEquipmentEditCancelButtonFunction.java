...
* Description
*------------
* Check edit Pnt Equipment Cancel Button Functionality
***********************************************************************************
*
* Author           :RAHUL.S
...
public class PlantEquipmentEditCancelButtonFunction extends DriverIntialization{
	...
	public static void deleteCancel() {
		...
		if (MasterMainNavigationsTest.plntEquipmentclick) {
			...
			materialMethodes.cancelOrCloseButtonFunction(PlantEquipmentPage.cancelbtn,
