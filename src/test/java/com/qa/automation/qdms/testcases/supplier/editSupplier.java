...
//* ================       ====         =====        ========
//*  TC-SUP-0074         30/03/2023   Arunan     Orginal Version
//*
//************************************************************************************
...
public class editSupplier extends DriverIntialization {
	...
	public static void supplierEditFunction() throws InterruptedException, IOException {
		...
		if (MasterMainNavigationsTest.supplierClick) {
			edit("Master Module", "Supplier", "TC-SUP-0074");
		}
...
//						Assert.assertEquals(SupplierPage.editModal.isDisplayed(), true);
				...
				if (updateBtnVisi) {
					...
					try {
						System.out.println(By.xpath("//tr[2][td[1][text()='" + editSupplier + "'] and td[2][text()='"
								+ editPlant + "'] and td[3][text()='" + editEmail + "'] and td[4][text()='"
								+ editContactNo + "'] and td[5][text()='" + editAddress + "']]"));
