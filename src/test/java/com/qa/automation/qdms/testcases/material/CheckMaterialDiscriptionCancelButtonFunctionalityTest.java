...
* Description
*------------
*TC-MAT-0163--Material discription Cancel Button Functionality
...
public class CheckMaterialDiscriptionCancelButtonFunctionalityTest extends DriverIntialization{
	...
	public static void deleteCancel() throws InterruptedException {
		...
		if (MasterMainNavigationsTest.clickMaterial) {
			...
			ActionCommonMethod.actionS(3, 12, MaterialPage.materialTable, "container", "Master Module.xlsx", "Material",
					"TC-MAT-0163-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(MaterialPage.materialDescriptionCloseBtn, MaterialPage.popUpModal,
					"CHECKING THE discription CANCEL BUTTON", "CHECKING THE POPUP");
