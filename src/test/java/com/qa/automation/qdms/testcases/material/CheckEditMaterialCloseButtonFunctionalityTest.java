...
public class CheckEditMaterialCloseButtonFunctionalityTest extends DriverIntialization{
	...
	public static void deleteCancel() throws InterruptedException {
		...
		testCase = extent.createTest("TC-MAT-0163--Material edit Close Button Functionality");
		LoginTest.Login();
		if (LoginTest.login) {
		...
		if (MasterMainNavigationsTest.clickMaterial) {
			...
			materialMethodes.cancelOrCloseButtonFunction(MaterialPage.materialEditCancalButton, MaterialPage.addMatrialPopUp,
					"CHECKING THE  Close BUTTON", "CHECKING THE POPUP");
