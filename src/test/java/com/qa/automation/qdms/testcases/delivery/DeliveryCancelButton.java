...
//* Description
//*------------
//*Check Edit Delivery "Cancel" Button Functionality
//***********************************************************************************
//*
//* Author           : Quenthan
...
public class DeliveryCancelButton extends DriverIntialization {
@Test
	...
	PageFactory.initElements(driver, aa);
		...
		extent.createTest("TC-DEL-0048:-Check Edit Delivery Cancel Button Functionality");
			LoginTest.Login();  
			contnew=true;
			if (LoginTest.login) {
						...
						if (MasterMainNavigationsTest.clickDelivery) {
							...
							if (SelectDate.clickDon) {
								...
								materialMethodes.cancelOrCloseButtonFunction(CustomerEditCancelButton.cancelbutton, CustomerEditCancelButton.Modal, 
										"Delivery Edit Cencal Button", "Delivery Edit");
							}	
