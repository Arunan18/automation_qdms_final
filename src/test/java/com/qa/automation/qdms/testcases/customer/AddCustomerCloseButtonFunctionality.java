...
//* Description
//*------------
//* Add Customer Pop up close Button Functionality 
//* 
//*************************************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-CUS-0076          26/07/2023   Priyanka     Original
//*************************************************************************************************
...
public class AddCustomerCloseButtonFunctionality extends DriverIntialization {
	...
	public static void addCancleButton() {
		...
		if (addbutton) {
			...
			materialMethodes.cancelOrCloseButtonFunction(CustomerPage.closebutton, CustomerPage.editpopup,
					"ADD CUSTOMER CLOSE BUTTON", "ADD CUSTOMER POP UP ");
