...
* Description
*------------
*TC-SUP-0082--Check Delete Supplier "Cancel" Button Functionality
...
* ================     ====         =====        ========
* TC-SUP-0082	     26/07/2023     RAHUL.S     ORIGINAL Version
...
public class SupplierDeleteCancelButtonFunction extends DriverIntialization {
	...
	public static void deleteCancel() throws InterruptedException {
		...
		if (MasterMainNavigationsTest.supplierClick) {
			...
			ActionCommonMethod.actionS(2, 7, SupplierPage.supplierTable, "delete", "Master Module.xlsx", "Supplier",
					"TC-SUP-0082-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(SupplierPage.deleteCancelButton, SupplierPage.deletePopUP,
