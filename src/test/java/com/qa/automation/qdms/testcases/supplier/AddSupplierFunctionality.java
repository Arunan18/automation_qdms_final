...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------------
* Checking Add Suppliear Functionality 
**********************************************************************************************************
*
* @author 	 : Jathu Jana
* 
...
* ========================================================================================================
*  (2) 	  	    TC-SUP-0064     	     30/03/2023	  	    Sayanthan		 Original Version
...
public class AddSupplierFunctionality extends DriverIntialization {
...
//		2.CHECKING FUNCTIONALITY MAIN METHOD
		CheckingAddSupplierFunctionalty("Master Module","Supplier","TC-SUP-0064");
...
//  	AFTER GET SUCCESS MESSAGE - STATUS
	 ...
	 * @throws InterruptedException
	 ******************************************************************************************************************************************/
	public static void addSupTableDataStatus(String  TestCase) throws InterruptedException {
		
//		POM INITIALIZATION
		PageFactory.initElements(driver, sp);
		
//		REPORT - PRINT TEST CASE NAME 
...
//		GET ALERT MESSAGE
		...
		if (functionality.compareData) {
			...
			try {
				...
				functionality.compareData("♦ Checking Plant Added In The table ", SupplierPage.tableFirstRowSecondData.getText(),plantData);
		...
		if (functionality.compareData) {
			...
			try {
				...
				functionality.compareData = false ;
				functionality.compareData("♦ Checking Email Added In The table ", SupplierPage.tableFirstRowThirdData.getText(),emailData);
		...
		if (functionality.compareData) {
			...
			try {
				...
				functionality.compareData = false ;
				functionality.compareData("♦ Checking Contact No Added In The table ", SupplierPage.tableFirstRowforthData.getText(),contactNoData);
		...
		if (functionality.compareData) {
			...
			try {
				functionality.compareData = false ;
				functionality.compareData("♦ Checking Address Added In The table ", SupplierPage.tableFirstRowFifthData.getText(),addressData);
...
//			CHECKING ADDED SUPPLIER STATUS
			addSupTableDataStatus("➢ Check Add Supplier Status in Table");
...
//		GET VALIDATION & PRINT REPORT
		...
		try {
			...
			testCase.log(Status.INFO, "Add Supplier Validation Message Shows : "+SupplierPage.popFirstValidation.getText());
...
//			IF SUPPLIER SAVED
	...
	/*******************************************************************************************************************************************
	 * @category MAIN METHOD FOR ADD SUPPLIER FUNCTIONALITY
	 * @param excelbook
	 * @param tabName
	 * @param testId
	 *******************************************************************************************************************************************/
	public static void CheckingAddSupplierFunctionalty(String excelbook , String tabName, String testId){
