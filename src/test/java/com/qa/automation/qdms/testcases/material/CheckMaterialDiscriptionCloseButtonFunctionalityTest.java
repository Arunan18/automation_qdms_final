...
* Description
*------------
*TC-MAT-0163--Material discription Close icon Button Functionality
...
public class CheckMaterialDiscriptionCloseButtonFunctionalityTest extends DriverIntialization{
	...
	public static void deleteCancel() throws InterruptedException {
		...
		if (MasterMainNavigationsTest.clickMaterial) {
			...
			ActionCommonMethod.actionS(3, 12, MaterialPage.materialTable, "container", "Master Module.xlsx", "Material",
					"TC-MAT-0163-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(MaterialPage.materialDescriptionCloseIcon, MaterialPage.popUpModal,
					"CHECKING THE discription Close icon BUTTON", "CHECKING THE POPUP");
