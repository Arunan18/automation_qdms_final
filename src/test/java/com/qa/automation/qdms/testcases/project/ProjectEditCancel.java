...
//* Description
//*------------
//* Check Edit Project "Cancel" Button Functionality
//***********************************************************************************
//*
//* Author           : Quenthan
...
public class ProjectEditCancel extends DriverIntialization{

@Test
public static void editcancelProject() throws InterruptedException {
...
extent.createTest("TC-PRO-0078:- Check Edit Project Cancel Button Functionality");
	LoginTest.Login();  
	contnew=true;
	if (LoginTest.login) {
				...
				if (MasterMainNavigationsTest.clickProject) {
					...
					if (SelectDate.clickDon) {
						...
						materialMethodes.cancelOrCloseButtonFunction(CustomerEditCancelButton.cancelbutton, CustomerEditCancelButton.Modal, 
								"Projectr Edit Cencal Button", "Projectr Edit");
					}
