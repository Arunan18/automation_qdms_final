...
//* Description
//*------------
//* Check Edit Employee Form Cancel Button Function
//***********************************************************************************
//*
//* Author           : Quenthan
...
public class EmployeeEditCancelButton extends DriverIntialization {
	@Test
	public static void editfuncationCancel() throws InterruptedException {
		...
		extent.createTest("TC-EMP-0095:-Check Edit Employee Form Cancel Button Function");
			LoginTest.Login();  
			contnew=true;
			if (LoginTest.login) {
						...
						if (MasterMainNavigationsTest.clickEmployee) 
						{
							...
							if (SelectDate.clickDon) {
								...
								materialMethodes.cancelOrCloseButtonFunction(CustomerEditCancelButton.cancelbutton, CustomerEditCancelButton.Modal, 
										"Employee Edit Cancel Button", "Employee Edit");}
