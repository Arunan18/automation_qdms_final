...
* Description
*------------
*TC-MAT-0163--Material Delete Cancel Button Functionality
...
public class MaterialDeleteCancelButtonFunction extends DriverIntialization {
	...
	public static void deleteCancel() throws InterruptedException {
		...
		testCase = extent.createTest("TC-MAT-0163--Material Delete Cancel Button Functionality");
		LoginTest.Login();
		if (LoginTest.login) {
		...
		if (MasterMainNavigationsTest.clickMaterial) {
			...
			ActionCommonMethod.actionS(3, 12, MaterialPage.materialTable, "delete", "Master Module.xlsx", "Material",
					"TC-MAT-0163-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(MaterialPage.deleteCancelButton, MaterialPage.deletePopUP,
