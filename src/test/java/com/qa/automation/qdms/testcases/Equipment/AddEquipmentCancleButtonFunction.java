...
//* Description
//*------------
//* Add Equipment Pop up cancle Button Functionality 
//* 
//*************************************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-EQU-0036          26/07/2023   Priyanka     Original
//*************************************************************************************************
...
public class AddEquipmentCancleButtonFunction extends DriverIntialization {
	...
	public static void AddcloseButton() throws InterruptedException {
		...
		if (addbutton) {
			...
			materialMethodes.cancelOrCloseButtonFunction(EquipmentPage.equipmentCancelbutton, EquipmentPage.editpopup,
					"ADD EQUIPMENT CANCLE BUTTON", "ADD EQUIPMENT POP UP ");
