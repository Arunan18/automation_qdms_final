...
//* Description
//*------------
//* Add SBU Pop up cancel Button Functionality 
//* 
//*************************************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-SBU-0033          26/07/2023   Priyanka     Original
//*************************************************************************************************
...
public class AddSbuCancleButtonFunctionality extends DriverIntialization {
	...
	public static void AddcancleButton() throws InterruptedException {
		...
		if (addbutton) {
			...
			materialMethodes.cancelOrCloseButtonFunction(SbuPage.cancelbutton, SbuPage.editpopup,
					"ADD SBU CANCLE BUTTON", "ADD SBU POP UP ");
