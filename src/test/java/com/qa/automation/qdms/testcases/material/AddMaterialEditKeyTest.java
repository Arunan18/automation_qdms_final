...
* DESCRIPTION
*-----------------------------------------------------------------------------------------------------------------
* Checking addMaterialkeytest Functionality
******************************************************************************************************************
*
...
* ================================================================================================================
*  	 TC-MAT-0072    	    				      Kajan		   Modified version (Rework)		      
******************************************************************************************************************/
...
public class AddMaterialEditKeyTest extends DriverIntialization {
	@Test
	public static void materialAddKeyTest() throws InterruptedException {
		...
		if (materialMethodes.iconclick) {
			...
			materialMethodes.materialAddkey(name1, name2, "material key test");
		}if (exdata) {
