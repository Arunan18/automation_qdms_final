...
* Description
*------------
* TC-SRC-0054--Check  Source "Cancel" Button Functionality
***********************************************************************************
*
* Author           :RAHUL.S
...
public class SourceEditCancelButtonFunction extends DriverIntialization{
	...
	public static void deleteCancel() throws InterruptedException {
		...
		if (MasterMainNavigationsTest.clickSource) {
			...
			ActionCommonMethod.actionS(0, 2, SourcePage.sourceTable, "edit", "Master Module.xlsx", "Source",
					"TC-SRC-0054-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(SourcePage.cancelbutton, SourcePage.editpoup,
