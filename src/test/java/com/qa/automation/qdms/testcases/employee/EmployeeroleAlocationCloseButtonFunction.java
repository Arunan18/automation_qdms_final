...
* Description
*------------
*TC-EMP-0101--Check  Employee role allocation "Close" Button Functionality
...
public class EmployeeroleAlocationCloseButtonFunction extends DriverIntialization{
	...
	public static void deleteCancel() throws InterruptedException {
		...
		testCase = extent.createTest("TC-EMP-0101	Check  Employee role allocation Close Button Functionality");
		LoginTest.Login();
		if (LoginTest.login) {
		...
		if (MasterMainNavigationsTest.clickEmployee) {
			...
			ActionCommonMethod.actionS(4, 9, EmployeePage.employeeTable, "idcard", "Master Module.xlsx", "Employee",
					"TC-EMP-0101-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(EmployeePage.employeeCloseButton, EmployeePage.popUpModel,
					"CHECKING THE role allocation Close BUTTON", "CHECKING THE POPUP");
