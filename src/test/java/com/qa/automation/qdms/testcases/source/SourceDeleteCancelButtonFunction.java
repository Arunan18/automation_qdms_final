...
public class SourceDeleteCancelButtonFunction extends DriverIntialization {
	...
	public static void deleteCancel() throws InterruptedException {
		...
		testCase = extent.createTest("TC-SRC-0054--Check Delete Source Cancel Button Functionality");
		LoginTest.Login();
		if (LoginTest.login) {
		...
		if (MasterMainNavigationsTest.clickSource) {
			...
			ActionCommonMethod.actionS(0, 2, SourcePage.sourceTable, "delete", "Master Module.xlsx", "Source",
					"TC-SRC-0054-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(SourcePage.deleteCancelButton, SourcePage.deletePopUP,
