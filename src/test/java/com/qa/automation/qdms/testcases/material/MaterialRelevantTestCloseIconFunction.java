...
* Description
*------------
*TC-MAT-0085--Material Relevant Test Close Icon Functionality
...
* ================     ====         =====        ========
* TC-MAT-0085	 26/07/2023     Arunan     ORIGINAL Version
...
public class MaterialRelevantTestCloseIconFunction extends DriverIntialization {
	...
	public static void deleteCancel() throws InterruptedException {
		...
		testCase = extent.createTest("TC-MAT-0085--Material Relevant Test Close Icon Functionality");
		LoginTest.Login();
		if (LoginTest.login) {
		...
		if (MasterMainNavigationsTest.clickMaterial) {
			...
			ActionCommonMethod.actionS(3, 11, MaterialPage.Table, "Add Key Test", "Master Module.xlsx", "Material",
					"TC-MAT-0085-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(MaterialPage.descCloseIcon, MaterialPage.editPopUP,
					"CHECKING THE RELEVANT TEST CLOSE ICON", "CHECKING THE POPUP");
