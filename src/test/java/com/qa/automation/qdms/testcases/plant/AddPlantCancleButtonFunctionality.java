...
//* Description
//*------------
//* Add Plant Pop up  cancel Button Functionality 
//* 
//*************************************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-PLANT-0064          26/07/2023   Priyanka     Original
//*************************************************************************************************
...
public class AddPlantCancleButtonFunctionality extends DriverIntialization {
	...
	public static void AddcancleButton() throws InterruptedException {
		...
		if (addbutton) {
			...
			materialMethodes.cancelOrCloseButtonFunction(PlantPage.cancelbutton, PlantPage.editpopup,
					"ADD PLANT CANCLE BUTTON", "ADD PLANT POP UP ");
