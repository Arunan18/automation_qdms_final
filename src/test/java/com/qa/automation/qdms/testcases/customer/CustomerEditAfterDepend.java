...
//		DESCRIPTION
//------------------
//					CUSTOMER UPDATE TEST AFTER DEPEND FUNCTION
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   13.03.2023	
//****************************************************************************************
//* Test Case Number     	  Date          Intis        Comments
//* ================       	  ======       ========      ========
//*  TC-CUS-0094             13.03.2023   @SASIKALA     Original Version
//*	 
//****************************************************************************************
...
public class CustomerEditAfterDepend extends DriverIntialization {
	static CustomerPage cutomerfunpg = new CustomerPage();

	static String CustomerReName = "";
	...
	public static void CustomerEditway() throws InterruptedException, IOException {
		PageFactory.initElements(driver, cutomerfunpg);
...
//-----------------------------------------------------------------------------------------
	...
	public static void Editcustomerselect() throws InterruptedException, IOException {
		...
		for (int j = firstRow; j <= lastRow; j++) {
			...
			CustomerReName = (String) row.getCell(2).getStringCellValue();
		...
		if (CustomerPage.CustomerFiled.isDisplayed()) {
			...
			if (CustomerPage.CustomerFiled.isEnabled()) {
				...
				try {
					...
					CustomerPage.CustomerFiled.sendKeys(CustomerReName);
					Thread.sleep(2000);
				} catch (Exception e) {
