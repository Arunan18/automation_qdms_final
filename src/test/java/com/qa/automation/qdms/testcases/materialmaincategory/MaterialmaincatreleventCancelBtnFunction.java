...
public class MaterialmaincatreleventCancelBtnFunction extends DriverIntialization{
	...
	public static void deleteCancel() throws InterruptedException {
		...
		if (MasterMainNavigationsTest.matmaincat) {
			...
			materialMethodes.cancelOrCloseButtonFunction(MaterialMainCategoryPage.cancelbtn,
