...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------------
* Checking Add Material Sub Category Validation 
**********************************************************************************************************
*
* @author 	 : Jathu Jana
* 
...
* ========================================================================================================
*  (6) 	  	 TC-MATSC-0041     	    	 15/03/2023	  	    Shadurshi		 Original Version
...
public class AddMaterialSubCategoryValidation extends DriverIntialization{
	...
	public static void inputSbuValue() {
		...
		String testcaseId = "TC-MATSC-0041";
...
//					VALIDATION CHECKING BY COMMON METHOD 
					materialMethodes.validationconfirm("", "","➢ Add Material Sub Category Validation");
