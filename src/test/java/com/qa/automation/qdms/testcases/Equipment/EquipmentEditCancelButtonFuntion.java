...
* Description
*------------
* Check edit Equipment Cancel Button Functionality
***********************************************************************************
*
* Author           :RAHUL.S
...
* ================     ====         =====        ========
* TC-EQU-0043	       26/07/2023   RAHUL.S     ORIGINAL Version
...
public class EquipmentEditCancelButtonFuntion extends DriverIntialization {
	...
	public static void deleteCancel() {
		...
		if (MasterMainNavigationsTest.Equipmentclick) {
			...
			ActionCommonMethod.actionS(0, 3, EquipmentPage.equipmentTable, "edit", "Master Module.xlsx", "Equipment",
					"TC-EQU-0065-01", 1);
			materialMethodes.cancelOrCloseButtonFunction(EquipmentPage.equipmentCancelbutton, EquipmentPage.editpopup,
