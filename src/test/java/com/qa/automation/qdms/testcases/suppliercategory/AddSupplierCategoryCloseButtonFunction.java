...
//* Description
//*------------
//* Add Supplier Category Pop up close Button Functionality 
//* 
//*************************************************************************************************
//*
...
public class AddSupplierCategoryCloseButtonFunction extends DriverIntialization {
	...
	public static void AddcloseButton() throws InterruptedException {
		...
		if (addbutton) {
			...
			materialMethodes.cancelOrCloseButtonFunction(SupplierCategoryPage.closebutton,
					SupplierCategoryPage.editpopup, "ADD SUPPLIER CATEGORY CLOSE BUTTON",
