...
* ================================================================================================================
*  (9) 	  	 		  TC-MATSC-0045    	         26/07/2023	  	   Jathu Jana		Original Version
******************************************************************************************************************/
...
public class AddMaterialSubCategoryCloseButtonFunctionality extends DriverIntialization{
...
//			CHECKING ADD MATERIAL SUB CATEGORY CLOSE BUTTON FUNCTIONALITY
			functionality.checkingCancelOrCloseFunctionanlity("➢ Checking Add Material Sub Category Close Button Functionality ",
					MaterialSubCategoryPage.popUpModelCloseButton ,MaterialSubCategoryPage.popUpModel);
