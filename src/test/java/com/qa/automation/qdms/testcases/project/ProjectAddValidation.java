...
//* Description
//*------------
//* Project Add Validation Functionality 
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*  TC-PRO-0067         22/02/2023   Priyanka     Orginal Version
//*
//************************************************************************************
...
public class ProjectAddValidation extends DriverIntialization {
	...
	public void ProjectValidation() throws InterruptedException, IOException {
		...
		for (int i = firstRow; i <= lastRow; i++) {
			...
			if (ProjectPage.projectsavebutton.isDisplayed()) {
				materialMethodes.validationconfirm("1", code, "Add Project Validation");
				per = true;
			}
