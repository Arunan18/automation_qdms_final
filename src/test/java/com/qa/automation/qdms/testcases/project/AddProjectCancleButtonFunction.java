...
//* Description
//*------------
//* Add Project Pop up cancle Button Functionality 
//* 
//*************************************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-PRO-0069        26/07/2023   Priyanka     Original
//*************************************************************************************************
...
public class AddProjectCancleButtonFunction extends DriverIntialization {
	...
	public static void AddcloseButton() throws InterruptedException {
		...
		if (addbutton) {
			...
			materialMethodes.cancelOrCloseButtonFunction(ProjectPage.CancelBtn, ProjectPage.editpopup,
					"ADD PROJECT CANCLE BUTTON", "ADD PROJECT POP UP ");
