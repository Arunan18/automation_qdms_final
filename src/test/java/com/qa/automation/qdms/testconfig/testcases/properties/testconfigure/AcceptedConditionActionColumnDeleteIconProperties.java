...
//* Description
//*------------
//* Test Configure - "Accepted Condition" - Action Column Delete Icon Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0744       14/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class AcceptedConditionActionColumnDeleteIconProperties extends DriverIntialization {
	...
	public static void actionDeleteIcon() throws InterruptedException, IOException {
		...
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 14, "Description", "Test Configuration Properties","Test_Configure", "TC-TCN-0744");
	...
	public static void  properr(String code) {
		...
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0744-02", driver.findElement(By.xpath("//td[text()='"+code+"']//following-sibling::td[1]//span[@class='anticon anticon-delete']")), "Action Column Delete Icon Properties");
	}	
}
