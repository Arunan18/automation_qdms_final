...
//* Description
//*------------
//* Additional Information Close Icon Function
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-MT-085		      16/05/2023   Gobithan     Orginal Version
//*
//************************************************************************************
...
public class AdditionalInformationCloseIconFunction extends DriverIntialization{
	...
	public static void action() throws InterruptedException, IOException {
		...
		/* SELECT THE VALUE */
		ActionCommonMethod.actionS(0, 10, ManageTestsPage.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Manage_Tests", "MTC-MT-085-01", 1);
		
		/* CLOSE ICON PROPERTYS */
		closeIcon();
    ...
    public static void closeIcon() {
        if (ManageTestsPage.additionalinformationcloseicon.isDisplayed()) {
            testCase = extent.createTest("STEP_05-- ADDITIONAL INFORMATION CLOSE ICON DISPLYED");
            testCase.log(Status.PASS, "TEST PASS");
            if (ManageTestsPage.additionalinformationcloseicon.isEnabled()) {
                testCase = extent.createTest("STEP_06--ADDITIONAL INFORMATION CLOSE ICON ENABLED");
                testCase.log(Status.PASS, "TEST PASS");
                try {
                    Thread.sleep(2000);
                    ...
                    ManageTestsPage.additionalinformationcloseicon.click();
                    Thread.sleep(2000);
                    ...
                    if (clicked) {
                        testCase = extent.createTest("STEP_07--ADDITIONAL INFORMATION CLOSE ICON CLICKED");
                        testCase.log(Status.PASS, "TEST PASS");
                        ...
                        if (addmodelwindow == false) {
                            ...
                            testCase = extent
                                    .createTest("STEP_08--ADDITIONAL INFORMATION MODEL WINDOW NOT CLOSED");
                            testCase.log(Status.FAIL, "TEST FAIL");
                        }
                    } else {
                        testCase = extent.createTest("STEP_07--ADDITIONAL INFORMATION CLOSE ICON NOT CLICKED");
                        testCase.log(Status.FAIL, "TEST FAIL");
                    }
                } catch (Exception e) {
                }
