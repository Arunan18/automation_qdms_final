...
//* Description
//*------------
//* Configure Test Using Main Category Wise One Results Parameter (FINISH PRODUCT TEST- WITH ACTIVE)
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0310        	22/05/2023   Gobithan     Orginal Version
//*
//************************************************************************************
...
public class ConfigureTestUsingMainCategoryWise_OneResultsParameter_FinishProduct_WithActive
	...
	public static void addgroupconfigure() throws InterruptedException, IOException {
		...
		// TESTCASE REPORT
		extent.createTest(
				"TC-TCN-0310-Configure Test Using Main Category Wise One Results Parameter (FINISH PRODUCT TEST- WITH ACTIVE)");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0310-first");

		// TEST PARAMETER FIELD
		Thread.sleep(2000);
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0310-second");

		// ADD PARAMETER FIELD
		Thread.sleep(3000);
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0310-second");

		// CONFIGURE EQUATION FIELD
		Thread.sleep(2000);
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0310-third");
		...
		Thread.sleep(3000);
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0310-fourth");
		...
		// ACCEPTED CRITERIA FIELD
		Thread.sleep(3000);
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0310-fifth");
		...
		Thread.sleep(3000);
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0310-seventh");
		TestConfigPage.nextBtn.click();

		// Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0310-first",
				"TC-TCN-0310-second", "TC-TCN-0310-third", "TC-TCN-0310-fourth", "TC-TCN-0310-fifth", "",
				"TC-TCN-0310-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0310-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "first",
