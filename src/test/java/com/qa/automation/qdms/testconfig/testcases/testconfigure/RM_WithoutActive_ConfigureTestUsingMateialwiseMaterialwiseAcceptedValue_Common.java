...
//* Description
//*------------
//* RM_WithoutActive_ConfigureTestUsingMaterialwiseMaterialwiseAcceptedValue_Common
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-TCN-0287           8/06/2023    Niluxy       Orginal Version
//*
//************************************************************************************
...
public class RM_WithoutActive_ConfigureTestUsingMateialwiseMaterialwiseAcceptedValue_Common
	...
	public static void action() throws InterruptedException, IOException {
		...
		extent.createTest(
				"TC-TCN-0287:RM_WithoutActive_ConfigureTestUsingMaterialwiseMaterialwiseAcceptedValue_Common");
		// LOGIN TO THE SYSTEM
		LoginTest.Login();
		...
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0287-second");
		Thread.sleep(3000);
		// STEP3 :ADD THE PARAMETER
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0287-second");
		Thread.sleep(3000);
		...
		AcceeptedCretiaStep.accepted("Test Configuragtion Module", "Test_Configure", "TC-TCN-0287-fourth");
		Thread.sleep(3000);
		// MOVE TO DOWN
		...
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0287-first",
				"TC-TCN-0287-second", "TC-TCN-0287-third", "TC-TCN-0287-fourth", "TC-TCN-0287-fifth", "",
				"TC-TCN-0287-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0287-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "First",
