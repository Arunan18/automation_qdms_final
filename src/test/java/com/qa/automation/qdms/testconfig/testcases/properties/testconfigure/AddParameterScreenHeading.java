...
* Description
*------------
* Test Configure Table - Parameter Table-Add Parameter Pop up Screen- "Add Parameter" UI Heading  Properties
***********************************************************************************
*
...
* ================       ====         =====        ========
* TC-TCN-0462          27/06/2023      RAHUL.S    Original Version
*
*************************************************************************************/
...
public class AddParameterScreenHeading extends DriverIntialization {
	...
	public static void addParaMeterPopUpHeading() throws InterruptedException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOf(TestConfigPage.addParaMeterPopUpHeading));
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0462-02", TestConfigPage.addParaMeterPopUpHeading, "ADD PARAMETER POPUP HEADING");
