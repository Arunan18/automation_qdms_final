...
//* Description
//*------------
//* Manage Test Edit Pop up Screen "Sub Category" Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-069        05/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ActionEditIconPopupSubCategoryHeading extends DriverIntialization {
	...
	public static void subCategoryProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void subCategoryHeadProperties() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Edit Icon Pop up Sub Category Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-069-02", GroupTestsPage.editiconpopupsubcategoryheading, "Edit Icon Pop up Sub Category Heading Properties");
	}
}
