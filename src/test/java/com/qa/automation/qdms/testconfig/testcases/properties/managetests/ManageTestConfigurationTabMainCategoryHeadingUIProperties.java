...
* Description
*------------
* Test Configure Manage Test Configuration Tab Main Category Heading UI Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-136           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class   ManageTestConfigurationTabMainCategoryHeadingUIProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
	@Test

	public static void testConfigurationTabMainCategoryHeadingUIProperties  ()
		...
		configurationTabMainCategoryHeadingUIProperties();
	...
	public static void configurationTabMainCategoryHeadingUIProperties () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-136-02",ManageTestsPage.testConfigureManageTestConfigurationTabedmaincategoryheadingProperties,
				"Step-4--testConfigure ManageTest Configuration Tab maincategory heading Properties");
	}
}
