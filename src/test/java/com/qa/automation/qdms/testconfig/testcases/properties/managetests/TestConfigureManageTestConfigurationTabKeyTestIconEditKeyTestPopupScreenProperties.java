...
* Description
*------------
* Test Configure Manage Test Configuration Tab Key Test Icon Edit Key Test Pop up Screen Properties 
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-117           10/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
static String test =null;
	@Test

	public static void configureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-117-01");
		...
		manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenProperties();
	...
	public static void manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenProperties() {
		PageFactory.initElements(driver, mtp);
		ProCommonMethods.modal("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-117-02",ManageTestsPage.testConfigureManageTestConfigurationTabKeytesticonpopupProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test Icon Popup Properties");
	}
