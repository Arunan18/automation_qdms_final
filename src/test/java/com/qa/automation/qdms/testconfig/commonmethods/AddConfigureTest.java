...
public class AddConfigureTest extends DriverIntialization {
	...
	public static void AddConfigureTest(String name, String ExcelTabName, String TestcaseId) throws IOException, InterruptedException {
		...
		//	WebElement list = driver.findElement(By.xpath("//div[@class='rc-virtual-list-holder-inner']/div/div/span"));
			...
			boolean active=Boolean.valueOf(active1);
				...
				try {
	              ...
	              for (int i1 = 0; i1 < 1000; i1++) {
	                 if (!pass) {
	                     try {
	                         driver.findElement(
	                                 By.xpath("//div[@class='ant-select-item-option-content']//span[text()='"+testname+"']"))
	                                 .click();
	                         pass = true;
	                     } catch (Exception e) {
	                     }
...
//					}
			...
			try {
				...
				id.click();
				Thread.sleep(2000);
				WebElement dro = driver.findElement(By.xpath("//div[contains(text(),'"+testtype+"')]"));
				dro.click();
			...
			try {
				...
				boolean value1 = id.isDisplayed();
				SampleCommonMethods.TestCasePrint("MAIN CATEGORY DROP DOWN IS DISPLAYED", "true",
				...
				try {
	              ...
	              for (int i1 = 0; i1 < 1000; i1++) {
	                 if (!pass) {
	                     try {
	                         driver.findElement(
	                                 By.xpath("//div[contains(text(),'"+maincatagory+"')]"))
	                                 .click();
	                         pass = true;
	                     } catch (Exception e) {
	                     }
				...
				try {
	              ...
	              for (int i1 = 0; i1 < 1000; i1++) {
	                 if (!pass) {
	                     try {
	                         driver.findElement(
	                                 By.xpath("//div[contains(text(),'"+subcatagory+"')]"))
	                                 .click();
	                         pass = true;
	                     } catch (Exception e) {
	                     }
				...
				try {
	              ...
	              for (int i1 = 0; i1 < 1000; i1++) {
	                 if (!pass) {
	                     try {
	                         driver.findElement(
	                                 By.xpath("//div[contains(@class,'ant-select-item-option-content')][normalize-space()='"+material+"']"))
	                                 .click();
	                         pass = true;
	                     } catch (Exception e) {
	                     }
			...
			try {
				...
				boolean value1 = id.isDisplayed();
				SampleCommonMethods.TestCasePrint("REPORT FORMAT DROP DOWN IS DISPLAYED", "true",
						String.valueOf(value1));
				boolean value2 = id.isEnabled();
				...
				if (value3 == due) {
					if (value3) {
						...
						try {
							...
							SampleCommonMethods.TestCasePrint("DUE BUTTON IS DISPLAYED", "true",
					...
					try {idd = driver.findElement(By.xpath("//input[@id='dueDay']"));// dueDay
					 ...
					 SampleCommonMethods.TestCasePrint("DUE DATE BOX BUTTON IS DISPLAYED", "true",
								String.valueOf(value4));
...
//				boolean value1 = element.isDisplayed();
//				SampleCommonMethods.TestCasePrint("NEXT BUTTON IS DISPLAYED", "true", String.valueOf(value1));
//				boolean value2 = element.isEnabled();
