 ...
 * Description
 *------------
 * Test Configure Module, Top Bar Accepted criteria, Accepted Value, Second Table, "Parameter" Column Search Icon's Pop-Up, "Reset"
 * Button Properties
 ***************************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0658 		    10/07/2023      Shangeetha    Original Version  
 *************************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaTabParameterColSearchPopResetBtn extends DriverIntialization{
	...
	public static void AcceptedCriteria() throws InterruptedException, IOException {
		...
		// Check 'Reset' Button Properties on 'Parameter' Column Search Pop-Up  
	...
	public static void methodClickOnColumnSearchIcon() {
		...
		try {
			...
			// Check 'Reset' Button Properties on 'Parameter' Column Search Pop-Up
			methodParameterColumnSearchIconPopUpResetBtn();
	...
	public static void methodParameterColumnSearchIconPopUpResetBtn() {
		PageFactory.initElements(driver, testPage);
		// Check 'Reset' Button Properties on 'Parameter' Column Search Pop-Up 
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0658-02", TestConfigPage.acceptedCriteriaTableTwoParameterColSrchPopResetBtn, "'Reset' Button Properties on 'Parameter' Column Search Pop-Up");
	}
}
