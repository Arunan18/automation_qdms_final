...
------------
 ...
 "Select Parameter for create equation" UI Heading Properties
*************************************************************************************************************************************************
 ...
 ================       ====         =====        ========
 TC-TCN-0582          14/07/2023    SHANGEETHA      Original Version
***************************************************************************************************************************************************/
...
public class ConfigEquTabResultsSelectParameterForcreatEquationHeading extends DriverIntialization{
	...
	public static void configureEquation() throws InterruptedException, IOException {
      ...
      //Check "Select Parameter for create equation" UI Heading Properties
	...
	public static void methodTextProperties() {
		PageFactory.initElements(driver, testPage);
		// Check  "Select Parameter for create equation" UI Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0582-02", TestConfigPage.selectParameterHeading, "'Select Parameter for create equation' Heading Properties");
