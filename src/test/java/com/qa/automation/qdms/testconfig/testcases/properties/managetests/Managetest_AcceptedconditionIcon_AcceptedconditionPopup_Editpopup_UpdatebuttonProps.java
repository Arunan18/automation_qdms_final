...
//* Description
//*------------
//* Test Configure - Manage Test Configuration Tab- Accepted Condition - Action - Edit Pop up Screen - "Update" Button UI Properties
//***************************************************************************************
//*
//* Author           : N.Karunya
...
//* ================       ====         =====        ========
//* MTC-MT-338         05/07/2023    N.Karunya   Original Version                
//************************************************************************************
...
public class Managetest_AcceptedconditionIcon_AcceptedconditionPopup_Editpopup_UpdatebuttonProps
		extends DriverIntialization {
	
	static ManageTestsPage mtp = new ManageTestsPage();

	@Test
	public static void Updatebutton() throws InterruptedException, IOException {
	...
	public static void UpdatebuttonProperties() {

		PageFactory.initElements(driver, mtp);

		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-338-02", ManageTestsPage.editConditionupdatebutton,
				"Manage Test - Accepted Condition Popup Screen Update Button Properties");
	}
