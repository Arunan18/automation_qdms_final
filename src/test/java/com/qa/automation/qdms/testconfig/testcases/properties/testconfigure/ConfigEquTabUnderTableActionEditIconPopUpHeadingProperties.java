 ...
 * Description
 *------------
 * Test Configure - Configure Test Table-  Configure Equation Tab - Equation Type Action-"Edit Icon" Pop up 
 * Heading Properties
 ***************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0603 			 07/07/2023   Shangeetha    Original Version  
 **************************************************************************************************************/
...
public class ConfigEquTabUnderTableActionEditIconPopUpHeadingProperties extends DriverIntialization{
	...
	public static void configureEquation() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Edit Icon Pop-Up Heading Properties
	...
	public static void editIconPopUpHeadingProperties() {
		...
		//Get Edit Icon Pop-Up Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0603-02", TestConfigPage.configEquActionEditIconPopHeading,"Edit Icon Pop-Up Heading Properties");
