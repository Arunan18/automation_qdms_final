...
//* Description
//*------------
//* Groups Tests - "Tests" Column Icon Pop up Screen- Delete Icon Pop up - Cancel Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-060         10/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class TestsPopupScreenDeleteIconPopupCancelBtn extends DriverIntialization {
	...
	public static void deleteIconPopupCancelBtn() throws InterruptedException, IOException {
		...
		//Calling the method
		deleteIconPopupCancelBtnPropertiess();
	...
	public static void deleteIconPopupCancelBtnPropertiess() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void deleteIconPopupCancelBtnProperties() {	
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Group_Test", "MTC-GT-060-02", GroupTestsPage.actionColumnDeleteIconPopupCancelBtn, "Action Column Delete Icon Pop up Screen Cancel Button Properties");
	}
}
