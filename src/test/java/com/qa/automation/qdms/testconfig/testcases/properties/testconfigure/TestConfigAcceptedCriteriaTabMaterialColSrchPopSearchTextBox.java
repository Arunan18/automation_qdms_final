 ...
 * ================        ====         =====          ========
 * TC-TCN-0662 		    10/07/2023      Shangeetha    Original Version  
 *************************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaTabMaterialColSrchPopSearchTextBox extends DriverIntialization{
	...
	public static void AcceptedCriteria() throws InterruptedException, IOException {
		...
		// Check 'Search' Text Box Properties on 'Material' Column Search Pop-Up
	...
	public static void methodSearchTextBox() {
		PageFactory.initElements(driver, testPage);
		// Check 'Search' Text Box Properties on 'Material' Column Search Pop-Up 
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0662-02", TestConfigPage.acceptedCriteriaTableTwoMaterialColSrchPopSearchTextBox, "'Search' Text Box Properties on 'Material' Column Search Pop-Up");
	}
}