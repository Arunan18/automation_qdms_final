...
* Description
*------------
* Test Configure  Manage Test Configuration Tab Site Manage Tests Button Properties  
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-107           07/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureManageTestConfigurationTabSiteManageTestsButtonProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();

	@Test

	public static void configureManageTestConfigurationTabSiteManageTestsButtonProperties() throws InterruptedException, IOException {
	...
	//Check the Test Configure Manage Test Configuration Tab Main Header Button Properties
	 manageTestConfigurationTabMainHeaderButtonProperties();
	...
	public static void manageTestConfigurationTabMainHeaderButtonProperties() {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-107-02", ManageTestsPage.mainManagetestConfigureNavicationsitemanagetestbutton,
				"Step-4--Test Configure Manage Test Configuration Tab Site Manage Test Header Button Properties");
	}
}
