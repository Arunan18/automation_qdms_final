...
//* Description
//*------------
//* Test Configure Configure Test Table Top Bar Additional Information Add Field Action Edit Icon Cancel Button Pop up Screen OK Button Properties
//*****************************************************************************************************************************************************
//*
//* Author           :M.Mathushan
...
//* ================       ====         =====        ========
//* TC-TCN-0790			14/07/2023    M.Mathushan   Original Version  
//*                    
//*****************************************************************************************************************************************************/
...
public class AdditionalInformationAddFieldActionEditIconCancelButtonPopupScreenOKButtonProperties extends DriverIntialization {
	static TestConfigPage testconfigpg = new TestConfigPage();

	@Test
	public static void informationAddFieldActionEditIconCancelButtonPopupScreenOkButtonProperties() throws InterruptedException, IOException {

		// MANAGE TEST PAGE PATH FROM LOGIN
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 14, "Description", "Test Configuration Properties",
				"Test_Configure", "TC-TCN-0790");
		// Get the Data For Excel
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Test_Configure", "TC-TCN-0790-01");
		...
		addFieldActionEditIconCancelButtonPopupScreenOkButtonProperties();
	...
	// Click Test Configure Module Additional Information Additional Information Add
	// Field Action Edit Icon Cancel Button Pop up Screen Ok Button Properties
	public static void addFieldActionEditIconCancelButtonPopupScreenOkButtonProperties() {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0790-02",TestConfigPage.editIconCancelButtonPopupScreenOkButtonProperties,
				"Additional Information  Add Field Status Add Field Action Edit Cancel Button Pop up Screen OK Button Properties");
