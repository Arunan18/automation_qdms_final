...
//* Description
//*------------
//* Groups Tests - "Tests" Column Icon Pop up Screen Delete Icon Pop up Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-057         10/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class TestsPopupScreenActionDeleteIconPopupProperties extends DriverIntialization {
	...
	public static void actionDeleteIconPopup() throws InterruptedException, IOException {
		...
		//Calling the method
		actionDeleteIconPopupPropertiess();
	...
	public static void actionDeleteIconPopupPropertiess() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			try {
				...
				actionDeleteIconPopupProperties();
	...
	public static void actionDeleteIconPopupProperties() {	
		PageFactory.initElements(driver, GroupTestpg);

		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Group_Test", "MTC-GT-057-02", GroupTestsPage.actionColumnDeleteIconPopup, "Tests Icon Popup Screen Action Column Delete Icon Pop up Properties");
	}
}
