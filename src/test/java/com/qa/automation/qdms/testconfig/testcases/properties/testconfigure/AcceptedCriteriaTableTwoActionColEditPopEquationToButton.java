 ...
 * ================        ====         =====          ========
 * TC-TCN-0691		    13/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class AcceptedCriteriaTableTwoActionColEditPopEquationToButton extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Edit Icon Pop-Up: Equation- 'To' Text Box Properties	
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Get Edit Icon Pop-Up: Equation- 'To' Button Properties	
			methodEquationToButtonProperties();			
	...
	public static void methodEquationToButtonProperties() {
		PageFactory.initElements(driver, testPage);
		//Get Edit Icon Pop-Up: Equation- 'To' Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0691-02", TestConfigPage.tableTwoActionColEditPopEquationToButton, "Equation: 'To' Button Properties");
