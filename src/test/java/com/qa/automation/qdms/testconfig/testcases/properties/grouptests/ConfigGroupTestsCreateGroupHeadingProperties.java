...
//* Description
//*------------
//* Config Group Test - "Create Group" Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-077          06/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfigGroupTestsCreateGroupHeadingProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void createGroupHeading() throws InterruptedException, IOException {
	...
	public static void createGroupHeadingProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void createGroupHeadProperties() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Column Pop up Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-077-02", GroupTestsPage.editiconpopupcreategroupheading, "Create Group Heading Properties");
	}
}
