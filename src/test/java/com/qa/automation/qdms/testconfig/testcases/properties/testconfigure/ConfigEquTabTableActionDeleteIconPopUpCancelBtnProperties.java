 ...
 * Description
 *------------
 * Test Configure - Configure Test Table, Configure Equation Tab, Equation Type Action Column, Delete Pop up Screen  
 ...
 * ================        ====         =====          ========
 * TC-TCN-0614			 08/07/2023   Shangeetha    Original Version  
 ******************************************************************************************************************/
...
public class ConfigEquTabTableActionDeleteIconPopUpCancelBtnProperties extends DriverIntialization{
	...
	public static void configureEquation() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Delete Icon Pop-Up, 'Cancel' Button Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Check 'Delete' Icon Pop-Up, 'Cancel' Button Properties	
			deleteIconPopUpCancelBtnProperties();			
	...
	public static void deleteIconPopUpCancelBtnProperties() {
		PageFactory.initElements(driver, testPage);
		//Check 'Delete' Icon Pop-Up, 'Cancel' Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0614-02", TestConfigPage.configEquActionDeleteIconPopCancelBtn,"'Delete' Icon Pop-Up, 'Cancel' Button Properties");
       }	
}