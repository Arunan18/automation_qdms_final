...
//* Description
//*------------
//* Config Group Test - Config Group Test Table "Material Main Category" TextBox Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-068         11/07/2023     K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfigGroupTestTableMaterialMainCategoryTextBox extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void materialMainCategoryHeading() throws InterruptedException, IOException {
		...
		//Calling the method
		materialMainCategoryTextBoxProperties();
	...
	public static void materialMainCategoryTextBoxProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void mainCategoryTextBoxProperties() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Edit Icon Pop up Material Main Category Heading Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-068-02", GroupTestsPage.materialmaincategorytextbox, "Material Main Category TextBox Properties");
	}
}
