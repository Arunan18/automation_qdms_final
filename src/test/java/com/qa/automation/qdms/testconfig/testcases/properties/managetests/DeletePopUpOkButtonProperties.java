...
//* Description
//*------------
//* Manage Test Configuration Tab - Delete PopUp "OK" Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*   MTC-MT-404          22/06/2023   Sasi     Original Version
//*
//************************************************************************************
...
public class DeletePopUpOkButtonProperties extends DriverIntialization {
	...
	public static void Popupicon() throws InterruptedException, IOException {
		...
		// Check Relevant Test OK Button Properties
		DeletepopupOkbutton();
	...
	public static void DeletepopupOkbutton() throws IOException, InterruptedException {
		...
		try {
			...
			testCase = extent.createTest("Delete Popup Ok Button Click");
			testCase.log(Status.INFO, "Clicked on the element 'Delete Popup Ok Button'");
			...
			extent.createTest("Delete Popup Ok Button Element Identify");
			testCase.log(Status.INFO, "Unable to Locate the element 'Delete Popup Ok Button'");
			testCase.log(Status.FAIL, "TEST FAIL ❎");

		} catch (ElementClickInterceptedException e) {
			testCase = extent.createTest("Delete Popup Ok Button Element Click Interupted");
			testCase.log(Status.INFO, "Unable to Click on the element 'Delete Popup Ok Button'");
			testCase.log(Status.FAIL, "TEST FAIL ❎");

		} catch (Exception e) {
			testCase = extent.createTest("Delete Popup Ok Button' Checking Terminated");
			testCase.log(Status.INFO, "'Delete Popup Ok Button' IS ENABLE OR VISIBLE");
			testCase.log(Status.FAIL, "TEST FAIL ❎");
		}
	}
	...
	public static void DeletePopupOkButtonProperties() {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-404-02", ManageTestsPage.deleteOkButtonMT, "Manage Test Delete Popup Ok Button Propeties");
	}
}
