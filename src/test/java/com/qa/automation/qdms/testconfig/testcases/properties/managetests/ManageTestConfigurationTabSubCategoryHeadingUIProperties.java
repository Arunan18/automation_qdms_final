...
* Description
*------------
* Test Configure Manage Test Configuration Tab Sub Category Heading UI Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-141           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class   ManageTestConfigurationTabSubCategoryHeadingUIProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
	@Test

	public static void testConfigurationTabSubCategoryHeadingUIProperties   ()
		...
		configurationTabSubCategoryHeadingUIProperties();
	...
	public static void configurationTabSubCategoryHeadingUIProperties () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-141-02",ManageTestsPage.testConfigureManageTestConfigurationTabedsubcategoryheadingProperties,
				"Step-4--testConfigure ManageTest Configuration Tab Subcategory heading Properties");
	}
}
