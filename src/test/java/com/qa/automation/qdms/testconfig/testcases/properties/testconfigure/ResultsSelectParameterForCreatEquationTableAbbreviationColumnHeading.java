...
------------
 ...
 "Select Parameter for create equation" Table: "Abbreviation" Column Heading
*************************************************************************************************************************************************
 ...
 ================       ====         =====        ========
 TC-TCN-0584          14/07/2023    Shangeetha      Original Version
***************************************************************************************************************************************************/
...
public class ResultsSelectParameterForCreatEquationTableAbbreviationColumnHeading extends DriverIntialization{
	...
	public static void configureEquation() throws InterruptedException, IOException {
      ...
      //Check "Abbreviation" Column Heading Properties
	...
	public static void methodTextProperties() {
		PageFactory.initElements(driver, testPage);
		//Check "Abbreviation" Column Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0584-02", TestConfigPage.configureEquationTestAbbreviationColumnHeading, "'Abbreviation' Column Heading Properties");
