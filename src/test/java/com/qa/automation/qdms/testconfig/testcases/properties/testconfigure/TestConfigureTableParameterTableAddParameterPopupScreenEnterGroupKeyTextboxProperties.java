...
* Description
*------------
Test Configure Table - Parameter Table-Add Parameter Pop up Screen- "Enter GroupKey" Text box Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0486          05/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableAddParameterPopupScreenEnterGroupKeyTextboxProperties
	...
	public static void groupKeyTextBoxProperties() throws InterruptedException, IOException {

		PageFactory.initElements(driver, testConfig);

		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0486-02", TestConfigPage.paraMeterAddParaMeterAddGroupEnterGroupKeyTextBox,
				"Test Configure Table - Parameter Table-Add Parameter Pop up Screen- Enter GroupKey Text box Properties");
