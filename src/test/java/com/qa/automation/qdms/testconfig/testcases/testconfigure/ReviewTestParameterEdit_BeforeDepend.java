...
//* Description
//*------------
//*ReviewTestParameterEditFunction_BeforeDepend
//*Review Test Parameter edit update button function under Test Configure
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-TCN-0117             4/05/2023     Niluxy       Original Version
//*TC-TCN-0120
//************************************************************************************
...
public class ReviewTestParameterEdit_BeforeDepend extends DriverIntialization {
	...
	public static void testparameter() throws InterruptedException, IOException {
		...
		extent.createTest("TC-TCN-0117:ReviewTestParameterEditFunction_BeforeDepend");
		extent.createTest("TC-TCN-0120:Review Test Parameter edit update button function under Test Configure");
		// LOGIN TO THE SYSTEM
		LoginTest.Login();
		...
		AddGroupKey.actionS(0, 14, ManageTestsPage.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Test_Configure", "TC-TCN-0117-01", 10);
		...
		Thread.sleep(2000);
		SampleActionMethods.clicking(TestConfigPage.updatebuttonreviewtest, 20,
				"STEP 15:CHECKING THE UPDATE BUTTON ICON ");
