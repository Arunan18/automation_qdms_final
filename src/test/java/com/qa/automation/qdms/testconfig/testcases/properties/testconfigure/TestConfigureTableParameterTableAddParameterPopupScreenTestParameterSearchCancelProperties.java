...
* ================       ====         =====        ========
TC-TCN-0482         05/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableAddParameterPopupScreenTestParameterSearchCancelProperties
	...
	public static void addParaMeterAddGroupPopUpParameterSearchIcon() throws InterruptedException, IOException {
		...
		try {
			...
			;
			// If clicks
			popUpScreenCancelButtonProperties();
	...
	public static void popUpScreenCancelButtonProperties() throws InterruptedException, IOException {

		PageFactory.initElements(driver, testConfig);

		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0482-02", TestConfigPage.paraMeterAddParaMeterAddGroupPopUpScreenTestParameterSearchIConResetButton,
				"Test Configure Table - Parameter Table-Add Parameter Pop up Screen- Test Parameter  Search Cancel Properties");
