...
//* ================       ====         =====          ========
//* MTC-MT-251             11/07/2023   BFH.Rakshana   Original Version                
//************************************************************************************
...
public class ManageTestConfigTypeHeading extends DriverIntialization{
	 
@Test
public static void manageTestConfigTypeHeading() throws InterruptedException, IOException {
	        NavigateManageTestFromLogin.clickIcon("Manage Tests", 9, "Description", "Test Configuration Properties",
		    "Manage_Tests", "MTC-MT-251");
...
public static void unitHeading() {
	...
	"MTC-MT-251-02", ManageTestsPage.TypeHeading,"Type Heading UI Properties");
}
