 ...
 * Description
 *------------
 * Test Configure Module, Top Bar Accepted criteria, Accepted Value, Second Table: "Condition" Column Search Icon's Pop-Up, "Search"
 ...
 * ================        ====         =====          ========
 * TC-TCN-0668 		    10/07/2023      Shangeetha    Original Version  
 *************************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaTabConditionColSrchPopSearchDropdown extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Check 'Search' Drop-down Properties on 'Condition' Column Search Pop-Up  
	...
	public static void methodClickOnColumnSearchIcon() {
		...
		try {
			...
			// Check 'Search' Drop-down Properties on 'Condition' Column Search Pop-Up 
			methodSearchDropdownProperties();
	...
	public static void methodSearchDropdownProperties() {
		PageFactory.initElements(driver, testPage);
		// Check 'Search' Drop-down Properties on 'Condition' Column Search Pop-Up 
		ProCommonMethods.dropDown("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0668-02", TestConfigPage.acceptedCriteriaTableTwoConditionColSrchPopSearchDropDownTextBox, "'Search' Drop-down Properties on 'Condition' Column Search Pop-Up", "1");
	}
}
