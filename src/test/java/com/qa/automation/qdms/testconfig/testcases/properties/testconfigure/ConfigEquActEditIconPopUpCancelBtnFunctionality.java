 ...
 * ================        ====         =====          ========
 * TC-TCN-0607			 07/07/2023   Shangeetha    Original Version  
 ***************************************************************************************************************/
...
public class ConfigEquActEditIconPopUpCancelBtnFunctionality extends DriverIntialization{
	...
	public static void editIconPopUpCancelButtonFunctionality() {
		...
		//Check 'Edit' Icon Pop-Up, 'Cancel' Button Functionality
		functionality.ButtonAndIconunctionalityMtd("'Cancel' Button Functionality", TestConfigPage.configEquActionEditIconPopCancelBtn, "Button");
