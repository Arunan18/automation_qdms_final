...
* Description
*------------
Test Configure Table - Parameter Table Middle Page- Test Parameter Table- "Save Parameter" Button Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0523         07/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameteTableMiddlePageTestParameterTableSaveParameterButtonProperties
	...
	public static void scrollDownUntilElementFound() throws InterruptedException, IOException {
		...
		// check properties
		commonMethodForCheckBoxProperties();

	}

	public static void commonMethodForCheckBoxProperties() throws InterruptedException, IOException {

		PageFactory.initElements(driver, testConfig);

		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0523-02", TestConfigPage.paraMeterAddParaMeterSaveParameter,
				"Test Configure Table - Parameter Table Middle Page- Test Parameter Table- Save Parameter Button Properties");
