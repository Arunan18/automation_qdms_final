...
//* Description
//*------------
//* Reset Button Function Under Test Equation
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0153			 17/05/2023   Gobithan     Original Version
//*
//************************************************************************************
...
public class ResetButtonFunctionUnderTestEquation extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		extent.createTest("STEP_04-- CONFIGURE EQUATION PROPERTIES"); 
		AddGroupKey.actionS(0, 14, ManageTestsPage.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Test_Configure", "TC-TCN-0153-01", 1);

		/* CLICK ON TEST PARAMETER ICON */
		Thread.sleep(1000);
		SampleCommonMethods.singleclick("STEP_04-- CONFIGURE EQUATION PROPERTIES", testnav.Configureequation,
				"01-- CONFIGURE EQUATION ICON DISPLAYED", "02-- CONFIGURE EQUATION ICON ENABLED");
