 ...
 * ================        ====         =====          ========
 * TC-TCN-0612			 08/07/2023   Shangeetha    Original Version  
 ******************************************************************************************************************/
...
public class ConfigEquTabTableActionDeleteIconPopUpQuestionMarkProperties extends DriverIntialization{
	...
	public static void configureEquation() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Delete Icon Pop-Up, "?" Icon Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Check 'Delete' Icon Pop-Up, '?' Mark Properties	
			deleteIconPopUpQuestionMarkIconProperties();			
	...
	public static void deleteIconPopUpQuestionMarkIconProperties() {
		PageFactory.initElements(driver, testPage);
		//Check 'Delete' Icon Pop-Up, '?' Mark Properties
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0612-02", TestConfigPage.configEquActionDeleteIconPopQuestionMark,"'Delete' Icon Pop-Up, '?' Icon Properties");
       }	
}