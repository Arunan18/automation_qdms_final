...
//* Description
//*------------
//* Additional Information Tab Function
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0018		 	08/05/2023   Gobithan     Orginal Version
//* 
//************************************************************************************
...
public class AdditionalInformationTabFunction extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		AddGroupKey.actionS(0, 14, mangetest.managetexttablecontainer, "Description", "Test Configuragtion Module.xlsx",
				"Test_Configure", "TC-TCN-0018-01", 1);

		// CLICK ON ADDITIONAL INFORMATION TAB
		Actions actions = new Actions(driver);
		actions.sendKeys(Keys.PAGE_UP).build().perform();
		Thread.sleep(500);
		driver.findElement(By.xpath("(//div[@class='ant-steps-item-icon'])[7]/..")).click();

		// Expected Window Displayed or Not
		TestConfigNavigation.expectedwindow("STEP_14--THE EXPECTED WINDOW HEADING PROPERTYS", testnav.additionalheading,
				"01--EXPECTED WINDOW HEADING DISPLAYED", "Additional Information");
