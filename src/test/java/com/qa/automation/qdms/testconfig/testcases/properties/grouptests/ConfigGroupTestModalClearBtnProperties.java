...
//* Description
//*------------
//* Configured Group Test - Configured Group Tests Table - Clear Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-106         11/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfigGroupTestModalClearBtnProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void configGroupTestClearBtn() throws InterruptedException, IOException {
		...
		//Calling the method
		configGroupTestClearBtnProperties();
	...
	public static void configGroupTestClearBtnProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			//Calling the method
			configGroupTestClearBtnPropertiess() ;
		} 
	...
	public static void configGroupTestClearBtnPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Heading Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-106-02", GroupTestsPage.configgrouptestclearbtn, "Configured Group Tests Table Clear Button Properties");
	}
}
