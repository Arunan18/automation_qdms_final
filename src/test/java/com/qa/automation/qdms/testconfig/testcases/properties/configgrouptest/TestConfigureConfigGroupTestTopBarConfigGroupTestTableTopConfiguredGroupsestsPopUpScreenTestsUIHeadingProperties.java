...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test Table Top Configured Groups Tests Pop Up Screen Tests UI Heading  Properties
******************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0055           06/07/2023   M.Mathushan    Original Version
*
*******************************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsestsPopUpScreenTestsUIHeadingProperties extends DriverIntialization{
	
	static configGroupTestsPage lk = new configGroupTestsPage();
	   
	@Test

	public static void configureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsestsPopUpScreenTestsUIHeadingProperties ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0055-01");
		...
		// Check Properties
		 configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsestsPopUpScreenTestsUIHeadingProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsestsPopUpScreenTestsUIHeadingProperties() throws InterruptedException {

		PageFactory.initElements(driver, lk);
Thread.sleep(2000);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0055-02", configGroupTestsPage.configGroupTest_AfterDropDownconfiguredtesttestheading,
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Configure Group Test Test Heading Properties");
