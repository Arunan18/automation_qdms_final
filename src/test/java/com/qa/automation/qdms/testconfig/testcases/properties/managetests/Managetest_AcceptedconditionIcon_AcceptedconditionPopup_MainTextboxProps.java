...
//* Description
//*------------
//* Test Configure - Manage Test Configuration Tab- Accepted Condition- Accepted Condition Pop up Screen-Main Text Box  Properties
//***************************************************************************************
//*
//* Author           : N.Karunya
...
//* ================       ====         =====        ========
//* MTC-MT-325          05/07/2023    N.Karunya   Original Version                
//************************************************************************************
...
public class Managetest_AcceptedconditionIcon_AcceptedconditionPopup_MainTextboxProps extends DriverIntialization {
	...
	@Test
	public static void mainTextbox() throws InterruptedException, IOException {

		// CALLING THE COMMON METHOD FOR NAVIGATE FROM-LOGIN TO SCROLLING IN THE MANAGE
		// TEST PAGE
		NavigateManageTestFromLogin.navigateManageTestFromLogin("Manage Tests", 11);

		// Check Accepted Condition Popup Main Textbox UI Properties
		mainTextboxExcel();
	...
	public static void mainTextboxExcel() throws IOException {
	...
	public static void mainTextboxProperties() {
		...
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-325-02", ManageTestsPage.maintextbox,
				"Manage Test - Accepted Condition Popup Screen Main Textbox Properties");
