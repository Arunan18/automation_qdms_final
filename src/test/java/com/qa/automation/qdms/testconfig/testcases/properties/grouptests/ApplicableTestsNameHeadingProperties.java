...
//* Description
//*------------
//*Config Group Test - Applicable Tests Table "Test Name" Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-083          06/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ApplicableTestsNameHeadingProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void testsNameHeading() throws InterruptedException, IOException {
	...
	public static void testsNameProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void testsNamePropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Name Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-083-02", GroupTestsPage.editiconpopuptestname, "Tests Name Heading Properties");
	}
}
