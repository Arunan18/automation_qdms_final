...
//* Description
//*------------
//* Manage Test "Action" - Column Edit Icon Pop up Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-066         05/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ActionColumnEditIconPopupProperties extends DriverIntialization {
	...
	public static void editPopupProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void actionEditPopupPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Column Pop up Properties
		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-066-02", GroupTestsPage.actionediticonpopup, "Action Column Edit Icon Popup UI Properties");
	}
}
