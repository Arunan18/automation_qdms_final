...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - "Value" Data Field Heading UI Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0551         11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class EditiconPopupScreenValueDataFieldHeadingUIProperties extends DriverIntialization {
	...
	public static void commonMethodHeadingProperties() throws InterruptedException, IOException {
		...
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0551-02", TestConfigPage.reviewTestParaMeterEditIconPopValueHead,
				"Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - Value Data Field Heading UI Properties");
