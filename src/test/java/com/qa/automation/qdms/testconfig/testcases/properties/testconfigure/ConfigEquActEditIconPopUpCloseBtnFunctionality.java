 ...
 * ================        ====         =====          ========
 * TC-TCN-0609			 07/07/2023   Shangeetha    Original Version  
 ***************************************************************************************************************/
...
public class ConfigEquActEditIconPopUpCloseBtnFunctionality extends DriverIntialization{
	...
	public static void editIconPopUpCloseButtonFunctionality() {
		...
		//Check 'Edit' Icon Pop-Up, 'Close' Button Functionality
		functionality.ButtonAndIconunctionalityMtd("'Close' Button Functionality", TestConfigPage.configEquActionEditIconPopCloseBtn, "Button");
