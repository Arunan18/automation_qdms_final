...
* ================       ====         =====        ========
*TC-TCN-0843           22/06/2023   Quenthan     Orginal Version
*
************************************************************************************/
...
public class ReviewTest_Material_PopupOkButtonProperties extends DriverIntialization {
	...
	public void modalproperties() throws InterruptedException, IOException {
		...
		TestConfiRev_MaterialSubHeadingProperties.navicateAndProperties("Test_Configure", "TC-TCN-0843-01", 2);

		// Click Material View Icon
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Test_Configure", "TC-TCN-0843-01");
...
//		Check Properties
	...
	public static void propertiesKeyTestOKButton() {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0843-02",TestConfigPage.materialPuModalOkButton ,
