...
* Description
*------------
Test Configure Configure Submit Button Properties
***********************************************************************************
*
...
* ================       ====         =====        ========
* TC-TCN-0436           13/07/2023    Shobika      Original Version
*
*******************************************************************************/
...
import com.qa.automation.qdms.testconfig.pages.TestConfigPage;
	...
	public class ConfigureTestTableSubmitButtonProperties extends DriverIntialization {
		static TestConfigPage submitbutton = new TestConfigPage();
		...
		public void ConfigureTestTableDueDayToggleButtonPropertie() throws InterruptedException, IOException {
			...
			// Test Configure Submit Button Properties
			submitbutton();
			// Refresh 
		...
		public void submitbutton() {
			PageFactory.initElements(driver, submitbutton);
			try {
		...
		public  void submitButton() {
			...
			PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
					"TC-TCN-0436-02", TestConfigPage.submitbutton,
					"Test Configure Configure Submit Button Properties");
		}
	}
