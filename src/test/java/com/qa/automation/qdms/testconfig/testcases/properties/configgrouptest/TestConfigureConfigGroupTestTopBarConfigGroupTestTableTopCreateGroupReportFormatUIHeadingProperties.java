...
* Description
*------------
* Test Configure - Config Group Test Top Bar Config Group Test Table Top Create Group Report Format UI Heading Properties
**************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0042           05/07/2023   M.Mathushan    Original Version
*
***************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopCreateGroupReportFormatUIHeadingProperties extends DriverIntialization {

static configGroupTestsPage lk = new configGroupTestsPage();
	
	@Test
	
	public static void configureConfigGroupTestTopBarConfigGroupTestTableTopCreateGroupReportFormatUIHeadingProperties() throws InterruptedException, IOException {
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0042-01");
		...
		//Check Properties
		configGroupTestTopBarConfigGroupTestTableTopCreateGroupReportFormatUIHeadingProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopCreateGroupReportFormatUIHeadingProperties() {

		PageFactory.initElements(driver, lk);

		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0042-02", configGroupTestsPage.configGroupTest_AfterDropDowncreatereportformatheading,
				"Step-4--Config Group Test- After Drop Down Table - Create report format Heading Properties");
