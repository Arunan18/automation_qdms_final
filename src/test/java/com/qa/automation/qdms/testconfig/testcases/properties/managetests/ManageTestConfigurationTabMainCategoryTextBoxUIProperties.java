...
* Description
*------------
* Test Configure Manage Test Configuration Tab Main Category Text Box UI Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-138           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class ManageTestConfigurationTabMainCategoryTextBoxUIProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
	@Test

	public static void testConfigurationTabMainCategoryTextBoxUIProperties  ()
		...
		configurationTabMainCategoryTextBoxUIProperties();
	...
	public static void configurationTabMainCategoryTextBoxUIProperties  () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-138-02",ManageTestsPage.testConfigureManageTestConfigurationTabedmaincategorysearchiconProperties,
				"Step-4--testConfigure ManageTest Configuration Tab maincategory Search TextBox Properties");
	}
