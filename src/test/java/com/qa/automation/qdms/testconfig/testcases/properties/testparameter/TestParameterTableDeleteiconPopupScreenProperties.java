...
* Description
*------------
*Test Parameter Table  Delete icon Pop up Screen Properties
************************************************************************************
*
...
* ================       ====         =====        ========
*TC-PAR-0107			 15/07/2023    Shobika      Original Version
*
*******************************************************************************/
...
public class TestParameterTableDeleteiconPopupScreenProperties extends DriverIntialization {
	static TestConfigPage deleteiconpopupscreen = new TestConfigPage();
	...
	public static void TestParameterTableEditParameterPopupScreenUpdateButtonPropertie()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Test_Parameter", "TC-PAR-0107-01");
		// edit pop-up screen properties
		deleteiconppupScreen(TestConfiRev_MaterialSubHeadingProperties.adddata.get(0));
		// Refresh
	...
	public static void deleteiconppupScreen(String data) {

		PageFactory.initElements(driver, deleteiconpopupscreen);
		try {
			TestConfigPage.paraMeterbutton.click();
			try {
				driver.findElement(By.xpath("//td[text()='" + data + "']//following-sibling::td/span/a[2]")).click();
				Thread.sleep(2000);
				deleteiconppupscreen();
	...
	public static void deleteiconppupscreen() {
		PageFactory.initElements(driver, deleteiconpopupscreen);
		// delete pop-up screen Properties
		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Test_Parameter", "TC-PAR-0107-02",
				TestConfigPage.deleteiconpopupscreen, "delete icon pop-up screen  Properties");
	}
}
