...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - "Type" Drop Down Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0544         11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class EditIconPopupScreenTypeDropDownProperties
	...
	public static void commonMethodDropDownProperties() throws InterruptedException, IOException {
		...
		ProCommonMethods.dropDown("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0544-02",
				TestConfigPage.reviewTestParaMeterEditIconPopTypeDropDown,
				"Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - Type Drop Down Properties","1");
