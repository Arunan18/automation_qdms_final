...
public class GroupTestsPaginationNextButtonProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test

	public static void groupTestsPaginationNextButton() throws InterruptedException, IOException {
		...
		//Calling the method
		groupTestsPaginationNextButtons();
	...
	public static void groupTestsPaginationNextButtons() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void groupTestsPaginationNextBtn() {
		PageFactory.initElements(driver, GroupTestpg);
