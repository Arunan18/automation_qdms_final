...
* Description
*------------
Test Configure Table - Parameter Table Middle Page- Test Parameter Table- "Decimal Value" Text Box Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0518         07/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableMiddlePageTestParameterTableDecimalValueTextBoxProperties
	...
	public static void scrollDownUntilElementFound() throws InterruptedException, IOException {
		...
		// check properties
		commonMethodForTextBoxProperties();

	}

	public static void commonMethodForTextBoxProperties() throws InterruptedException, IOException {

		PageFactory.initElements(driver, testConfig);

		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0518-02",
				TestConfigPage.paraMeterAddParaMeterValueSubHead, "Decimal Value Text Box Properties");
