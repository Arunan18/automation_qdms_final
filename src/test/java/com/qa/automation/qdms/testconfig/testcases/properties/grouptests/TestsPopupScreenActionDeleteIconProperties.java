...
//* Description
//*------------
//* Groups Tests - "Tests" Icon Column Pop up Screen Delete Icon Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-056         10/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class TestsPopupScreenActionDeleteIconProperties extends DriverIntialization {
	...
	public static void actionDeleteIconPropertiess() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void actionDeleteIconProperties() {	
		...
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Group_Test", "MTC-GT-056-02", GroupTestsPage.testspopupactioncolumndeleteicon, "Tests Icon Popup Screen Action Column Delete Icon Properties");
	}
}
