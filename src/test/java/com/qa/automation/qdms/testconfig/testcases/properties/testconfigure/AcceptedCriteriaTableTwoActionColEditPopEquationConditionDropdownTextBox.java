 ...
 * "Equation (Equal,Between, >,<)Drop-down", Text Box Properties
 **********************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0687		    14/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class AcceptedCriteriaTableTwoActionColEditPopEquationConditionDropdownTextBox extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Edit Icon Pop-Up: 'Equation (Equal,Between, >,<) Drop-down' Text Box Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Get Edit Icon Pop-Up: 'Equation (Equal,Between, >,<) Drop-down' Text Box Properties	
	...
	public static void methodTextBoxProperties() {
		...
		//Get Edit Icon Pop-Up: 'Equation (Equal,Between, >,<) Drop-down' Text Box Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0687-02", TestConfigPage.tableTwoActionColEditPopEquationDropTextBox, "'Equation (Equal,Between, >,<) Drop-down' Text Box  Properties");
