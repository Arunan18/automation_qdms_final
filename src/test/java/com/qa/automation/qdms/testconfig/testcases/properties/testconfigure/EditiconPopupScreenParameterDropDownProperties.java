...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - "Parameter" Drop Down Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0542     11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class EditiconPopupScreenParameterDropDownProperties
	...
	public static void excelMethodCheckBox() throws InterruptedException, IOException {
		...
		try {
			...
			try {
				...
				// Get Properties
				commonMethodDropDownProperties();
	...
	public static void commonMethodDropDownProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, testConfig);

		ProCommonMethods.dropDown("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0542-02",
				TestConfigPage.reviewTestParaMeterEditIconPopParaDropDown,
				"Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - Parameter Drop Down Properties","1");
