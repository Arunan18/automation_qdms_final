...
//* Description
//*------------
//* Manage Test "Group Test" - Main Category Search TextBox Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*  MTC-GT-030      	 25/06/2023      Sasi     Original Version
//*
//************************************************************************************
...
public class MainCategorySearchTextBoxProperties extends DriverIntialization{
	...
	public static void mainCategoryTextBoxProperties() {
		...
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Group_Test", "MTC-GT-030-02",
				GroupTestsPage.mainCategoryTextBox, "Main Category TextBox Properties");
	}
}
