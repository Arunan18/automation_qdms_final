...
//* Description
//*------------
//* Group Tests - Config Group Test - Create Group Table - "Report Format" Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-080         12/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class CreateGroupTableReportFormatHeading extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void reportFormatHeading() throws InterruptedException, IOException {
	...
	public static void reportFormatProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			try {	
				GroupTestsPage.editiconpopupreporttypeheading.click();

				//Calling the method
				reportFormatPropertiess();

			}
			catch (NoSuchElementException e) {
				testCase = extent.createTest("Checking Report Format heading");
				testCase.log(Status.INFO, "Unable to Locate Report Format heading");
				testCase.log(Status.FAIL, "TEST FAIL");

			} catch (ElementClickInterceptedException e) {
				testCase = extent.createTest("Checking Report Format heading");
				testCase.log(Status.INFO, "Report Format heading is not Clicked");
				testCase.log(Status.FAIL, "TEST FAIL");

			} catch (Exception e) {
				testCase = extent.createTest("Checking Report Format heading");
				testCase.log(Status.INFO, "Report Format heading Click is not Occured");
				testCase.log(Status.FAIL, "TEST FAIL");
			}
	...
	public static void reportFormatPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Column Pop up Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-080-02", GroupTestsPage.editiconpopupreportformatheading, "Report Format Heading Properties");
	}
}
