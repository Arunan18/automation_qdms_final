...
* Description
*------------
* Test Configure Manage Test Configuration Tab Raw Material Search Button  UI Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-149           12/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class   ManageTestConfigurationTabRawMaterialSearchButtonUIProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
	@Test

	public static void testConfigurationTabRawMaterialSearchButtonUIProperties   ()
		...
		//Check the Manage Test Configuration TabKey Test Icon Properties
		 configurationTabRawMaterialSearchButtonUIProperties();
	...
	public static void configurationTabRawMaterialSearchButtonUIProperties  () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-149-02",ManageTestsPage.testConfigureManageTestConfigurationTabedrawmaterialsearchbutton,
				"Step-4--testConfigure ManageTest Configuration Tab Raw Material Search Button Properties");
	}
