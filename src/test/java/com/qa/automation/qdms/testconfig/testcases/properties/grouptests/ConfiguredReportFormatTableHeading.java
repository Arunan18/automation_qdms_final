...
//* Description
//*------------
//* Config Group Test - Configured Groups Table "Report Format" Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-090          06/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfiguredReportFormatTableHeading extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void reportFormatTableHeading() throws InterruptedException, IOException {
	...
	public static void reportFormatHeadingProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			//Calling the method
			reportFormatTableHeadingPropertiess() ;
		} 
	...
	public static void reportFormatTableHeadingPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Group Name Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-090-02", GroupTestsPage.editiconpopupreportformat, "Report Format Heading Properties");
	}
}
