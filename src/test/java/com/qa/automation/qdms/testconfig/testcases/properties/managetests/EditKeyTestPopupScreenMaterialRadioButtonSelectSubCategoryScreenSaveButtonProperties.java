...
* Description
*------------
* Test Configure  Manage Test Configuration Tab Key Test Icon  Edit Key Test Pop up Screen Material  Radio Button Select Sub Category Screen Save Button Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-131           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class   EditKeyTestPopupScreenMaterialRadioButtonSelectSubCategoryScreenSaveButtonProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
    static String test =null;
	@Test

	public static void keyTestPopupScreenMaterialRadioButtonSelectSubCategoryScreenSaveButtonProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-131-01");
		...
		testPopupScreenMaterialRadioButtonSelectSubCategoryScreenSaveButtonProperties();
	...
	public static void testPopupScreenMaterialRadioButtonSelectSubCategoryScreenSaveButtonProperties () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		Thread.sleep(1000);
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-131-02",ManageTestsPage.editKeyTestPopupmaterialselectsubcategorysearchmaterialsavebuttonProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test Pop up Screen Select Subcategory Screen Save Button Properties");
	}
