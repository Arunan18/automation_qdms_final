...
//* Description
//*------------
//* SUB CATEGORY SINGLE SEARCH & RESET FOR GROUP TEST
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-010			 28/04/2023   Gobithan     Orginal Version
//* MTC-GT-011			 28/04/2023   Gobithan     RESET
//************************************************************************************
...
public class SubCategorySingleSearch extends DriverIntialization{
	...
	public static void action() throws InterruptedException, IOException
	{
		...
		SampleSingleSearchMethods.newSingleSearch(grouptest.subcatsearchicon, grouptest.subcatsearchtextbox,
				grouptest.maincatsearchbutton, "SUB CATEGORY SINGLE SEARCH",
				"Test Configuragtion Module", "Group_Tests", "MTC-GT-010", 1, 2, grouptest.tableColoumnoSubcategory,
				"//tbody[@class='ant-table-tbody']/tr[", "]/td[3]", testdata);
