...
//* Description
//*------------
//* AddConfigGroupTest_MaterialCategorySpecialType
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-CGT-0020    19/05/2023  Niluxy       Original Version
//*
//************************************************************************************
...
public class AddConfigGroupTest_MaterialCategorySpecialType extends DriverIntialization {
	...
	public static void addgroupconfigure() throws InterruptedException, IOException {
		...
		extent.createTest("TC-CGT-0020-AddConfigGroupTest_MaterialCategorySpecialType");
		// LOGIN TO THE SYSTEM
		LoginTest.Login();
		...
		TestConfigNavigation.mainmethod("STEP 2 :TEST TOP NAVIGATION PROPERTIES", addPage.testtopnav,
				"TEST TOP NAVIGATION BUTTON DISPLAYED", "TEST TOP NAVIGATION BUTTON ENABLED",
				addPage.testleftnav, addPage.testparameterleftnav, addPage.testconfigleftnav,
				addPage.configgrouptestleftnav, "ON CLICK THE TEST TOP NAVIGATION REDERECT TO CORRECT WINDOW");
		...
		// ADD MATERIAL CATEGORY FIELD AND SELECT THE SPECIAL TYPE DATA FROM EXCEL
		extent.createTest("STEP 4:ADD THE CONFIG GROUP TEST");
		AddConfigGroupTest.addConfigGroupTest("Test Configuragtion Module", "Config_Group_Test", "TC-CGT-0020");
