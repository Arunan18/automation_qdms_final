...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - "Unit " Drop down Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0546        11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class EditIconPopupScreenUnitDropdownProperties extends DriverIntialization {
	...
	public static void commonMethodDropDownProperties() throws InterruptedException, IOException {
		...
		ProCommonMethods.dropDown("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0546-02",
				TestConfigPage.reviewTestParaMeterEditIconPopUnitDropDown,
				"Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - Unit  Drop down Properties",
				"1");
