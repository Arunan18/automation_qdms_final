...
//* Description
//*------------
//* Test Configure - "Accepted Condition" - Action Column Edit Icon Pop up Screen - Update Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0749        14/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ActionColumnEditPopupScreenUpdateBtn extends DriverIntialization {
	static TestConfigPage testconfigurebutton = new TestConfigPage();
	static String code = null;
	@Test
	public static void editIconPopupUpdateBtn() throws InterruptedException, IOException {
		// Calling The Common Method To Navigate From The Login Page To Scrolling In The Manage Test Page and Click on Edit Configure Icon
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 14, "Description", "Test Configuration Properties","Test_Configure", "TC-TCN-0749");
		...
		//Calling the method
		editIconPopupUpdateBtnProperties();
	...
	public static void editIconPopupUpdateBtnProperties() throws InterruptedException, IOException {
		...
		try {
			...
			//Calling the method
			editIconPopupUpdateBtnPropertiess();
	...
	public static void  editIconPopupUpdateBtnPropertiess(){
		PageFactory.initElements(driver, testconfigurebutton);

		//Check Action Column Edit Icon Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0749-02", TestConfigPage.editiconpopupupdatebtn, "Action Column Edit Icon Pop up Screen Update Button Properties");
	}	
}
