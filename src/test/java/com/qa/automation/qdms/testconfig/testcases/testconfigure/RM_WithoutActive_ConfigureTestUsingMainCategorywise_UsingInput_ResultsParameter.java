...
//* Description
//*------------
//* RawMaterial_WithoutActive_ConfigureTestUsingMainCategorywise_UsingInput_ResultsParameter
//***********************************************************************************
//*
//* Author           : Niluxy Krishnathavam
//* Date Written     : 9/06/2023
//* 
//*
//* 
//* Test Case Number       Date         Intis        Comments
//* ================       ====         =====        ========
//*TC-TCN-0400           9/06/2023    Niluxy       Original Version
//*
//************************************************************************************
...
public class RM_WithoutActive_ConfigureTestUsingMainCategorywise_UsingInput_ResultsParameter extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		extent.createTest("TC-TCN-0400:RM_WithoutActive_ConfigureTestUsingMainCategorywise_UsingInput_ResultsParameter");
		// LOGIN TO THE SYSTEM
		LoginTest.Login();
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0400-first");
		Thread.sleep(2000);
		// STEP2 :SELECTING THE PARAMETER IN TEST PARAMETER PAGE
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0400-second");
		Thread.sleep(3000);
		// STEP3 :ADD THE PARAMETER
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0400-second");
		Thread.sleep(3000);
		// STEP4 :ADD THE EQUATIONS
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0400-third");
		Thread.sleep(3000);
		// MOVE TO NEXT PAGE
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);
		// STEP5 : ADD THE ACCEPTCRETERIA
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0400-fourth");
		Thread.sleep(3000);
		// MOVE TO DOWN
		...
		Thread.sleep(3000);
		// STEP6 :ADD TEST KEYS
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0400-fifth");
		// MOVE TO NEXT PAGE
		Thread.sleep(3000);
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();
		TestConfigPage.nextBtn.click();
		...
		Thread.sleep(3000);
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0400-seventh");
		// DOWN THE PAGE
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();
		// MOVE TO NEXT PAGE
		TestConfigPage.nextBtn.click();
		...
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0400-first",
				"TC-TCN-0400-second", "TC-TCN-0400-third", "TC-TCN-0400-fourth", "TC-TCN-0400-fifth", "",
				"TC-TCN-0400-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0400-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "First",
