...
//* Description
//*------------
//* AddConfigGroupTest_MainCategoryReportType
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-CGT-0001             19/05/2023  Niluxy       Original Version
//*
//************************************************************************************
...
public class AddConfigGroupTest_MainCategoryReportType extends DriverIntialization {
	...
	public static void addgroupconfigure() throws InterruptedException, IOException {
		...
		extent.createTest("TC-CGT-0001-AddConfigGroupTest_MainCategoryReportType");
		...
		//ADD MAIN CATEGORY FIELD AND SELECT THE REPORT TYPE DATA FROM EXCEL
		extent.createTest("STEP 4:ADD THE CONFIG GROUP TEST");
		AddConfigGroupTest.addConfigGroupTest("Test Configuragtion Module","Config_Group_Test","TC-CGT-0001");	
