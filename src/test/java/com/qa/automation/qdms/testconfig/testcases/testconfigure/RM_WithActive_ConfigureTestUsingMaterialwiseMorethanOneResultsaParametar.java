...
//* Description
//*------------
//*  RawMaterialWithActive_ConfigureTestUsingMaterialwiseMorethanOneResultsaParametar
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-TCN-0253            25/05/2023    Niluxy       Orginal Version
//*
//************************************************************************************
...
public class RM_WithActive_ConfigureTestUsingMaterialwiseMorethanOneResultsaParametar extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		extent.createTest("TC-TCN-0253:RM_WithActive_ConfigureTestUsingMaterialMainCategorywiseMorethanOneResultsaParametar");
		// LOGIN TO THE SYSTEM
		LoginTest.Login();
...
//STEP1 :ADD  THE CONFIGURETEST	
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0253-first");
		Thread.sleep(2000);
//STEP2 :SELECTING THE PARAMETER IN TEST PARAMETER PAGE
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0253-second");
		Thread.sleep(3000);
//STEP3 :ADD THE PARAMETER		
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0253-second");
		Thread.sleep(3000);
//STEP4 :ADD THE EQUATIONS
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0253-third");
		Thread.sleep(3000);
//MOVE TO NEXT PAGE
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);
//STEP5 : ADD THE ACCEPTCRETERIA
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0253-fourth");
		Thread.sleep(3000);
//MOVE TO DOWN 
...
//MOVE TO NEXT PAGE 
		...
		Thread.sleep(3000);
//STEP6 :ADD TEST KEYS 
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0253-fifth");
//MOVE TO NEXT PAGE	
		Thread.sleep(3000);
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();
		TestConfigPage.nextBtn.click();
//STEP7 :ADD ACCEPTED CONDITION
				AcceptCondition.condition("Test Configuragtion Module", "Test_Configure", "TC-TCN-0253-sixth");
				TestConfigPage.nextBtn.click();
//STEP8 :ADD ADITIONAL INFORMATION
		Thread.sleep(3000);
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0253-seventh");
//DOWN THE PAGE		
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();
//MOVE TO NEXT PAGE		
		TestConfigPage.nextBtn.click();
...
// STEP9:  REVIEW TEST CHECK IN REVIEW TAB 
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0253-first",
				"TC-TCN-0253-second", "TC-TCN-0253-third", "TC-TCN-0253-fourth", "TC-TCN-0253-fifth",
				"TC-TCN-0253-sixth", "TC-TCN-0253-seventh");
...
//STEP11 :CONFIRM THE TEST HAS BEEN ADDED OR NOT IN SAMPLES    
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0253-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "First",
