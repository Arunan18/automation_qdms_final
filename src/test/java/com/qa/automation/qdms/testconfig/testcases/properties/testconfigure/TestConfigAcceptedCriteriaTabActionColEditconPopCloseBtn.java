 ...
 * ================        ====         =====          ========
 * TC-TCN-0696		    12/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaTabActionColEditconPopCloseBtn extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check 'Edit' Icon Pop-Up, 'Close' Button Properties
	...
	public static void editIconPopUpCloseButtonProperties() {
		...
		//Check 'Edit' Icon Pop-Up, 'Close' Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0696-02", TestConfigPage.acceptedCriteriaTableTwoActionColEditPopCloseBtn,"Edit Icon Pop-Up, 'Close' Button Properties");
