...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen -"Cancel" Button Functionality
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0560        11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class EditiconPopupScreenCancelButtonFunctionality extends DriverIntialization {
	...
	public static void commonMethodTextBoxProperties() throws InterruptedException, IOException {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(TestConfigPage.reviewTestParaMeterEditIconPopCancelButtonProps));

		try {
			if (TestConfigPage.reviewTestParaMeterEditIconPopCancelButtonProps.isDisplayed()) {

				testCase = extent.createTest("STEP-1-CANCEL BUTTON IS DISPLAYED");
				testCase.log(Status.PASS, "TEST PASS ☑");

				if (TestConfigPage.reviewTestParaMeterEditIconPopCancelButtonProps.isEnabled()) {
					...
					try {
						...
						TestConfigPage.reviewTestParaMeterEditIconPopCancelButtonProps.click();
