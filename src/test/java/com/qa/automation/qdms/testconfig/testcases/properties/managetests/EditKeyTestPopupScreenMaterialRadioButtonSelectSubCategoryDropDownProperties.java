...
* Description
*------------
* Test Configure - Manage Test Configuration Tab Key Test Icon Edit Key Test Pop up Screen Material  Radio Button Select Sub Category Drop Down Properties
***********************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-128           11/07/2023   M.Mathushan    Original Version
*
*************************************************************************************************************************************************************/
...
public class  EditKeyTestPopupScreenMaterialRadioButtonSelectSubCategoryDropDownProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
    static String test =null;
	@Test

	public static void iconkeyTestPopupScreenMaterialRadioButtonSelectSubCategoryDropDownProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-128-01");
	...
	public static void keyTestPopupScreenMaterialRadioButtonSelectSubCategoryDropDownProperties () throws InterruptedException {
		...
		ProCommonMethods.dropDown("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-128-02",ManageTestsPage.editKeyTestPopupmaterialselectsubcategorydropdownProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test Pop up Screen Material SubCategory Drop Down Properties", "1");
	}
