...
//* Description
//*------------
//* Manage Test - Action Pop up Screen OK Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-111          05/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ActionDeletePopupScreenOkBtnProperties extends DriverIntialization  {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void deletePopupOkBtn() throws InterruptedException, IOException {
	...
	public static void actionPopupOkButtonProperties() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Action Pop up Screen Ok Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-111-02", GroupTestsPage.actionpopupokbutton, "Action Popup Screen Ok Button Properties");
	}
}
