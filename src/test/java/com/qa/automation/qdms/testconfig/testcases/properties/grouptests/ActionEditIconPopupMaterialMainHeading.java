...
//* Description
//*------------
//* Manage Test Edit Pop up Screen "Material Main Category" Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-067         05/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ActionEditIconPopupMaterialMainHeading extends DriverIntialization {
	...
	public static void materialMainCategoryHeading() throws InterruptedException, IOException {
		...
		//Calling the method
		materialMainCategoryHeadingProperties();
	...
	public static void materialMainCategoryHeadingProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void mainCategoryHeadingProperties() {
		...
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-067-02", GroupTestsPage.materialmaincategoryheading, "Edit Icon Pop up Material Main Category Heading Properties");
	}
}
