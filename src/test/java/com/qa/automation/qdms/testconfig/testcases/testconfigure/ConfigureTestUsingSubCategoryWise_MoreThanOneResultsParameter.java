...
//* Description
//*------------
//**TC-TCN-0345 - Configure Test Using Main Category wise (more than one results parameter)
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-TCN-0345          26/05/2023      RAHUL.S       Original Version
...
public class ConfigureTestUsingSubCategoryWise_MoreThanOneResultsParameter extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		extent.createTest("TC-TCN-0345:Configure Test Using Main Category wise (more than one results parameter)");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0345-first");
		Thread.sleep(2000);

		// STEP2 :SELECTING THE PARAMETER IN TEST PARAMETER PAGE
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0345-second");
		Thread.sleep(3000);

		// STEP3 :ADD THE PARAMETER
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0345-second");
		Thread.sleep(2000);

		// STEP4 :ADD THE EQUATIONS
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0345-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0345-fourth");
		Thread.sleep(3000);
		...
		// STEP6 :ADD TEST KEYS
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0345-fifth");
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

		// STEP7 :ADD ACCEPTED CONDITION
		AcceptCondition.condition("Test Configuragtion Module", "Test_Configure", "TC-TCN-0345-sixth");
		...
		Thread.sleep(3000);
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0345-seventh");
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();
		...
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0345-first",
				"TC-TCN-0345-second", "TC-TCN-0345-third", "TC-TCN-0345-fourth", "TC-TCN-0345-fifth",
				"TC-TCN-0345-sixth", "TC-TCN-0345-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0345-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "first",
