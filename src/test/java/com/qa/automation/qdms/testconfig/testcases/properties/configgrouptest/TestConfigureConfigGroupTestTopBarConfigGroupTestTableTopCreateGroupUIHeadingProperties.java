...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test Table Top Create Group UI Heading Properties
***************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0039           05/07/2023   M.Mathushan    Original Version
*
**************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopCreateGroupUIHeadingProperties extends DriverIntialization {
	static configGroupTestsPage lk = new configGroupTestsPage();
	
	@Test
	
	public static void configGroupTestTopBarConfigGroupTestTableTopCreateGroupUIHeadingProperties() throws InterruptedException, IOException {
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0039-01");
		...
		//Check Properties
		configGroupTestTopBarConfigGroupTestTableTopCreateGroupUIHeading();
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopCreateGroupUIHeading() {

		PageFactory.initElements(driver, lk);

		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0039-02", configGroupTestsPage.configGroupTest_AfterDropDowncreategroupheading,
				"Step-4--Config Group Test- After Drop Down Table - Create Group Heading Properties");
