...
* Description
*------------
* Test Configure  Manage Test Configuration Tab- Key Test Icon  Edit Key Test Pop up Screen Save Button Properties
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-127           11/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class  keyTestIconEditKeyTestPopupScreenSaveButtonProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
    static String test =null;
	@Test

	public static void TestIconEditKeyTestPopupScreenSaveButtonProperties ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-127-01");
		...
		editKeyTestPopupScreenSaveButtonProperties();
	...
	public static void editKeyTestPopupScreenSaveButtonProperties  () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		Thread.sleep(1000);
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-127-02",ManageTestsPage.editKeyTestPopupScreenSaveButtonProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test Pop up Screen Select for Key Test Save Button Properties");
	}
