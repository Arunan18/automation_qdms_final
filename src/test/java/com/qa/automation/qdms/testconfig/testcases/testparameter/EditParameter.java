...
//* ================       ====         =====        ========
//* TC-PAR-0051  		 25/04/2023   Gobithan     Orginal Version
//*
//************************************************************************************
...
public class EditParameter extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		ActionCommonMethod.actionS(0, 3, testpage.productionSampleTable, "edit", "Test Configuragtion Module.xlsx",
				"Test_Parameter", "TC-PAR-0051-01", 1);
	...
	public static void editmethod() throws InterruptedException, IOException
	{
		PageFactory.initElements(driver, methods);
		...
		XSSFRow row = sheet.getRow(firstRow);
			...
			parametertype = (String) row.getCell(3).getStringCellValue();
			parameterdatatype = (String) row.getCell(4).getStringCellValue();
		...
		SampleCommonMethods.methodoneclick("STEP_8-- UPDATE BUTTON PROPERTIES", testpage.updatebtn,"01-- UPDATE BUTTON DISPLAYED", "02-- UPDATE BUTTON ENABLED",testpage.testparameterheadding,"Parameter","03-- ON CLICK THE UPDATE BUTTON TEST PARAMETER WINDOW DISPLAYED");
