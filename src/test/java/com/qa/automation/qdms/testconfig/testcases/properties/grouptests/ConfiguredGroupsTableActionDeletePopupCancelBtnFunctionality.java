...
//* Description
//*------------
//* Config Group Test - Configured Groups Table- Action Column - Delete Icon Pop up Screen - Cancel Button Functionality
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-102          11/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfiguredGroupsTableActionDeletePopupCancelBtnFunctionality extends DriverIntialization {
	...
	public static void actionColumnCancelBtn() throws InterruptedException, IOException {
		...
		//Calling the method
		actionColumnCancelBtnFunctionalityy();
	...
	public static void actionColumnCancelBtnFunctionalityy() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			try {
				...
				actionColumnCancelBtnFunctionality();
	...
	public static void actionColumnCancelBtnFunctionality() throws InterruptedException {
		PageFactory.initElements(driver, GroupTestpg);

		Thread.sleep(2000);

		//Check Action Column - Delete Icon Pop up Screen - Cancel Button Functionality
		functionality.ButtonAndIconunctionalityMtd("'Cancel' Button Functionality", GroupTestsPage.actioncolumndeleteiconcancelbtn, "Button");
	}
}
