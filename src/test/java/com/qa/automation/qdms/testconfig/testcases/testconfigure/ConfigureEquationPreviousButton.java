...
//* Description
//*------------
//* Configure Equation Previous Button
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0149		 	15/05/2023     Gobithan     Original Version
//* 
//************************************************************************************
...
public class ConfigureEquationPreviousButton extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		AddGroupKey.actionS(0, 14, mangetest.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Test_Configure", "TC-TCN-0149-01", 2);
		...
		Thread.sleep(2000);
		ButtonFunction.buttonfunction("Test Configuragtion Module", "Test_Configure", "TC-TCN-0149",
				"STEP_05--ACCEPTED CONDITION TAB PREVIOUS BUTTON PROPERTYS",
				"01--CONFIGURE EQUATION TAB PREVIOUS BUTTON DISPLAYED",
				"02--CONFIGURE EQUATION TAB PREVIOUS BUTTON ENABLED", TestConfigPage.parametervalue, "Parameter",
				"03--ON CLICK THE CONFIGURE EQUATION TAB REDERECT TO CORRECT WINDOW");
