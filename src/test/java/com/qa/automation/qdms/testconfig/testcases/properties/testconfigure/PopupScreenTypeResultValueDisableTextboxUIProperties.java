...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen -(Type - Result) "Value" Disable Text box  UI Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0554          11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class PopupScreenTypeResultValueDisableTextboxUIProperties extends DriverIntialization {
	...
	public static void excelMethodCheckBox() throws InterruptedException, IOException {
		...
		try {
			...
			try {
				...
				ActionCommonMethod.dropdDown(TestConfigPage.reviewTestParaMeterEditIconPopRConfigTextBox, test2);
	...
	public static void commonMethodTextBoxProperties() throws InterruptedException, IOException {
		...
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0554-02",
				TestConfigPage.reviewTestParaMeterEditIconPopRInputTextBox,
				"Edit icon  Pop up Screen -(Type -Result)Value Enable Text box  UI Properties");
