...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - "Input Methods" Data Field Heading UI Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0549         11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class InputMethodsDataFieldHeadingUIProperties extends DriverIntialization {
	...
	public static void commonMethodHeadingProperties() throws InterruptedException, IOException {
		...
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0549-02", TestConfigPage.reviewTestParaMeterEditIconPopInputMethodHeading,
				"Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - Input Methods Data Field Heading UI Properties");
