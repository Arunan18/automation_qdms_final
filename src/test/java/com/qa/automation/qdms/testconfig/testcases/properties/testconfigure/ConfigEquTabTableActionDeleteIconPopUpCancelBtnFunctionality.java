 ...
 * ================        ====         =====          ========
 * TC-TCN-0615			 08/07/2023   Shangeetha    Original Version  
 ******************************************************************************************************************/
...
public class ConfigEquTabTableActionDeleteIconPopUpCancelBtnFunctionality extends DriverIntialization{
	...
	public static void configureEquation() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Delete Icon Pop-Up, 'Cancel' Button Functionality
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Check 'Delete' Icon Pop-Up, 'Cancel' Button Functionality	
	...
	public static void deleteIconPopUpCancelBtnFunctionality() {
		PageFactory.initElements(driver, testPage);
		//Check 'Delete' Icon Pop-Up, 'Cancel' Button Functionality
		functionality.ButtonAndIconunctionalityMtd("'Cancel' Button Functionality", TestConfigPage.configEquActionDeleteIconPopCancelBtn, "Button");
