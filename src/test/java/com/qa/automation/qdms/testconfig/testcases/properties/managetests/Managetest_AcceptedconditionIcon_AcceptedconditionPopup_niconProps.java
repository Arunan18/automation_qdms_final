...
//* Description
//*------------
//* Test Configure - Manage Test Configuration Tab- Accepted Condition- Accepted Condition Pop up Screen-- "n" icon Properties
//***************************************************************************************
//*
//* Author           : N.Karunya
...
//* ================       ====         =====        ========
//* MTC-MT-327          05/07/2023    N.Karunya   Original Version                
//************************************************************************************
...
public class Managetest_AcceptedconditionIcon_AcceptedconditionPopup_niconProps extends DriverIntialization {
	...
	@Test
	public static void acceptedconditionPopupnIcon() throws InterruptedException, IOException {

		// CALLING THE COMMON METHOD FOR NAVIGATE FROM-LOGIN TO SCROLLING IN THE MANAGE
		// TEST PAGE
		NavigateManageTestFromLogin.navigateManageTestFromLogin("Manage Tests", 11);

		// Check Accepted Condition Popup "n" Icon UI Properties
		acceptedconditionPopupnIconExcel();
	...
	public static void acceptedconditionPopupnIconExcel() throws IOException {
		...
		try {
			...
			acceptedconditionPopupnIconProperties();
	...
	public static void acceptedconditionPopupnIconProperties() {

		PageFactory.initElements(driver, mtp);

		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Manage_Tests", "MTC-MT-327-02",
				ManageTestsPage.nIcon, "Manage Test - Accepted Condition Popup Screen n Icon Properties");
