 ...
 *  "Equation (Equal,Between, >,<)", Text Box Properties
 ****************************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * MTC-MT-221		    14/07/2023    Shangeetha    Original Version  
 **************************************************************************************************************************************/
...
public class ManageTestConfigAcceptedValuePopupEditIconPopEquationValueTextBox extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 8, "Description", "Test Configuration Properties",
				"Manage_Tests", "MTC-MT-221");
		Thread.sleep(2000);

		// Calling The Method To Check The Edit Icon Pop-Up: 'Equation' Text Box Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Get Edit Icon Pop-Up: 'Equation' Text Box Properties	
	...
	public static void methodTextBoxProperties() {
		...
		//Get Edit Icon Pop-Up: 'Equation' Text Box Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Manage_Tests", "MTC-MT-221-02", ManageTestsPage.tableTwoActionColEditPopEquationDropTextBox, "'Equation' Text Box Properties");
