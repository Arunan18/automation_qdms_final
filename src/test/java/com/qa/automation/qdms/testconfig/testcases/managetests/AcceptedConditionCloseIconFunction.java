...
//* Description
//*------------
//* Accepted Condition Close button function - Test Configuration - Test Case
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-MT-092         19/05/2023     Saranka     Original Version
...
public class AcceptedConditionCloseIconFunction extends DriverIntialization {
...
//===================================================== M E T H O D ==========================================================
	...
	public void methodCallingForOKButtonFunc() throws InterruptedException, IOException {
		...
		AcceptedConditionCloseIconFunction.CloseIconFun();
...
//______________________________________________	
	...
	public static void CloseIconFun() throws InterruptedException, IOException {
...
Thread.sleep(1500);
		...
		testCase = extent.createTest("STEP:1 BEFORE CLICK CLOSE BUTTON  MODEL IS VISIBLE");
		try {
...
//__________________________________________
		...
		Thread.sleep(2000);
		WebElement OkButton = driver.findElement(By.xpath("//button[@aria-label='Close']"));
		Thread.sleep(2000);
		SampleActionMethods.clicking(OkButton, 2, "STEP:2 CLOSE BUTTON");
