...
* Description
*------------
* Test Configure - Manage Test Configuration Tab Key Test Icon Edit Key Test Pop up Screen Sub Category UI Heading  Properties
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-119          10/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSubCategoryUIHeadingProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
static String test =null;
	@Test

	public static void configureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSubCategoryUIHeadingProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-119-01");
		...
		manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSubCategoryUIHeadingProperties();
	...
	public static void manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSubCategoryUIHeadingProperties() {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-119-02",ManageTestsPage.testConfigureManageTestConfigurationTabeditKeytestsubcategoryheadingProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test SubCategory UI Heading Properties");
	}
