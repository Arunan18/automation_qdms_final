...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action "Edit icon" Pop up Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0538        10/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TesConTabParaTabLastPartRevTesParaActEditPopProperties
	...
	public static void excelMethodCheckBox() throws InterruptedException, IOException {
		...
		try {
			...
			try {
				...
				// Get Properties
				commonMethodEditiconPopUpProperties();
	...
	public static void commonMethodEditiconPopUpProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, testConfig);

		ProCommonMethods.modal("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0538-02",
				TestConfigPage.reviewTestParaMeterEditIconPop,
				"Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action Edit icon Properties");
