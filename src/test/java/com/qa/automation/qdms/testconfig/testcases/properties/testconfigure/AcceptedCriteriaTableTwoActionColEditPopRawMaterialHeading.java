 ...
 * "Raw Material ", Heading Properties
 **********************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0684		    12/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class AcceptedCriteriaTableTwoActionColEditPopRawMaterialHeading extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Edit Icon Pop-Up: 'Raw Material' Label Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Get Edit Icon Pop-Up: 'Raw Material' Label Properties	
			RawMaterialLabelProperties();			
	...
	public static void RawMaterialLabelProperties() {
		PageFactory.initElements(driver, testPage);
		//Get Edit Icon Pop-Up: 'Raw Material' Label Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0684-02", TestConfigPage.tableTwoActionColEditPopRawMaterialLabel,"'Raw Material' Label Properties");
