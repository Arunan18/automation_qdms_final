...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test "Material Test" Heading UI Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-TC-0043             22/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class testTabTableMainHeading extends DriverIntialization{
	@Test
	...
	public void testtabTableMainHeading() {
		TestConfigPage tcp=new TestConfigPage();
		PageFactory.initElements(driver, tcp);
//      GET PROPERTIES OF STATUS HEADING BY TEXT PROPERTIES COMMON METHOD
      PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test", "TC-TC-0043-01", TestConfigPage.testtableheading,
              "Checking TEST TABLE Heading UI Properties :");
