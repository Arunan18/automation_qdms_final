...
//* Description
//*------------
//* Config Group Test - "Configured Groups" Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-088         06/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfiguredGroupsHeadingProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void configuredGroupsHeading() throws InterruptedException, IOException {
		...
		//Calling the method
		configuredGroupsHeadProperties();
	...
	public static void configuredGroupsHeadProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			//Calling the method
			configuredGroupsHeadingPropertiess() ;
		} 
	...
	public static void configuredGroupsHeadingPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Name Check Box Icon Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-088-02", GroupTestsPage.editiconpopupconfiguredgroups, "Configured Groups Heading Properties");
	}
}
