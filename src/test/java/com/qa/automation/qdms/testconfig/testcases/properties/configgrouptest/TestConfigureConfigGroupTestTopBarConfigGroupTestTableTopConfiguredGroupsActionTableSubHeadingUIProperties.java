...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test Table Top Configured Groups Action Table Sub Heading UI Properties
******************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0058           06/07/2023   M.Mathushan    Original Version
*
*******************************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionTableSubHeadingUIProperties extends DriverIntialization{
	
	static configGroupTestsPage lk = new configGroupTestsPage();
	   
	@Test

	public static void configureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionTableSubHeadingUIProperties ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0058-01");
		...
		// Check Properties
		configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionTableSubHeadingUIProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionTableSubHeadingUIProperties  () throws InterruptedException {

		PageFactory.initElements(driver, lk);
Thread.sleep(2000);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0058-02", configGroupTestsPage.configGroupTest_AfterDropDownconfiguredactionheading,
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Configure Group Action Heading Properties");
