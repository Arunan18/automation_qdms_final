 ...
 * ================        ====         =====          ========
 * TC-TCN-0651		    13/07/2023      Shangeetha    Original Version  
 ***************************************************************************************************************************/
...
public class AcceptedCriteriaFirstTableBetweenMaximumTextBox extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		//Accepted criteria Tab, First Table: Check 'Maximum' Text Box Properties   
	...
	public static void methodSelectDropdownValue() {
		...
		try {
			...
			//Accepted criteria Tab, "Between" Condition, First Table: Check 'Maximum' Text Box Properties     
			methodFirstTableMaximumTextBoxProperties(); 
	...
	public static void methodFirstTableMaximumTextBoxProperties() {
		PageFactory.initElements(driver, testPage);
		//Accepted criteria Tab, "Between" Condition, First Table: Check 'Maximum' Text Box Properties   
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0651-02", TestConfigPage.equationConditionBetweenMaximumTextBox, "'Maximum' Text Box Properties");
	}
}
