 ...
 * ================        ====         =====          ========
 * TC-TCN-0680		    12/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class AcceptedCriteriaTableTwoActionColEditPopParameterHeading extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Edit Icon Pop-Up: 'Parameter' Heading Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Get Edit Icon Pop-Up: 'Parameter' Heading Properties	
	...
	public static void parameterHeadingProperties() {
		...
		//Get Edit Icon Pop-Up: 'Parameter' Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0680-02", TestConfigPage.tableTwoActionColEditPopParameterLabel,"'Parameter' Label Properties");
