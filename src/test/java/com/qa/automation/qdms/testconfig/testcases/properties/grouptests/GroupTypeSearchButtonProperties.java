...
//* Description
//*------------
//* Manage Test "Group Test" - Group Type Search Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*   MTC-GT-049 		 28/06/2023      Sasi       Original Version
//*
//************************************************************************************
...
public class GroupTypeSearchButtonProperties extends DriverIntialization{
	static GroupTestsPage GroupTestpg = new GroupTestsPage();

	@Test
	public static void groupTypeSearch() throws InterruptedException, IOException {
	...
	public static void groupTypeClickIcon() throws IOException, InterruptedException {
		...
		try {
			...
			testCase = extent.createTest("Group Type Search Button");
			...
			// Calling the method
			groupTypeSearchButtonProperties();
	...
	public static void groupTypeSearchButtonProperties() {
		GroupTestsPage GroupTestpg = new GroupTestsPage();
		PageFactory.initElements(driver, GroupTestpg);

		// Check Group Type Search Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Group_Test",
				"MTC-GT-049-02", GroupTestsPage.groupTypeSearchButton, "Group Type Search Button Properties");
	}
}
