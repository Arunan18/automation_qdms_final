 ...
 * Description
 *------------
 * Test Configure Module, Top Bar Accepted criteria, Accepted Value, Second Table,"Action" Column: "Edit" Icon's Pop-Up Properties
 **********************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0678		    11/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaTabActionColEditconPopUp extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Edit Icon Pop-Up Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Check 'Edit' Icon Pop-Up Properties	
	...
	public static void editIconPopUpProperties() {
		...
		ProCommonMethods.modal("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0678-02", TestConfigPage.acceptedCriteriaTableTwoActionColEditPop,"Edit Icon Pop-Up Properties");
