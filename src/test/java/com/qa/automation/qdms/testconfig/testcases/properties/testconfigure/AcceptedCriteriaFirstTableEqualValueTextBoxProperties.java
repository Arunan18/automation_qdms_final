 ...
 * Description
 *------------
 * Test Configure Module, Top Bar Accepted criteria, Accepted Value, "Material" Option, Select " Equal (=)" Condition,
 *  First Table: "Value" Text Box Properties
 ****************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0647		    13/07/2023      Shangeetha    Original Version  
 ***************************************************************************************************************************/
...
public class AcceptedCriteriaFirstTableEqualValueTextBoxProperties extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		//Accepted criteria Tab, First Table: Check 'Value' Text Box Properties   
	...
	public static void methodSelectDropdownValue() {
		...
		try {
			...
			//Accepted criteria Tab, "Equal" Condition, First Table: Check 'Value' Text Box Properties     
			methodFirstTableValueTextBoxProperties(); 
	...
	public static void methodFirstTableValueTextBoxProperties() {
		PageFactory.initElements(driver, testPage);
		//Accepted criteria Tab, "Equal" Condition, First Table: Check 'Value' Text Box Properties   
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0647-02", TestConfigPage.equationConditionEqualValueTextBox, "'Value' Text Box Properties");
	}
}
