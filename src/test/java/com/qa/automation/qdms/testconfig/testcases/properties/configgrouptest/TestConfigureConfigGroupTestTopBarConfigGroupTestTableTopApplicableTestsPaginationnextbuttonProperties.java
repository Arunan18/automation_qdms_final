...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test Table Top Applicable Tests Pagination next button Properties
**************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0047           05/07/2023   M.Mathushan    Original Version
*
***************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopApplicableTestsPaginationnextbuttonProperties extends DriverIntialization {

static configGroupTestsPage lk = new configGroupTestsPage();
	
	@Test
	
	public static void configureConfigGroupTestTopBarConfigGroupTestTableTopApplicableTestsPaginationnextbuttonProperties() throws InterruptedException, IOException {
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0047-01");
		...
		//Check Properties
		configGroupTestTopBarConfigGroupTestTableTopApplicableTestsPaginationnextbuttonProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopApplicableTestsPaginationnextbuttonProperties() {

		PageFactory.initElements(driver, lk);

		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0047-02", configGroupTestsPage.ConfigGroupTest_AfterDropDownapplicabletesttestnamenextbutton,
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Test Name Next Button Properties");
