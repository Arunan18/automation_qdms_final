 ...
 * ================        ====         =====          ========
 * TC-TCN-0693		    12/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class AcceptedCriteriaTableTwoActionColEditPopReleventToResultCheckBox extends DriverIntialization{
	...
	public static void relevantToResultsCheckBox() {
		...
		//Get Edit Icon Pop-Up: 'Relevant to Results' Check-Box Properties
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0693-02", TestConfigPage.tableTwoActionColEditPopRelevantToTestCheckBox,"'Relevant to Results' Check-Box Properties");
