...
//* Description
//*------------
//*Test Configure - Configure Test Table-  Top Bar "Add Key Test" Tab - "Reset"  Button Properties
//***************************************************************************************
//*
//* Author           : THAKSHILA
...
//* ================       ====         =====        ========
//*  
//*TC-TCN-0728       14/07/2023    THAKSHILA    Modified Version                   
//************************************************************************************
...
public class ConfConfiTestTablTopBarAddKeyTestTabResetButnProps extends DriverIntialization {
...
// ADD KEY TEST SUB CATEGORY ICON PROPERTIES
	...
	public static void addkeySubCategoryButtonProperties() {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0728-02", TestConfigPage.selectForKeyMaterResButton,
				"Test Configure - Configure Test Table-  Top Bar Add Key Test Tab - Reset  Button Properties");
