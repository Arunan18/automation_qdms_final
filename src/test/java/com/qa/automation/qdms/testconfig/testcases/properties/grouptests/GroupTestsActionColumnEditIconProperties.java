...
//* Description
//*------------
//* Manage Test "Action" - Column Edit Icon Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-065          05/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class GroupTestsActionColumnEditIconProperties extends DriverIntialization {
	...
	public static void  properr(String code) {
		...
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-065-02", driver.findElement(By.xpath("//td[text()='"+code+"']//following-sibling::td[6]//span[@class='anticon anticon-form']")), "Action Column Edit Icon Properties");
	}	
}
