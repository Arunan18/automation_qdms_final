...
//* Description
//*------------
//* Manage Test Tab Group Test - "Raw Material" Search icon Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*  MTC-GT-040          27/06/2023   Sasi     Original Version
//*
//************************************************************************************
...
public class RawMaterialSearchIconProperties extends DriverIntialization{
	...
	public static void rawMaterialHeadingProperties() {
		...
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Group_Test", "MTC-GT-040-02",
				GroupTestsPage.rawMaterialSearchicon, "Raw Material Seach Icon Properties");
	}
}
