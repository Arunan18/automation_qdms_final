...
* Description
*------------
*Test Parameter Table Add Parameter Button-Pop up Screen Cancel button Properties
***********************************************************************************
*
...
public class TestParameterTableAddParameterButtonPopupScreenCancelbuttonProperties extends DriverIntialization {
	static TestParameterPage parameterancelbutton = new TestParameterPage();

	@Test
	public void TestParameterTableAddParameterButtonPopupScreenCancelbuttonPropertie()
			throws InterruptedException, IOException {
		// login test
		LoginTest.Login();
		// Navigation to TestConfiguration
		TestConfigNavigation.TestConfigurationCard();
		// Test Parameter Table Add Parameter Button-Pop up Screen Cancel button
		// Properties
	...
	public void parameterCancelButton() {
		PageFactory.initElements(driver, parameterancelbutton);
		try {
