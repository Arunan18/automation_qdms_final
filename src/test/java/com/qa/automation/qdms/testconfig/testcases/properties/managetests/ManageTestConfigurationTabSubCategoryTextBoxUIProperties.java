...
* Description
*------------
* Test Configure Manage Test Configuration Tab Sub Category Text Box UI Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-143           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class ManageTestConfigurationTabSubCategoryTextBoxUIProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
	@Test

	public static void testConfigurationTabSubCategorySearchIconHeadingUIProperties   ()
		...
		//Check the Manage Test Configuration TabKey Test Icon Properties
		 testConfigurationTabSubCategoryTextBoxUIProperties();
	...
	public static void testConfigurationTabSubCategoryTextBoxUIProperties () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-143-02",ManageTestsPage.testConfigureManageTestConfigurationTabedsubcategorytextboxProperties,
				"Step-4--testConfigure ManageTest Configuration Tab Subcategory Text Box Properties");
	}
