...
//* Description
//*------------
//* Config Group Test - Applicable Tests Table Pagination Next Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-085          06/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ApplicablePaginationNextButton extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void paginationNextButton() throws InterruptedException, IOException {
		...
		//Calling the method
		paginationNextButtonProperties();
	...
	public static void paginationNextButtonProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			//Calling the method
			paginationNextButtonPropertiess() ;
		} 
	...
	public static void paginationNextButtonPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Pagination Next Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-085-02", GroupTestsPage.editiconpopupnextbutton, "Pagination Next Button Properties");
	}
}
