...
//* Description
//*------------
//* Manage Test Configuration Tab - Delete PopUp "Cancel" Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*   MTC-MT-405          22/06/2023   Sasi     Original Version
//*
//************************************************************************************
...
public class DeletePopUpCancelButtonProperties extends DriverIntialization {
...
//Check Relevant Test Cancel Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-405-02", ManageTestsPage.deleteCancelButtonMT,
				"Manage Test Delete Popup Cancel Button Properties");
	}
}
