...
* Description
*------------
* Configure Test Using Sub Category wise (without due day) (RAW MATERIAL TEST-Without Active)
***********************************************************************************
*
...
* ================       ====         =====        ========
* TC-TCN-0277            24/05/2023   Arunan     Orginal Version
...
public class ConfigureTestUsingSubCategorywiseWithoutDueDayForRawmaterialInActive extends DriverIntialization {
...
//      TESTCASE REPORT
		extent.createTest(
				"TC-TCN-0277-Configure Test Using Sub Category wise (without due day) (RAW MATERIAL TEST-Without Active)");
...
//        Configure Test Configure Test Step
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0277-first");
		Thread.sleep(500);

//        Select Parameter in Parameter Step
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0277-second");
		Thread.sleep(500);

//        Add parameter in Parameter Step
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0277-second");
		Thread.sleep(500);

//        Add Equation in Equation Step
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0277-third");
		Thread.sleep(3000);
...
//        Add Accepted Value in Accepted creatia Step
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0277-fourth");
		Thread.sleep(3000);
...
//        Add Key Test in Key Test Step
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0277-fifth");
...
//        Add Additional Information in Additional Information Step
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0277-seventh");
...
//		Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0277-first",
				"TC-TCN-0277-second", "TC-TCN-0277-third", "TC-TCN-0277-fourth", "TC-TCN-0277-fifth",
				"TC-TCN-0277-sixth", "TC-TCN-0277-seventh");
...
// 		DONE BUTTON PROPERTYS
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0277-eigth", AddConfigureTest.testname, AddConfigureTest.testtype, "First",
