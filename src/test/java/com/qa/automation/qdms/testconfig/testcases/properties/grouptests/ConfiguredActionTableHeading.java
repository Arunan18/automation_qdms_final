...
//* Description
//*------------
//* Config Group Test - Configured Groups Table "Action" Table Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-096         06/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfiguredActionTableHeading extends DriverIntialization {
	...
	public static void actionTableHeadingProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void actionTableHeadingPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-096-02", GroupTestsPage.editiconpopupaction, "Action Table Heading Properties");
	}
}
