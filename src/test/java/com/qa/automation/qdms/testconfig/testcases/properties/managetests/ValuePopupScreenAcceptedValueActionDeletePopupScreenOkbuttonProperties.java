...
* Description
*------------
*Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen - Accepted Value-Action - Delete Pop up Screen  "Ok " button Properties 
***************************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
*  
*MTC-MT-235       17/07/2023    THAKSHILA    Modified Version    */
...
public class ValuePopupScreenAcceptedValueActionDeletePopupScreenOkbuttonProperties extends DriverIntialization {
	...
	public static void popUpScreenButtonProperties() {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests", "MTC-MT-235-02",
				ManageTestsPage.acceptValuePopDeletePopUpOkButton,
				"Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen - Accepted Value-Action - Delete Pop up Screen  Ok  button Properties ");
