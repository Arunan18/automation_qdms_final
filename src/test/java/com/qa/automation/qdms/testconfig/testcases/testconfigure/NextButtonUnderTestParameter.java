...
//* Description
//*------------
//* Next Button Function Under Test Parameter
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0128			 17/05/2023   Gobithan     Orginal Version
//*
//************************************************************************************
...
public class NextButtonUnderTestParameter extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		AddGroupKey.actionS(0, 14, ManageTestsPage.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Test_Configure", "TC-TCN-0128-01", 2);
		...
		Thread.sleep(2000);
		ButtonFunction.buttonfunction("Test Configuragtion Module", "Test_Configure", "TC-TCN-0128",
				"STEP_06--TEST PARAMETER NEXT BUTTON PROPERTYS", "01--TEST PARAMETER NEXT BUTTON DISPLAYED",
				"02--TEST PARAMETER NEXT BUTTON ENABLED", TestConfigPage.equationtypeheading, "Equation Type",
				"03--ON CLICK THE TEST PARAMETER NEXT BUTTON REDERECT TO CORRECT WINDOW");
