...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen -"Update" Button Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0561       11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class EditiconPopupScreenUpdateButtonProperties extends DriverIntialization {
	...
	public static void commonMethodButtonProperties() throws InterruptedException, IOException {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0561-02", TestConfigPage.reviewTestParaMeterEditIconPopUpdateButtonProps,
				"Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen -Update Button Properties");
