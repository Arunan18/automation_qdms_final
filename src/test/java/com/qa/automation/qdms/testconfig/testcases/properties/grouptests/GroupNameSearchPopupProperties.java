...
//* Description
//*------------
//* Manage Test Tab Group Test - "Group Name" Search PopUp Screen Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*  MTC-GT-023	          24/06/2023   Sasi     Original Version
//*
//************************************************************************************
...
public class GroupNameSearchPopupProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();

	@Test
	public static void GroupNamePopUp() throws InterruptedException, IOException {
	...
	public static void GroupTestClickIcon() throws IOException, InterruptedException {
		...
		try {
			...
			testCase = extent.createTest("Group Name PopUp Screen");
	...
	public static void GroupNamePopUPProperties() {
		...
		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Group_Test",
				"MTC-GT-023-02", GroupTestsPage.groupNameSearchpopup, "Group Name PopUp Screen Properties");
	}
}
