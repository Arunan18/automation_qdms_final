...
//* Description
//*------------
//* Test Configure - "Accepted Condition" - Action Column Edit Icon Pop up Screen - Edit Condition Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0746        14/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class AcceptedConditionEditIconPopupEditConditionHeading extends DriverIntialization{
	static TestConfigPage testconfigurebutton = new TestConfigPage();
	static String code = null;
	@Test
	public static void editIconPopupEditConditionHeading() throws InterruptedException, IOException {
		// Calling The Common Method To Navigate From The Login Page To Scrolling In The Manage Test Page and Click on Edit Configure Icon
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 14, "Description", "Test Configuration Properties","Test_Configure", "TC-TCN-0746");
	...
	public static void editConditionHeading() throws InterruptedException, IOException {
		...
		try {
			...
			//Calling the method
			editConditionHeadingProperties();
	...
	public static void  editConditionHeadingProperties(){
		PageFactory.initElements(driver, testconfigurebutton);

		//Check Action Column Edit Icon Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0746-02", TestConfigPage.editConditionHeading, "Action Column Edit Icon Pop up Screen Edit Condition Heading Properties");
	}	
}
