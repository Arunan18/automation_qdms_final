...
//* Description
//*------------
//* Config Group Test - Applicable Tests Table Test Name Check Box Icon Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-084          06/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ApplicableTestNameCheckBoxProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void testsNameCheckBox() throws InterruptedException, IOException {
	...
	public static void testsNameCheckBoxProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void testNameCheckBoxPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Name Check Box Icon Properties
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-084-02", GroupTestsPage.editiconpopuptestnamecheckboxicon, "Tests Name Check Box Icon Properties");
	}
}
