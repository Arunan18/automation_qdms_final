...
* Description
*------------
* Test Configure Manage Test Configuration Tab Key Test Icon Edit Key Test Pop up Screen Select For Key Test  Check Box Properties
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-124           10/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class ManageTestConfigurationTabKeyTestIconditKeyTestPopupScreenSelectForKeyTestCheckBoxProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
static String test =null;
	@Test

	public static void testConfigurationTabKeyTestIconditKeyTestPopupScreenSelectForKeyTestCheckBoxProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-124-01");
		...
		configurationTabKeyTestIconditKeyTestPopupScreenSelectForKeyTestCheckBoxProperties(TestConfiRev_MaterialSubHeadingProperties.adddata.get(1));
	...
	public static void configurationTabKeyTestIconditKeyTestPopupScreenSelectForKeyTestCheckBoxProperties(String keytest) {

		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-124-02",driver.findElement(By.xpath("//div[@class='ant-modal-content']//th[text()='"+keytest+"']/../th[1]//input/..")),
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test Pop up Screen Select for Key Test Check Box Properties");
	}
