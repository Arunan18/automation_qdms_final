...
* Description
*------------
* Test Parameter Table Action UI Heading Properties
***********************************************************************************
*
...
* ================       ====         =====        ========
* TC-PAR-0087          05/07/2023    Shobika      Original Version
*
*************************************************************************************/
...
public class TestParameterTableActionUIHeadingProperties extends DriverIntialization {
	static TestParameterPage Parametertableaction = new TestParameterPage();

	@Test
	public void TestParameterTableActionUIHeadingPropertie() throws InterruptedException, IOException {
		// login test
		LoginTest.Login();
	...
	public void Parametertableaction() {
		PageFactory.initElements(driver, Parametertableaction);
		try {
