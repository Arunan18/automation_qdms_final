...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - "Type" Data Field Heading UI Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0543     11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class EditIconPopupScreenTypeDataFieldHeadingUIProperties extends DriverIntialization {
	...
	public static void commonMethodHeadingProperties() throws InterruptedException, IOException {
		...
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0543-02", TestConfigPage.reviewTestParaMeterEditIconPopTypeHead,
				"Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - Type Data Field Heading UI Properties");
