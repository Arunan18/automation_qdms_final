...
//* Description
//*------------
//* Config Group Test - Configured Groups Table- Action Column - Delete Icon Pop up Screen - Ok Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-100         11/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfiguredGroupsTableActionDeletePopupOkBtn extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	static String codetype = null;
	@Test
	public static void actionColumnOkBtn() throws InterruptedException, IOException {
	...
	public static void actionColumnOkBtnProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void deleteIconOkBtnProperties() {	
		PageFactory.initElements(driver, GroupTestpg);

		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Group_Test", "MTC-GT-100-02", GroupTestsPage.actioncolumndeleteiconokbtn, "Action Column Delete Icon Pop up Screen Ok Button Properties");
	}
}
