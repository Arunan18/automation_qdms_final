...
//* Description
//*------------
//* Test Configure - Manage Test Configuration Tab- Accepted Condition- Accepted Condition Pop up Screen-- "U" icon Properties
//***************************************************************************************
//*
//* Author           : N.Karunya
...
//* ================       ====         =====        ========
//* MTC-MT-326          05/07/2023    N.Karunya   Original Version                
//************************************************************************************
...
public class Managetest_AcceptedconditionIcon_AcceptedconditionPopup_UiconProps extends DriverIntialization {
	...
	@Test
	public static void acceptedconditionPopupUIcon() throws InterruptedException, IOException {

		// CALLING THE COMMON METHOD FOR NAVIGATE FROM-LOGIN TO SCROLLING IN THE MANAGE
		// TEST PAGE
		NavigateManageTestFromLogin.navigateManageTestFromLogin("Manage Tests", 11);

		// Check Accepted Condition Popup "U" Icon UI Properties
		acceptedconditionPopupUIconExcel();
	...
	public static void acceptedconditionPopupUIconExcel() throws IOException {
		...
		try {
			...
			acceptedconditionPopupUIconProperties();
	...
	public static void acceptedconditionPopupUIconProperties() {
		
		PageFactory.initElements(driver, mtp);

		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-326-02", ManageTestsPage.UIcon,
				"Manage Test - Accepted Condition Popup Screen U Icon Properties");
