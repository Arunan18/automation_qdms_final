...
* Description
*------------
Test Configure Table - Parameter Table-Add Parameter Pop up Screen- "Test Parameter"  Search Pop up Screen Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0479           05/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableAddParameterPopupScreenTestParameterSearchPopupScreenProperties
	...
	public static void popUpScreenProperties() throws InterruptedException, IOException {

		PageFactory.initElements(driver, testConfig);

		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0479-02", TestConfigPage.paraMeterAddParaMeterAddGroupPopUpScreenTestParameterSearchIConPoP,
				"Test Configure Table - Parameter Table-Add Parameter Pop up Screen- Test Parameter  Search Pop up Screen Properties");
