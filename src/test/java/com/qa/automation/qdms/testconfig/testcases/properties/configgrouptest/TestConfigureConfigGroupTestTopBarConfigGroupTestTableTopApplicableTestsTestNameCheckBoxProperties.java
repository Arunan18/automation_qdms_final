...
* Description
*------------
* Test Configure  Config Group Test Top Bar Config Group Test Table Top Applicable Tests Test Name Check Box Properties
**************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0046           05/07/2023   M.Mathushan    Original Version
*
***************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopApplicableTestsTestNameCheckBoxProperties
	...
	public static void configureConfigGroupTestTopBarConfigGroupTestTableTopApplicableTestsTestNameCheckBoxProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0046-01");
		...
		// Check Properties
		configGroupTestTopBarConfigGroupTestTableTopApplicableTestsTestNameCheckBoxProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopApplicableTestsTestNameCheckBoxProperties() {

		PageFactory.initElements(driver, lk);

		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Config_Group_Test", "TC-CGT-0046-02",
				configGroupTestsPage.configGroupTest_AfterDropDownapplicabletesttestnamescheckbox,
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Test Name Check Box Properties");
