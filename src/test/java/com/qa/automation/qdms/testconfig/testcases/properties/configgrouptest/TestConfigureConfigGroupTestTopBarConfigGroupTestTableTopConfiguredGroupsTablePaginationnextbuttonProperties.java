...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test Table Top Configured Groups Table Pagination next button Properties  
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0065           07/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsTablePaginationnextbuttonProperties extends DriverIntialization {

	static configGroupTestsPage lk = new configGroupTestsPage();
	   
	@Test

	public static void configureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsTablePaginationnextbuttonProperties ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0065-01");
		...
		// Check Properties
		configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsTablePaginationnextbuttonProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsTablePaginationnextbuttonProperties() throws InterruptedException {
		PageFactory.initElements(driver, lk);
		Thread.sleep(2000);
		
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0065-02", configGroupTestsPage.configGroupTest_AfterDropDownconfiguregrouptablepaginatrionnextbutton,
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Configure Group Table Pagination Next Button Properties");
