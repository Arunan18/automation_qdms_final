...
* Description
*------------
* Configure Test  Using Main Category wise (more than one results parameter)   (RAW MATERIAL TEST-Without Active)
***********************************************************************************
*
...
* ================       ====         =====        ========
* TC-TCN-0282           25/05/2023   Arunan     Original Version
...
public class ConfigureTestUsingMainCategorywiseMOREthanOneResultsParametarForRawMaterialInActive
	...
	public static void addgroupconfigure() throws InterruptedException, IOException {
		...
		extent.createTest(
				"TC-TCN-0282: Configure Test Using Main Category wise (more than one results parameter)(RAW MATERIAL TEST-Without Active)");
//		LOGIN TO THE SYSTEM
		LoginTest.Login();
...
//        Configure Test Configure Test Step
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0282-first");
		Thread.sleep(500);

//        Select Parameter in Parameter Step
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0282-second");
		Thread.sleep(500);

//        Add parameter in Parameter Step
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0282-second");
		Thread.sleep(500);

//        Add Equation in Equation Step
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0282-third");
		Thread.sleep(3000);
...
//        Add Accepted Value in Accepted criteria Step
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0282-fourth");
		Thread.sleep(3000);
...
//        Add Key Test in Key Test Step
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0282-fifth");
...
//		Add condition in Condition Step
		AcceptCondition.condition("Test Configuragtion Module", "Test_Configure", "TC-TCN-0282-sixth");
...
//        Add Additional Information in Additional Information Step
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0282-seventh");
...
//		Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0282-first",
				"TC-TCN-0282-second", "TC-TCN-0282-third", "TC-TCN-0282-fourth", "TC-TCN-0282-fifth",
				"TC-TCN-0282-sixth", "TC-TCN-0282-seventh");
...
//		Done Button Click
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0282-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "second",
