...
* Description
*------------
Test Configure Table - Parameter Table-Add Parameter Pop up Screen- "GroupKey" Filed UI Heading  Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
*TC-TCN-0485      03/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableAddParameterPopupScreenGroupKeysUIHeadingProperties
	...
	public static void addParaMeterAddGroupButton() throws InterruptedException, IOException {
		...
		try {
			...
			// If clicks
			addParaMeterAddGroupPopUpScreenKeyFelidHeading();
	...
	public static void addParaMeterAddGroupPopUpScreenKeyFelidHeading() throws InterruptedException, IOException {

		PageFactory.initElements(driver, testConfig);

		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0485-02", TestConfigPage.paraMeterAddParaMeterAddGroupPopUpScreenGroupKeyHead,
				"Test Configure Table - Parameter Table-Add Parameter Pop up Screen- GroupKey Filed UI Heading  Properties");
