 ...
 * "Relevant To Result", Heading Properties
 **********************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0692		    12/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class AcceptedCriteriaTableTwoActionColEditPopReleventToResultLabel extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Edit Icon Pop-Up: 'Relevant to Result' Label Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Get Edit Icon Pop-Up: 'Relevant to Results' Label Properties	
			relevantToResultsLabelProperties();			
	...
	public static void relevantToResultsLabelProperties() {
		PageFactory.initElements(driver, testPage);
		//Get Edit Icon Pop-Up: 'Relevant to Results' Label Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0692-02", TestConfigPage.tableTwoActionColEditPopRelevantToTestLabel,"'Relevant to Results' Label Properties");
