...
* Description
*------------
* Configure Test  Using Main Category wise (Material wise accepted value)(Individual wise)
***********************************************************************************
*
...
* ================       ====         =====        ========
*TC-TCN-0349           07/06/2023	  ARUNAN     Original Version
...
public class ConfigureTestUsingMainCategorywiseWithIndividualWiseForFinishProductActive extends DriverIntialization{
	 
		@Test
		public static void ConfigureTestUsingMaterialIndividualwiseAcceptedValue() throws InterruptedException, IOException{
	        ...
	        PageFactory.initElements(driver, action);
		        ...
		        extent.createTest("TC-TCN-0372:Configure Test  Using Main Category wise With Material IndividualWise Accepted Value");
		        // LOGIN TO THE SYSTEM
		        LoginTest.Login();
		...
		//STEP5 : ADD THE ACCEPTCRETERIA
		        AcceeptedCretiaStep.accepted("Test Configuragtion Module", "Test_Configure", "TC-TCN-0372-forth");
		        Thread.sleep(3000);
		//MOVE TO DOWN 
		...
		// STEP8:  REVIEW TEST CHECK IN REVIEW TAB 
		        ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0372-first",
		                "TC-TCN-0372-second", "TC-TCN-0372-third", "TC-TCN-0372-forth", "TC-TCN-0372-fifth",
		                "", "TC-TCN-0372-seventh");
