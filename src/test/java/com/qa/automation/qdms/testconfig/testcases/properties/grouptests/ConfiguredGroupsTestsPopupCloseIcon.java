...
//* Description
//*------------
//* Config Group Tests- Configured Group Table- Tests Column Icon Pop up- Close Icon Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-094         10/07/2023       K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfiguredGroupsTestsPopupCloseIcon extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	static String codetype = null;
	@Test
	public static void testsPopupCloseIconProperties() throws InterruptedException, IOException {
		...
		//Calling the method
		testsPopupCloseIconPropertiess();
	...
	public static void testsPopupCloseIconPropertiess() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void closeIconProperties() {	
		...
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Group_Test", "MTC-GT-094-02", GroupTestsPage.testscolumnPopupCloseIcon, "Tests Column Icon Pop up Screen Close Icon Properties");
	}
}
