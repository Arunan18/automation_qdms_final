...
//* Description
//*------------
//* Config Group Test - Config Group Test Table "Select Material" TextBox Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-072        11/07/2023     K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfigGroupTestTableSelectMaterialTextBox extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void selectMaterialTextBox() throws InterruptedException, IOException {
		...
		//Calling the method
		selectMaterialTextBoxPropertiess();
	...
	public static void selectMaterialTextBoxPropertiess() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			//Calling the method
			selectMaterialTextBoxProperties();
		} 
	...
	public static void selectMaterialTextBoxProperties() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Edit Icon Pop up Material Main Category Heading Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-072-02", GroupTestsPage.editiconpopupselectmaterialtextbox, "Select Material TextBox Properties");
	}
}
