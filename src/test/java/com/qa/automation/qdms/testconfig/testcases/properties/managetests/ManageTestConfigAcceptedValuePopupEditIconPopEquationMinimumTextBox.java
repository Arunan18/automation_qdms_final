 ...
 * ================        ====         =====          ========
 * MTC-MT-222		    14/07/2023      Shangeetha    Original Version  
 **************************************************************************************************************************************/
...
public class ManageTestConfigAcceptedValuePopupEditIconPopEquationMinimumTextBox extends DriverIntialization{
	...
	public static void methodTextBoxProperties() {
		...
		//Get Edit Icon Pop-Up: 'Equation Minimum Value's' Text Box Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Manage_Tests", "MTC-MT-222-02", ManageTestsPage.tableTwoActionColEditPopEquationMinimumTextBox, "'Equation Minimum Value's' Text Box Properties");
