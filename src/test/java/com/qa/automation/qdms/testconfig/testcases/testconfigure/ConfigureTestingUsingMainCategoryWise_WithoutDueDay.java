...
//* ================       ====         =====        ========
//* TC-TCN-0338        	01/06/2023     Saranka     Orginal Version
//*
//************************************************************************************
...
public class ConfigureTestingUsingMainCategoryWise_WithoutDueDay extends DriverIntialization {
	...
	@Test
	public void ConfigTestwithoutDayFun() throws InterruptedException, IOException {
...
// _______________________________
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0338-first");
		Thread.sleep(2000);
...
// __________________________________________________________
		...
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0338-Second");
		Thread.sleep(3000);
...
//_______________________________________        
		...
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0338-Second");
		Thread.sleep(2000);
...
//_______________________________________        
		...
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0338-Third");
		Thread.sleep(3000);
...
//______________________________________ 
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0338-fourth");
		Thread.sleep(3000);
...
//_______________________________
		...
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0338-fifth");
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();
		TestConfigPage.nextBtn.click();
...
//_________________________________        
		...
		Thread.sleep(3000);
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0338-seventh");
...
//___________________________________        
		...
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0338-first",
				"TC-TCN-0338-Second", "TC-TCN-0338-Third", "TC-TCN-0338-fourth", "TC-TCN-0338-fifth",
				"TC-TCN-0338-sixth", "TC-TCN-0338-seventh");
...
// _________________________________
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0338-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "First",
