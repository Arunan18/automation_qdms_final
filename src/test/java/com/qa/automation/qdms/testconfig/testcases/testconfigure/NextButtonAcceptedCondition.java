...
//* Description
//*------------
//* NEXT BUTTON UNDER THE ACCEPTED CONDITION
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0218		 	15/05/2023     Gobithan     Original Version
//* 
//************************************************************************************
...
public class NextButtonAcceptedCondition extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		AddGroupKey.actionS(0, 14, mangetest.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Test_Configure", "TC-TCN-0218-01", 2);
		...
		Thread.sleep(2000);
		ButtonFunction.buttonfunction("Test Configuragtion Module", "Test_Configure", "TC-TCN-0218",
				"STEP_05--ACCEPTED CONDITION TAB NEXT BUTTON PROPERTYS",
				"01--ACCEPTED CONDITION TAB NEXT BUTTON DISPLAYED", "02--ACCEPTED CONDITION TAB NEXT BUTTON ENABLED",
				TestConfigPage.additionalheading, "Additional Information",
				"03--ON CLICK THE ACCEPTED CONDITION TAB REDERECT TO CORRECT WINDOW");
