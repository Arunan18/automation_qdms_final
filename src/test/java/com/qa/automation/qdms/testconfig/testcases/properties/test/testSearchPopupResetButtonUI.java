...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Material Test Table "Test" Reset Button  Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-TC-0049             22/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class testSearchPopupResetButtonUI extends DriverIntialization {
...
@Test
	public void testSearchpopupResetbuttonUIProperties() throws InterruptedException, IOException {
		//login test
		LoginTest.Login();
		...
		try {
			...
			try {
				...
				try {
					...
					Thread.sleep(1000);
					testtabTestSearchpopupresetButtonUI();
	...
	public void testtabTestSearchpopupresetButtonUI() {
		TestConfigPage tcp=new TestConfigPage();
		PageFactory.initElements(driver, tcp);
//      GET PROPERTIES OF STATUS POPUP TEXTBOX BY TEXTBOX PROPERTTIES COMMON METHOD
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test", "TC-TC-0049-01", TestConfigPage.ResetBtn,
