 ...
 * ================        ====         =====          ========
 * TC-TCN-0697		    11/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaTabActionColEditPopCloseBtnFunctionality extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check 'Edit' Icon Pop-Up, 'Close' Button Functionality
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			editIconPopUpCloseButtonFunctionality();			
	...
	public static void editIconPopUpCloseButtonFunctionality() {
		PageFactory.initElements(driver, testPage);
		//Check 'Edit' Icon Pop-Up, 'Close' Button Functionality
		functionality.ButtonAndIconunctionalityMtd("'Close' Button Functionality", TestConfigPage.acceptedCriteriaTableTwoActionColEditPopCloseBtn, "Button");
