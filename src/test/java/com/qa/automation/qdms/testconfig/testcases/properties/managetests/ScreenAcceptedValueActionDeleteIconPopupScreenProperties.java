...
* Description
*------------
*Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen - Accepted Value-Action -"Delete Icon" - Pop up Screen Properties
***************************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
*  
*MTC-MT-233        17/07/2023    THAKSHILA    Modified Version    */
...
public class ScreenAcceptedValueActionDeleteIconPopupScreenProperties extends DriverIntialization {
	...
	public static void popUpScreenProperties() {
		...
		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-233-02", ManageTestsPage.acceptValuePopDeletePopUp,
				"Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen - Accepted Value-Action -Delete Icon - Pop up Screen Properties");
