...
* Description
*------------
*Test Parameter Table  Add Parameter Button-Pop up Screen Close Button Functionality
***********************************************************************************
*
...
* ================       ====         =====        ========
* TC-PAR-0103          06/07/2023    Shobika      Original Version
*
*************************************************************************************/
...
import com.qa.automation.qdms.testconfig.pages.TestParameterPage;
	...
	public class TestParameterTableAddParameterButtonPopupScreenClosebuttonFunctionality extends DriverIntialization {
		static TestParameterPage parameterclosebutton = new TestParameterPage();

		@Test
		public void TestParameterTableAddParameterButtonPopupScreenclosebuttonFunctionality()
		...
		public void parameterclosebutton() {
			...
			}public void parameterCloseButtonfunc() {
				PageFactory.initElements(driver, parameterclosebutton);
				try {
					if (TestParameterPage.parameterclosebutton.isDisplayed()) {
					...
					if (TestParameterPage.parameterclosebutton.isEnabled()) {
					...
					testCase = extent.createTest("Checking The Add condition Action Edit Popup Screen CloseClose Button");
