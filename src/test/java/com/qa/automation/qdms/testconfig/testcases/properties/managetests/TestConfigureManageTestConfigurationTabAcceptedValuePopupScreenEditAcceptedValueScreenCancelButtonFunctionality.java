...
* Description
*------------
*Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen - Edit Accepted Value Screen - "Cancel" Button Functionality
***************************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
*  
*MTC-MT-228           17/07/2023    THAKSHILA    Modified Version    */
...
public class TestConfigureManageTestConfigurationTabAcceptedValuePopupScreenEditAcceptedValueScreenCancelButtonFunctionality
	...
	public static void buttonFunctionality() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(ManageTestsPage.acceptValuePopEditCancelButton));

		try {
			if (ManageTestsPage.acceptValuePopEditCancelButton.isDisplayed()) {

				testCase = extent.createTest("STEP-1-CANCEL BUTTON IS DISPLAYED");
				testCase.log(Status.PASS, "TEST PASS ☑");

				if (ManageTestsPage.acceptValuePopEditCancelButton.isEnabled()) {
					...
					try {
						...
						ManageTestsPage.acceptValuePopEditCancelButton.click();
