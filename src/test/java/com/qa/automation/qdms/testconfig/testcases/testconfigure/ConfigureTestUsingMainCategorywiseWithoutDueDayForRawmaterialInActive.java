...
* ================       ====         =====        ========
* TC-TCN-0276            24/05/2023   Arunan     Orginal Version
...
public class ConfigureTestUsingMainCategorywiseWithoutDueDayForRawmaterialInActive extends DriverIntialization {
...
//      TESTCASE REPORT
		extent.createTest(
				"TC-TCN-0276-Configure Test Using Main Category wise (without due day)(RAW MATERIAL TEST-Without Active)");
...
//        Configure Test Configure Test Step
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0276-first");
		Thread.sleep(500);

//        Select Parameter in Parameter Step
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0276-second");
		Thread.sleep(500);

//      Add parameter in Parameter Step
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0276-second");

		Thread.sleep(2000);
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();

//        Add Equation in Equation Step
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0276-third");
		Thread.sleep(3000);
...
//        Add Accepted Value in Accepted creatia Step
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0276-fourth");
		Thread.sleep(3000);
...
//        Add Key Test in Key Test Step
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0276-fifth");
...
//        Add Additional Information in Additional Information Step
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0276-seventh");
...
//		Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0276-first",
				"TC-TCN-0276-second", "TC-TCN-0276-third", "TC-TCN-0276-fourth", "TC-TCN-0276-fifth",
				"TC-TCN-0276-sixth", "TC-TCN-0276-seventh");
...
// 		DONE BUTTON PROPERTYS
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0276-eigth", AddConfigureTest.testname, AddConfigureTest.testtype, "First",
