...
//* Description
//*------------
//* Config Group Test - Configured Groups Table "Tests" Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-091          06/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfiguredTestsTableHeadingProperties extends DriverIntialization  {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void testsTableHeading() throws InterruptedException, IOException {
	...
	public static void testsTableHeadingProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void testsTableHeadingPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-091-02", GroupTestsPage.editiconpopuptests, "Tests Heading Properties");
	}
}
