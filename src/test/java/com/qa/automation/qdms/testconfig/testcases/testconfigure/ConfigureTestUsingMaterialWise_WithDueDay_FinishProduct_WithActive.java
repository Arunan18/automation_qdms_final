...
//* Description
//*------------
//* Configure Test Using Material With due day (FINISH PRODUCT TEST- WITH ACTIVE)
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0306        	22/05/2023   Gobithan     Orginal Version
//*
//************************************************************************************
...
public class ConfigureTestUsingMaterialWise_WithDueDay_FinishProduct_WithActive extends DriverIntialization {
	...
	public static void addgroupconfigure() throws InterruptedException, IOException {
		...
		// TESTCASE REPORT
		extent.createTest(
				"TC-TCN-0306-Configure Test Using Material With due day (FINISH PRODUCT TEST- WITH ACTIVE)");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0306-first");

		// TEST PARAMETER FIELD
		Thread.sleep(2000);
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0306-second");

		// ADD PARAMETER FIELD
		Thread.sleep(3000);
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0306-second");

		// CONFIGURE EQUATION FIELD
		Thread.sleep(2000);
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0306-third");
		...
		Thread.sleep(3000);
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0306-fourth");
		...
		// ACCEPTED CRITERIA FIELD
		Thread.sleep(3000);
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0306-fifth");
		TestConfigPage.nextBtn.click();
		...
		Thread.sleep(3000);
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0306-seventh");
		TestConfigPage.nextBtn.click();

		// Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0306-first",
				"TC-TCN-0306-second", "TC-TCN-0306-third", "TC-TCN-0306-fourth", "TC-TCN-0306-fifth", "",
				"TC-TCN-0306-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0306-eigth", AddConfigureTest.testname, AddConfigureTest.testtype, "first",
