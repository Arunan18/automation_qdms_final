...
//* Description
//*------------
//* Test Configure - "Accepted Condition" - Action Column Edit Icon Pop up Screen - Cancel Button Functionality
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0750        14/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ActionEditPopupCancelBtnFunctionality extends DriverIntialization {
	...
	public static void editIconPopupCancelBtn() throws InterruptedException, IOException {
		...
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 14, "Description", "Test Configuration Properties","Test_Configure", "TC-TCN-0750");
		...
		//Calling the method
		editIconPopupCancelBtnFunctionality();
	...
	public static void editIconPopupCancelBtnFunctionality() throws InterruptedException, IOException {
	...
	public static void  editIconPopupCancelButtonFunctionality(){
		...
		functionality.ButtonAndIconunctionalityMtd("'Cancel' Button Functionality", TestConfigPage.editiconpopupcancelbtn, "Button");
	}	
}
