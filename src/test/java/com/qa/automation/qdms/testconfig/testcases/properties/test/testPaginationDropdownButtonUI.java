...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test - Material Test Table - Pagination Drop down Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-TC-0072             23/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class testPaginationDropdownButtonUI extends DriverIntialization{
...
@Test
	...
	public void clicktestconfigrationcard() {
		...
		try {
			...
			try {
				...
				Thread.sleep(500);
				testpaginationdropdownButtonUI();
	...
	public void testpaginationdropdownButtonUI() {
		test tcp=new test();
		PageFactory.initElements(driver, tcp);
//      GET PROPERTIES OF STATUS POPUP TEXTBOX BY TEXTBOX PROPERTTIES COMMON METHOD
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test", "TC-TC-0072-02", test.testpaginationdropdownbtn,
              "Checking TEST TABLE pagination dropdown UI Properties :");
	}
