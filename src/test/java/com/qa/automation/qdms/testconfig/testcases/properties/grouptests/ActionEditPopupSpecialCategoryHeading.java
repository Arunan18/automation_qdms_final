...
//* Description
//*------------
//* Manage Test Edit Pop up Screen "Special Category" CheckBox Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-075          05/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ActionEditPopupSpecialCategoryHeading extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void specialCategoryHeading() throws InterruptedException, IOException {
	...
	public static void specialCategoryProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void specialCategoryPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Edit Icon Pop up Screen Special Category Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-075-02", GroupTestsPage.editiconpopupspecialcategoryheading, "Edit Icon Pop up Screen Special Category Heading Properties");
	}
}
