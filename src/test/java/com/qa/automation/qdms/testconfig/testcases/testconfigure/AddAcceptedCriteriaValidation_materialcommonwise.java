...
//* Description
//*------------
//* Add Accepted Criteria Validation Material Common Wise
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*	TC-TCN-0394		    07/06/2023     Gobithan    Original Version
//*
//************************************************************************************
...
public class AddAcceptedCriteriaValidation_materialcommonwise extends DriverIntialization {
	...
	public static void TestEquationDeleteFuntion() throws InterruptedException, IOException {
		...
		extent.createTest("STEP_05--ACCEPTED CRETERIA MATERIAL COMMON WISE VALIDATION");
		validationempty();
		...
		// BETWEEN WISE EMPTY VALIDATION
		betweenwiseemptyvalidation();

		// BETWEEN WISE VALUE MUST BE NUMBER VALIDATION
		betweenwisevalueemptyvalidation();
	...
	public static void validationempty() throws IOException {
		try {
			...
			String expecteddata = AddAcceptedCriteriaValidation_testwise.excel("Test Configuragtion Module",
					"Test_Configure", "TC-TCN-0394", 0, 3);
	...
	// VALUE CANT BE EMPTY VALIDATION
		...
		try {
			...
			try {				
				if (ManageTestsPage.materialradiobtn.isDisplayed()) {
					...
					if (ManageTestsPage.materialradiobtn.isEnabled()) {
						...
						if (!ManageTestsPage.commonradiobtn.isSelected()) {
							ManageTestsPage.commonradiobtn.click();
						}
					} else {
			...
			try {
				String selecttypeparameter = AddAcceptedCriteriaValidation_testwise.excel("Test Configuragtion Module",
						"Test_Configure", "TC-TCN-0394", 1, 2);
				try {
				...
				String expecteddata = AddAcceptedCriteriaValidation_testwise.excel("Test Configuragtion Module",
						"Test_Configure", "TC-TCN-0394", 1, 3);
				try {
					Assert.assertEquals(Actualvalue, expecteddata);
					testCase = extent.createTest("2.ACCEPTED VALUE CAN'T BE EMPTY VALIDATION");
					testCase.log(Status.PASS, "TEST PASS");
					testCase.log(Status.INFO, "Actual Data :- " + Actualvalue);
					testCase.log(Status.INFO, "Expected Data :- " + expecteddata);
	...
	public static void valuemustbenumber() throws IOException, InterruptedException {
		...
		try {
			...
			WebElement aa = driver.findElement(
					By.xpath("//div[contains(@name,'condition')]//div[contains(@class,'ant-select-selector')]"));
			aa.click();
			...
			try {
				String selecttypeparameter = AddAcceptedCriteriaValidation_testwise.excel("Test Configuragtion Module",
						"Test_Configure", "TC-TCN-0394", 2, 1);
				/* SELECT THE DROP DOWN FOR PARAMETER TYPE FEILD */
				Actions actions = new Actions(driver);
				if (selecttypeparameter != "") {
					for (int i = 0; i < count; i++) {
						try {
							...
							Thread.sleep(1000);
							driver.findElement(
									By.xpath("//div[contains(@title,'" + selecttypeparameter + "')]//div[1]")).click();
							break;
				...
				testCase = extent.createTest("SELECT TYPE PARAMETER IS NOT WORKED IN VALUE MUST NUMBER VALIDATION");
				testCase.log(Status.FAIL, "TEST FAIL");
			}
			try {
				String sendvalue = AddAcceptedCriteriaValidation_testwise.excel("Test Configuragtion Module",
						"Test_Configure", "TC-TCN-0394", 2, 2);
			...
			try {
				Assert.assertEquals(Actualvalue, expecteddata);
				testCase = extent.createTest("3.ACCEPTED VALUE MUSTBE NUMBER VALIDATION");
				testCase.log(Status.PASS, "TEST PASS");
				testCase.log(Status.INFO, "Actual Data :- " + Actualvalue);
				testCase.log(Status.INFO, "Expected Data :- " + expecteddata);
				testCase.log(Status.INFO, "EXPECTED & ACTUAL ACCEPTED VALUE MUSTBE NUMBER VALIDATION ARE CORRECT");
			} catch (AssertionError e) {
				testCase = extent.createTest("3.ACCEPTED VALUE MUSTBE NUMBER VALIDATION");
				testCase.log(Status.FAIL, "TEST FAIL");
				testCase.log(Status.INFO, "Actual Data :- " + Actualvalue);
				testCase.log(Status.INFO, "Expected Data :- " + expecteddata);
				testCase.log(Status.INFO, "EXPECTED & ACTUAL ACCEPTED VALUE MUSTBE NUMBER VALIDATION ARE NOT CORRECT");
			}
	...
	// BETWEEN WISE EMPTY VALIDATION
	public static void betweenwiseemptyvalidation() throws IOException, InterruptedException {
		...
		try {
			...
			try {
				String selecttypeparameter = AddAcceptedCriteriaValidation_testwise.excel("Test Configuragtion Module",
						"Test_Configure", "TC-TCN-0394", 3, 1);
				/* SELECT THE DROP DOWN FOR PARAMETER TYPE FEILD */
				Actions actions = new Actions(driver);
				if (selecttypeparameter != "") {
					for (int i = 0; i < count; i++) {
				...
				testCase = extent.createTest("SELECT TYPE PARAMETER IS NOT WORK IN BETWEEN WISE EMPTY VALIDATION");
				testCase.log(Status.FAIL, "TEST FAIL");
			}
			try {
				String sendvalue = AddAcceptedCriteriaValidation_testwise.excel("Test Configuragtion Module",
						"Test_Configure", "TC-TCN-0394", 3, 2);
				ManageTestsPage.minimum.click();
				ManageTestsPage.minimum.sendKeys(sendvalue);
				ManageTestsPage.acceptedvalueSaveButton.click();
			} catch (Exception e) {
				testCase = extent.createTest("MINIMUM VALUE FIELD IS NOT WORK IN BETWEEN WISE EMPTY VALIDATION");
				testCase.log(Status.FAIL, "TEST FAIL");
			}

			// REPORT FOR BETWEEN WISE EMPTY VALIDATION
			String Actualvalue = ManageTestsPage.acceptedvaluefootervalidation.getText();
			String expecteddata = AddAcceptedCriteriaValidation_testwise.excel("Test Configuragtion Module",
					"Test_Configure", "TC-TCN-0394", 3, 3);
			try {
				Assert.assertEquals(Actualvalue, expecteddata);
				testCase = extent.createTest("4.ACCEPTED VALUE BETWEEN WISE EMPTY VALIDATION");
				testCase.log(Status.PASS, "TEST PASS");
				testCase.log(Status.INFO, "Actual Data :- " + Actualvalue);
				testCase.log(Status.INFO, "Expected Data :- " + expecteddata);
				testCase.log(Status.INFO, "EXPECTED & ACTUAL ACCEPTED VALUE BETWEEN WISE EMPTY VALIDATION ARE CORRECT");
			} catch (AssertionError e) {
				testCase = extent.createTest("4.ACCEPTED VALUE BETWEEN WISE EMPTY VALIDATION");
				testCase.log(Status.FAIL, "TEST FAIL");
				testCase.log(Status.INFO, "Actual Data :- " + Actualvalue);
				...
				testCase.log(Status.INFO,
						"EXPECTED & ACTUAL ACCEPTED VALUE BETWEEN WISE EMPTY VALIDATION ARE NOT CORRECT");
			}
	...
	// BETWEEN WISE VALUE MUST BE NUMBER VALIDATION
	public static void betweenwisevalueemptyvalidation() throws IOException, InterruptedException {
		...
		try {
			...
			try {
				String selecttypeparameter = AddAcceptedCriteriaValidation_testwise.excel("Test Configuragtion Module",
						"Test_Configure", "TC-TCN-0394", 4, 1);
				/* SELECT THE DROP DOWN FOR PARAMETER TYPE FEILD */
				Actions actions = new Actions(driver);
				if (selecttypeparameter != "") {
					for (int i = 0; i < count; i++) {
				...
				testCase = extent
						.createTest("SELECT TYPE PARAMETER IS NOT WORK IN BETWEEN WISE VALUE EMPTY VALIDATION");
				testCase.log(Status.FAIL, "TEST FAIL");
			}
			try {
				String sendvalue = AddAcceptedCriteriaValidation_testwise.excel("Test Configuragtion Module",
						"Test_Configure", "TC-TCN-0394", 4, 2);
				ManageTestsPage.minimum.click();
				ManageTestsPage.minimum.sendKeys(sendvalue);
				ManageTestsPage.acceptedvalueSaveButton.click();
			} catch (Exception e) {
				testCase = extent.createTest("MINIMUM VALUE FIELD IS NOT WORK IN BETWEEN WISE VALUE EMPTY VALIDATION");
				testCase.log(Status.FAIL, "TEST FAIL");
			}

			// REPORT FOR BETWEEN WISE VALUE MUST BE NUMBER VALIDATION
			String Actualvalue = ManageTestsPage.acceptedvaluefootervalidation.getText();
			String expecteddata = AddAcceptedCriteriaValidation_testwise.excel("Test Configuragtion Module",
					"Test_Configure", "TC-TCN-0394", 4, 3);
			try {
				Assert.assertEquals(Actualvalue, expecteddata);
				testCase = extent.createTest("5.ACCEPTED VALUE BETWEEN WISE VALUE MUST BE NUMBER VALIDATION");
				testCase.log(Status.PASS, "TEST PASS");
				testCase.log(Status.INFO, "Actual Data :- " + Actualvalue);
				testCase.log(Status.INFO, "Expected Data :- " + expecteddata);
				testCase.log(Status.INFO,
						"EXPECTED & ACTUAL ACCEPTED VALUE BETWEEN WISE VALUE MUST BE NUMBER VALIDATION ARE CORRECT");
			} catch (AssertionError e) {
				testCase = extent.createTest("5.ACCEPTED VALUE BETWEEN WISE VALUE MUST BE NUMBER VALIDATION");
				testCase.log(Status.FAIL, "TEST FAIL");
				testCase.log(Status.INFO, "Actual Data :- " + Actualvalue);
				testCase.log(Status.INFO, "Expected Data :- " + expecteddata);
				testCase.log(Status.INFO,
						"EXPECTED & ACTUAL ACCEPTED VALUE BETWEEN WISE VALUE MUST BE NUMBER VALIDATION ARE NOT CORRECT");
			}
			try {
				// CLICK ON CANCEL BUTTON
				ManageTestsPage.acceptedvalueclosebutton.click();
			} catch (Exception e) {
				testCase = extent.createTest("CANCEL BUTTON IS NOT WORK IN VALIDATION");
				testCase.log(Status.FAIL, "TEST FAIL");
			}
