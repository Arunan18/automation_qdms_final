 ...
 * "Edit Equation" Text Box Properties
 ****************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0604 			 07/07/2023   Shangeetha    Original Version  
 ***************************************************************************************************************/
...
public class ConfigEquActEditIconPopUpEditEquationTextBoxProperties extends DriverIntialization{
	static TestConfigPage testPage = new TestConfigPage();
	static String searchCode = null;
	@Test
	public static void configureEquation() throws InterruptedException, IOException {
		// Calling The Common Method To Navigate From The Login Page To Scrolling In The Manage Test Page and Click on Configure Test
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 14, "Description", "Test Configuration Properties",
				"Test_Configure", "TC-TCN-0604");
		...
		// Calling The Method To Check The Edit Icon Pop-Up Edit Equation TextBox Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Check 'Edit' Icon Pop-Up Edit Equation Text Box Properties	
			editIconPopUpEditEquationTextBoxProperties();			
	...
	public static void editIconPopUpEditEquationTextBoxProperties() {
		PageFactory.initElements(driver, testPage);
		//Check 'Edit' Icon Pop-Up Edit Equation Text Box Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0604-02", TestConfigPage.configEquActionEditIconPopEditEqTextBox,"Edit Icon Pop-Up, Edit Equation Text Box Properties");
