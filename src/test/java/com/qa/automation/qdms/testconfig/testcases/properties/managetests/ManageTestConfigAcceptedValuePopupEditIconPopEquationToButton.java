 ...
 * ================        ====         =====          ========
 * MTC-MT-224		    14/07/2023      Shangeetha    Original Version  
 **************************************************************************************************************************************/
...
public class ManageTestConfigAcceptedValuePopupEditIconPopEquationToButton extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 8, "Description", "Test Configuration Properties",
				"Manage_Tests", "MTC-MT-224");
		Thread.sleep(2000);

		// Calling The Method To Check The Edit Icon Pop-Up: Equation- 'To' Button Properties	
	...
	public static void methodEquationToButtonProperties() {
		...
		//Get Edit Icon Pop-Up: Equation- 'To' Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests", "MTC-MT-224-02", ManageTestsPage.tableTwoActionColEditPopEquationToButton, "Equation: 'To' Button Properties");
