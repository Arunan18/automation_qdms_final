...
* ================       ====         =====        ========
*TC-TCN-0365         31/05/2023   Quenthan     Orginal Version
*
************************************************************************************/
...
public class ConfigureTestUsingGroupKeyParameter_finishProduct extends DriverIntialization  {
	...
	public static void configureTestUsingGroupKeyParameter() throws InterruptedException, IOException {
		...
		// LOGIN TO THE SYSTEM 
		LoginTest.Login();
		extent.createTest("TC-TCN-0365--Configure Test  Using Group Key (Parameter)--FINISH PRODUCT TEST-Without Active");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0365-first");
		Thread.sleep(2000);

		// TEST PARAMETER FIELD
		AddGroupKey.groupKey("Test Configuragtion Module", "Test_Configure", "TC-TCN-0365-secound-Group");
		Thread.sleep(3000);

		// ADD PARAMETER FIELD
		TestParameterStep.testParametersGroup("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0365-secound-add");
		Thread.sleep(2000);

		// CONFIGURE EQUATION FIELD
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0365-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0365-fourth");
		Thread.sleep(3000);
		TestConfigPage.nextBtn.click(); 
		Thread.sleep(3000);

		// ACCEPTED CRITERIA FIELD
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0365-fifth");
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

//		//ADD CONDITION IN CONDITION STEP
//				Thread.sleep(3000);
//				AcceptCondition.condition("Test Configuragtion Module", "Test_Configure", "TC-TCN-0365-sixth");
//				TestConfigPage.nextBtn.click();
//				Thread.sleep(3000);

		// ADD INFORMATION
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0365-seventh");
		...
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0365-first",
				"TC-TCN-0365-secound-add", "TC-TCN-0365-third", "TC-TCN-0365-fourth", "TC-TCN-0365-fifth", "",
				"TC-TCN-0365-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0365-eight", AddConfigureTest.testname, AddConfigureTest.testtype, "second",
