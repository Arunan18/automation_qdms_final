...
//* Description
//*------------
//**TC-TCN-0347 - Configure Test  Using Main Category wise (Material wise accepted value)(Common wise)
...
//* ================       ====         =====        ========
//*TC-TCN-0347          26/05/2023      RAHUL.S       Original Version
//*                     09/06/2023      RAHUL.S       Rechecked
//************************************************************************************
...
public class ConfigureTestUsingMainCategoryWise_Materialwiseacceptedvalue_Commonwise extends DriverIntialization {
...
//        Configure Test Configure Test Step
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0347-first");
		Thread.sleep(500);

//        Select Parameter in Parameter Step
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0347-second");
		Thread.sleep(500);

//        Add parameter in Parameter Step
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0347-second");
		Thread.sleep(500);

//        Add Equation in Equation Step
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0347-third");
		Thread.sleep(3000);
...
//        Next Button Click in Equation
		...
		AcceeptedCretiaStep.accepted("Test Configuragtion Module", "Test_Configure", "TC-TCN-0347-fourth");
		Thread.sleep(3000);
...
//        Add Key Test in Key Test Step
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0347-fifth");
...
//        Add Additional Information in Additional Information Step
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0347-seventh");
...
//		Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0347-first",
				"TC-TCN-0347-second", "TC-TCN-0347-third", "TC-TCN-0347-fourth", "TC-TCN-0347-fifth",
				"TC-TCN-0347-sixth", "TC-TCN-0347-seventh");
...
//		Done Button Click
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0347-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "second",
