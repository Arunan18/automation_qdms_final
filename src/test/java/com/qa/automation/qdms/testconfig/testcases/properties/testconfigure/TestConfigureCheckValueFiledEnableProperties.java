...
* Description
*------------
Test Configure Table - Parameter Table Middle Page- Test Parameter Table- Select- Type "config" & Check "Value" Filed Enable Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0512          13/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureCheckValueFiledEnableProperties extends DriverIntialization {
	...
	public static void commonMethodTextBoxProperties() throws InterruptedException, IOException {
		...
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0512-02",
				TestConfigPage.reviewTestParaMeterValueTextBox, "(Type - Config)Value Enable Text box  UI Properties");
