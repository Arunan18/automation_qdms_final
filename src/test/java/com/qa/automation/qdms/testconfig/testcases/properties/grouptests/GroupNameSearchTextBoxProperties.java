...
//* Description
//*------------
//* Manage Test Tab Group Test - "Group Name" Search TextBox Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*  MTC-GT-024	          24/06/2023   Sasi     Original Version
//*
//************************************************************************************
...
public class GroupNameSearchTextBoxProperties extends DriverIntialization {
	...
	public static void GroupTestClickIcon() throws IOException, InterruptedException {
		...
		try {
			...
			testCase = extent.createTest("Group Name Search TextBox Filed");
	...
	public static void GroupNameTextBoxProperties() {
		GroupTestsPage GroupTestpg = new GroupTestsPage();
		PageFactory.initElements(driver, GroupTestpg);

		// Check Group Name PopUp Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Group_Test", "MTC-GT-024-02",
				GroupTestsPage.groupNameTextBox, "Group Name TextBox Properties");
	}
}
