...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test Table Top Configured Groups Tests Table Sub Heading UI Properties
************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0053           06/07/2023   M.Mathushan    Original Version
*
*************************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsTestsTableSubHeadingUIProperties extends DriverIntialization {

	static configGroupTestsPage lk = new configGroupTestsPage();

	@Test

	public static void configureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsTestsTableSubHeadingUIProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0053-01");
		...
		// Check Properties
		configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsTestsTableSubHeadingUIProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsTestsTableSubHeadingUIProperties() {

		PageFactory.initElements(driver, lk);

		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0053-02", configGroupTestsPage.configGroupTest_AfterDropDownconfiguredtestheading,
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Configure Group Test Table SubHeading UI Properties");
