...
* Description
*------------
* Test Configure Manage Test Configuration Tab Test Heading UI Properties  
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-110           07/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureManageTestConfigurationTabTestHeadingUIProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();

	@Test

	public static void configureManageTestConfigurationTabTestHeadingUIProperties() throws InterruptedException, IOException {
	...
	//Check the Test Configure Manage Test Configuration Tab Main Header Button Properties
		manageTestConfigurationTabTestHeadingUIProperties();
	...
	public static void manageTestConfigurationTabTestHeadingUIProperties() {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-110-02", ManageTestsPage.testConfigureManageTestConfigurationTabTestHeadingUIProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Test Heading Properties");
	}
}
