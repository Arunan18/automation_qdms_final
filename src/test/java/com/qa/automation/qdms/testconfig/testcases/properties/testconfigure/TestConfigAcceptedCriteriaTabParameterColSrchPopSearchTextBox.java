 ...
 * ================        ====         =====          ========
 * TC-TCN-0656 		    10/07/2023      Shangeetha    Original Version  
 *************************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaTabParameterColSrchPopSearchTextBox extends DriverIntialization{
	...
	public static void AcceptedCriteria() throws InterruptedException, IOException {
		...
		// Check 'Search' Text Box Properties on 'Parameter' Column Search Pop-Up
	...
	public static void methodSearchTextBox() {
		PageFactory.initElements(driver, testPage);
		// Check 'Search' Text Box Properties on 'Parameter' Column Search Pop-Up 
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0656-02", TestConfigPage.acceptedCriteriaTableTwoParameterColSrchPopSearchTextBox, "'Search' Text Box Properties on 'Parameter' Column Search Pop-Up");
	}
}
