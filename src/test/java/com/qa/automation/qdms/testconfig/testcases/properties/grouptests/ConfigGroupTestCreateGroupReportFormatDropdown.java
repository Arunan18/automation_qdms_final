...
//* Description
//*------------
//* Group Tests - Config Group Test - Create Group Table - "Report Format" Drop Down Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-081         12/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfigGroupTestCreateGroupReportFormatDropdown extends DriverIntialization {
	...
	public static void reportFormatDropdown() throws InterruptedException, IOException {
		...
		//Calling the method
		reportFormatDropdownProperties();
	...
	public static void reportFormatDropdownProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			try {	
				...
				//Calling the method
				reportFormatDropdownPropertiess();
	...
	public static void reportFormatDropdownPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Column Pop up Properties
		ProCommonMethods.dropDown("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-081-02", GroupTestsPage.editiconpopupreportformatDropdown, "Report Format Drop Down Properties", "1");
	}
}
