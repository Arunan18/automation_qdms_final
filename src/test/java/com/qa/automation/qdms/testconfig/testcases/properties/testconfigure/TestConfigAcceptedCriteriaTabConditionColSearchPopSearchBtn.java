 ...
 * ================        ====         =====          ========
 * TC-TCN-0669 		    11/07/2023      Shangeetha    Original Version  
 *************************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaTabConditionColSearchPopSearchBtn extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Check 'Search' Button Properties on 'Condition' Column Search Pop-Up  
	...
	public static void methodSearchButtonProperties() {
		PageFactory.initElements(driver, testPage);
		// Check 'Search' Button Properties on 'Condition' Column Search Pop-Up 
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0669-02", TestConfigPage.acceptedCriteriaTableTwoConditionColSrchPopSearchBtn, "'Search' Button Properties on 'Condition' Column Search Pop-Up");
	}
}
