...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - "Relevant To Accepted Value" Check box Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0556           11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class RelevantToAcceptedValueCheckboxProperties extends DriverIntialization {
	...
	public static void commonMethodCheckboxProperties() throws InterruptedException, IOException {
		...
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0556-02",
				TestConfigPage.reviewTestParaMeterEditIconPopRelevantCheckBox,
				"Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen -Relevant To Accepted Value Check box Properties");
