...
* Description
*------------
*	Test Parameter Table  - Edit Parameter Pop up Screen Properties
************************************************************************************
*
...
* ================       ====         =====        ========
*TC-PAR-0104			 15/07/2023    Shobika      Original Version
*
*******************************************************************************/
...
public class TestParameterTableEditParameterPopupScreenProperties extends DriverIntialization {
	static TestConfigPage editiconpopupscreen = new TestConfigPage();

	@Test
	public static void TestParameterTableEditParameterPopupScreenPropertie() throws InterruptedException, IOException {
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		// login test
		LoginTest.Login();
		// Navigation to TestConfiguration
		TestConfigNavigation.TestConfigurationCard();
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Test_Parameter", "TC-PAR-0104-01");
		// edit pop-up screen properties
		tPmediticonpopup(TestConfiRev_MaterialSubHeadingProperties.adddata.get(0));
		// Refresh
	...
	public static void tPmediticonpopup(String data) {
		PageFactory.initElements(driver, editiconpopupscreen);
		try {
			TestConfigPage.paraMeterbutton.click();
			try {
				driver.findElement(By.xpath("//td[text()='" + data + "']//following-sibling::td/span/a[1]")).click();
				Thread.sleep(2000);
				tpmediticonIconPopup();
	...
	public static void tpmediticonIconPopup() {
		PageFactory.initElements(driver, editiconpopupscreen);
		// edit pop-up screen Properties
		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Test_Parameter",
				"TC-PAR-0104-02", TestConfigPage.tpmediticonpopup, "Edit icon pop-up screen Properties");
	}
}
