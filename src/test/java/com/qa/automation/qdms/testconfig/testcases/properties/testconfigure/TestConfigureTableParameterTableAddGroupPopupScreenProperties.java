...
* Description
*------------
*Test Configure Table - Parameter Table-"Add Group" Pop up Screen Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
*TC-TCN-0475        03/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableAddGroupPopupScreenProperties extends DriverIntialization {
	...
	public static void addParaMeterAddGroupButton() throws InterruptedException, IOException {
		...
		try {
			...
			// If clicks
			addParaMeterAddGroupPopUpScreen();
	...
	public static void addParaMeterAddGroupPopUpScreen() throws InterruptedException, IOException {

		PageFactory.initElements(driver, testConfig);

		ProCommonMethods.modal("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0475-02",
				TestConfigPage.paraMeterAddParaMeterAddGroupPopUpScreen,
				"Test Configure Table - Parameter Table-Add Group Pop up Screen Properties");
