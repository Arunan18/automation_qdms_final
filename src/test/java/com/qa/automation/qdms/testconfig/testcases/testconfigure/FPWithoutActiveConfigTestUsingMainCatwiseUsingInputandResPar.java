...
//* Description
//*------------
//*FPWithoutActiveConfigTestUsingMainCatwiseUsingInputandResPar
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0406           09/06/2023    Priyanka       Orginal Version
//*
//*******************************************************************************
...
public class FPWithoutActiveConfigTestUsingMainCatwiseUsingInputandResPar extends DriverIntialization {
	...
	public static void FPTestActiveWithKeyTest() throws IOException, InterruptedException {
		...
		extent.createTest("TC-TCN-0406:FPWithoutActiveConfigTestUsingMainCatwiseUsingInputandResPar");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0406-first");
		Thread.sleep(2000);
		// STEP2 :SELECTING THE PARAMETER IN TEST PARAMETER PAGE
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0406-secound");
		Thread.sleep(3000);
		// STEP3 :ADD THE PARAMETER
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0406-secound");
		Thread.sleep(2000);
		// STEP4 :ADD THE EQUATIONS
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0406-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0406-fourth");
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);
		// CLICK ON NEXT BUTTON
		...
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0406-seventh");
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();

		TestConfigPage.nextBtn.click();

		// Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0406-first",
				"TC-TCN-0406-secound", "TC-TCN-0406-third", "TC-TCN-0406-fourth", "TC-TCN-0406-fifth",
				"TC-TCN-0406-sixth", "TC-TCN-0406-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0406-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "first",
