...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test Table Top Configured Groups Action Delete Icon Properties
******************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0059           06/07/2023   M.Mathushan    Original Version
*
*******************************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionDeleteIconProperties  extends DriverIntialization {

	static configGroupTestsPage lk = new configGroupTestsPage();
	   
	@Test

	public static void configureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionDeleteIconProperties ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0059-01");
		...
		// Check Properties
		configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionDeleteIconProperties(TestConfiRev_MaterialSubHeadingProperties.adddata.get(1));
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionDeleteIconProperties  (String data) throws InterruptedException {
Thread.sleep(1000);
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0059-02", driver.findElement(By.xpath("//main/div/div/div[2]/div/form//form//td[text()='"+data+"']/following-sibling::td[3]/span")),
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Configure Group Delete Icon Properties");
