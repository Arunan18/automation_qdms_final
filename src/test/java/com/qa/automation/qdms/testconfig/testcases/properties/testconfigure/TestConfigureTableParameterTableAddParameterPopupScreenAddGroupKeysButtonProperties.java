...
* Description
*------------
Test Configure Table - Parameter Table-Add Parameter Pop up Screen- "Add GroupKeys" Button Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0498       06/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableAddParameterPopupScreenAddGroupKeysButtonProperties
	...
	public static void commonMethodForButtonProperties() throws InterruptedException, IOException {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0498-02",
				TestConfigPage.paraMeterAddParaMeterAddGroupKeysButton,
				"Test Configure Table - Parameter Table-Add Parameter Pop up Screen- Add GroupKeys Button Properties");
