...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test - Material Test Table "Add Test" Pop up Screen Add Test UI Heading Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-TC-0055             23/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class addTestPopupHeading extends DriverIntialization{


@Test
	public void addtestHeadingUI() throws InterruptedException, IOException {
		//login test
		LoginTest.Login();
	...
	public void addtestpopupHeadingUI() {
		TestConfigPage tcp=new TestConfigPage();
		PageFactory.initElements(driver, tcp);
//      GET PROPERTIES OF STATUS HEADING BY TEXT PROPERTIES COMMON METHOD
//      PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test", "TC-TC-0055-02", TestConfigPage.addtestpopupheading,
//              "Checking TEST TABLE TEST add popup heading UI Properties :");
	}
