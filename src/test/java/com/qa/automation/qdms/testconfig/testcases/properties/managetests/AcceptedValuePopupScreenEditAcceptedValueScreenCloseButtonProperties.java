...
* Description
*------------
*MTC-MT-229	Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen  - Edit Accepted Value Screen - "Close" Button Properties
***************************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
*  
*MTC-MT-229         17/07/2023    THAKSHILA    Modified Version    */
...
public class AcceptedValuePopupScreenEditAcceptedValueScreenCloseButtonProperties
	...
	public static void buttonProperties() {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests", "MTC-MT-229-02",
				ManageTestsPage.acceptValuePopEditCloseButton,
				"Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen  - Edit Accepted Value Screen - Close Button Properties");
