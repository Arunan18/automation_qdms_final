...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test Configuration Top bar "Test" UI Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-TC-0004             22/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class testTopBarProperties extends DriverIntialization {
	@Test
	...
	public void testButtonTopBarUI() {
		...
		PageFactory.initElements(driver, tcp);
			...
			PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test Configuration", "TC-TC-0004-01", TestConfigPage.testtopnav, "Test Configuration test Button (top bar)UI Properties");
