...
//* Description
//*------------
//*FPTestWithoutActiveConfigureTestUsingMainCategorywiseoneresultsparametar
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-TCN-0341            26/05/2023    Priyanka       Orginal Version
//*
//*******************************************************************************
...
public class FPTestWithoutActiveConfigureTestUsingMainCategorywiseoneresultsparametar extends DriverIntialization {
	...
	public static void FPTestActiveWithKeyTest() throws IOException, InterruptedException {
		...
		extent.createTest("TC-TCN-0341:FPTestWithoutActiveConfigureTestUsingMainCategorywiseoneresultsparametar");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0341-first");
		Thread.sleep(2000);
		// STEP2 :SELECTING THE PARAMETER IN TEST PARAMETER PAGE
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0341-secound");
		Thread.sleep(3000);
		// STEP3 :ADD THE PARAMETER
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0341-secound");
		Thread.sleep(2000);
		// STEP4 :ADD THE EQUATIONS
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0341-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0341-fourth");
		Thread.sleep(3000);
		// CLICK ON NEXT BUTTON
		...
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0341-seventh");
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();

		TestConfigPage.nextBtn.click();

		// Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0341-first",
				"TC-TCN-0341-secound", "TC-TCN-0341-third", "TC-TCN-0341-fourth", "TC-TCN-0341-fifth",
				"TC-TCN-0341-sixth", "TC-TCN-0341-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0341-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "first",
