 ...
 * ================        ====         =====          ========
 * TC-TCN-0688		    13/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class AcceptedCriteriaTableTwoActionColEditPopEquationTextBox extends DriverIntialization{
	...
	public static void methodTextBoxProperties() {
		...
		//Get Edit Icon Pop-Up: 'Equation' Text Box Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0688-02", TestConfigPage.tableTwoActionColEditPopEquationDropTextBox, "'Equation' Text Box Properties");
