 ...
 * ================        ====         =====          ========
 * TC-TCN-0613			 08/07/2023   Shangeetha    Original Version  
 ******************************************************************************************************************/
...
public class ConfigEquTabTableActionDeleteIconPopUpOkBtnProperties extends DriverIntialization{
	...
	public static void configureEquation() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Delete Icon Pop-Up, 'OK' Button Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Check 'Delete' Icon Pop-Up, 'OK' Button Properties	
	...
	public static void deleteIconPopUpOkBtnProperties() {
		...
		//Check 'Delete' Icon Pop-Up, 'OK' Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0613-02", TestConfigPage.configEquActionDeleteIconPopOkBtn,"'Delete' Icon Pop-Up, 'OK' Button Properties");
       }	
}