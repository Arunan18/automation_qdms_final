...
//* Description
//*------------
//*  Configure Test  Using Sub Category wise (Using Input & Results Parameter)Finish Product With Active
//********************************************************************************************************
//*
//* Author           : MATHUSAN
...
//* ================       ====         =====        ========
//* TC-TCN-0404			 09/06/2023    MATHUSAN     Original Version
//* 
//********************************************************************************************************
...
public class FinishProductConfigureTestUsingSubCategorywiseUsingInputandResultsParameterwithActive
	...
	public static void action() throws InterruptedException, IOException {
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0404-first");
		Thread.sleep(2000);

		// TEST PARAMETER FIELD
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0404-second");
		Thread.sleep(3000);

		// ADD PARAMETER FIELD
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0404-second");
		Thread.sleep(2000);

		// CONFIGURE EQUATION FIELD
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0404-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0404-fourth");
		Thread.sleep(3000);
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

		// ACCEPTED CRITERIA FIELD
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0404-fifth");
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

		// ADD ACCEPTED CONDITION
		AcceptCondition.condition("Test Configuragtion Module", "Test_Configure", "TC-TCN-0404-sixth");
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

		// ADD INFORMATION
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0404-seventh");
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

		// REVIEW TEST CHECK IN REVIEW TAB
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0404-first",
				"TC-TCN-0404-second", "TC-TCN-0404-third", "TC-TCN-0404-fourth", "TC-TCN-0404-fifth", " ",
				"TC-TCN-0404-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0404-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "second",
