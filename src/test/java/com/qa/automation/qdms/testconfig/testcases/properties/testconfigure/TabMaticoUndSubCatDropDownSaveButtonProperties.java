...
//* Description
//*------------
//*Test Configure - Configure Test Table- Top Bar - Add Key Test Tab - Material icon - Under Sub Category Drop Down - "Save" Button Properties
//***************************************************************************************
//*
//* Author           : THAKSHILA
...
//* ================       ====         =====        ========
//*  
//*TC-TCN-0725         14/07/2023    THAKSHILA    Modified Version                   
//************************************************************************************
...
public class TabMaticoUndSubCatDropDownSaveButtonProperties extends DriverIntialization {
...
// ADD KEY TEST SUB CATEGORY ICON PROPERTIES
	...
	public static void addkeySubCategoryButtonProperties() {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0725-02", TestConfigPage.selectForKeyMaterSaveButton,
				"Test Configure - Configure Test Table- Top Bar - Add Key Test Tab - Material icon - Under Sub Category Drop Down - Save Button Properties");
