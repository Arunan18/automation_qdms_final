...
* Description
*------------
* Test Configure Manage Test Configuration Tab Raw Material Heading UI Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-146           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class  ManageTestConfigurationTabRawMaterialHeadingUIProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
	@Test

	public static void testConfigurationTabRawMaterialHeadingUIProperties  ()
		...
		configurationTabRawMaterialHeadingUIProperties();
	...
	public static void configurationTabRawMaterialHeadingUIProperties () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-146-02",ManageTestsPage.testConfigureManageTestConfigurationTabedrawmaterialheadingProperties,
				"Step-4--testConfigure ManageTest Configuration Tab RawMaterial heading Properties");
	}
}
