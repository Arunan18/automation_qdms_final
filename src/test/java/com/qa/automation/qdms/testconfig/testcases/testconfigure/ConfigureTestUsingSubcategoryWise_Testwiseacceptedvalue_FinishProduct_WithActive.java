...
//* Description
//*------------
//* Configure Test Using Sub category Wise Test wise accepted value (FINISH PRODUCT TEST- WITH ACTIVE)
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0320        	26/05/2023    Gobithan     Orginal Version
//*
//************************************************************************************
...
public class ConfigureTestUsingSubcategoryWise_Testwiseacceptedvalue_FinishProduct_WithActive
	...
	public static void configuretest() throws InterruptedException, IOException {
		...
		// TESTCASE REPORT
		extent.createTest(
				"TC-TCN-0320-ConfigureTest Using SubcategoryWise Testwiseacceptedvalue FinishProduct WithActive");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0320-first");

		// TEST PARAMETER FIELD
		Thread.sleep(2000);

		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0320-second");

		// ADD PARAMETER FIELD
		Thread.sleep(3000);
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0320-second");

		// CONFIGURE EQUATION FIELD
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0320-third");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0320-fourth");
		...
		// ACCEPTED CRITERIA FIELD
		Thread.sleep(3000);
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0320-fifth");
		...
		Thread.sleep(3000);
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0320-seventh");
		TestConfigPage.nextBtn.click();

		// Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0320-first",
				"TC-TCN-0320-second", "TC-TCN-0320-third", "TC-TCN-0320-fourth", "TC-TCN-0320-fifth", "",
				"TC-TCN-0320-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0320-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "first",
