...
//* Description
//*------------
//* Test Parameter Delete Function Before Depend
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-MT-055			 16/05/2023   Gobithan     Orginal Version
//*
//************************************************************************************
...
public class ParameterDeleteFunctionBeforeDepend extends DriverIntialization {
	...
	public static void beforedepend() throws InterruptedException, IOException {
		...
		AddGroupKey.actionS(0, 7, mangetest.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Manage_Tests", "MTC-MT-055-01", 1);

		/* SELECT THE DELETE VALUE */
		ActionCommonMethod.actionS(0, 9, mangetest.testparametertablecontainer, "delete",
				"Test Configuragtion Module.xlsx", "Manage_Tests", "MTC-MT-055-01", 2);
		...
		String successmessage = TestConfigNavigation.excel("Test Configuragtion Module", "Manage_Tests", "MTC-MT-055",
				3);

		/* DELETE MESSAGE */
		SampleCommonMethods.dataaddedsuccessmsg("03--DELETE CONFERMATION MESSAGE BEFORE DEPEND", mangetest.successMsg,
				successmessage);
