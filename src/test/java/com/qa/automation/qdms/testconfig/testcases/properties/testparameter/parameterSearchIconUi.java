...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test Parameter Table "Parameter" Search icon Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-PAR-0070             26/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class parameterSearchIconUi extends DriverIntialization{


@Test
	public void parametersearchiconUI() throws InterruptedException, IOException {
		//login test
		LoginTest.Login();
	...
	public void clicktestconfigrationcard() {
		...
		try {
			...
			try {
				...
				Thread.sleep(500);
				parametertabparameterSearchIcon();
	...
	public void parametertabparameterSearchIcon() {
		TestParameterPage tcp=new TestParameterPage();
		PageFactory.initElements(driver, tcp);
//      GET PROPERTIES OF STATUS SEARCH ICON BY ICON PROPERTIES COMMON METHOD
      PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Test", "TC-TC-0070-02", TestParameterPage.parameterSearchicon,
              "Checking PARAMETER TABLE PARAMETER COLOUM search icon UI Properties :");
	}
