...
//* Description
//*------------
//* Test Configure - Manage Test Configuration Tab- Accepted Condition- Accepted Condition Pop up Screen- "Parameter" UI Sub Heading  Properties
//***************************************************************************************
//*
//* Author           : N.Karunya
...
//* ================       ====         =====        ========
//* MTC-MT-321          04/07/2023    N.Karunya   Original Version                
//************************************************************************************
...
public class Managetest_AcceptedconditionIcon_AcceptedconditionPopup_ParametersubHeadingProps
	...
	@Test
	public static void parametersubHeading() throws InterruptedException, IOException {
	...
	public static void addConditionpopupheadingExcel() throws IOException {
	...
	public static void parametersubHeadingProperties() {

		PageFactory.initElements(driver, mtp);

		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-321-02", ManageTestsPage.parameterheading,
				"Manage Test - Accepted Condition Popup  Parameter Heading Properties");
