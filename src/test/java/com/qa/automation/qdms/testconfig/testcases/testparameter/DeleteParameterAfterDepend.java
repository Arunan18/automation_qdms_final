...
public class DeleteParameterAfterDepend extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		ActionCommonMethod.actionS(0, 3, testpage.productionSampleTable, "delete", "Test Configuragtion Module.xlsx",
				"Test_Parameter", "TC-TPM-0007-01", 1);
	   ...
	   /* DATA DELETED SUCCESS MESSAGE */
		SampleCommonMethods.dataaddedsuccessmsg("STEP_5-- DATA IS NOT DELETED",testpage.successMsg, message);
			
	   /*TABLE DATA COUNT READUSED OR NOT */
		SampleCommonMethods.equalpass("STEP_6-- DATA COUNT IN THE DATA TABLE", testpage.tablecount, String.valueOf(datacount));
