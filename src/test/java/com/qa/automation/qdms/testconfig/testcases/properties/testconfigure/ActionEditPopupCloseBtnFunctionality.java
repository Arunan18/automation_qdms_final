...
//* Description
//*------------
//* Test Configure - "Accepted Condition" - Action Column Edit Icon Pop up Screen - Close Icon Functionality
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0751         17/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ActionEditPopupCloseBtnFunctionality extends DriverIntialization {
	...
	public static void editIconPopupCloseIcon() throws InterruptedException, IOException {
		...
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 14, "Description", "Test Configuration Properties","Test_Configure", "TC-TCN-0751");
		...
		//Calling the method
		editIconPopupCloseIconFunctionality();
	...
	public static void editIconPopupCloseIconFunctionality() throws InterruptedException, IOException {
	...
	public static void  editIconPopupClose(){
		PageFactory.initElements(driver, testconfigurebutton);

		//Check 'Edit' Icon Pop-Up, 'Cancel' Button Functionality
		functionality.ButtonAndIconunctionalityMtd("'Close' Icon Functionality", TestConfigPage.editiconpopupupcloseicon, "Icon");
	}	
}
