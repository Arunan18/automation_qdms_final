...
//* Description
//*------------
//* Config Group Tests- Configured Group Table- Tests Column Icon - Tests Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-093       10/07/2023       K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfiguredGroupsTestsPopupTestsHeadingProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	static String codetype = null;
	@Test
	public static void testsPopupTestsHeadingProperties() throws InterruptedException, IOException {
		...
		//Calling the method
		testsPopupTestsHeadingPropertiess();
	...
	public static void testsPopupTestsHeadingPropertiess() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void testsHeadingProperties() {	
		PageFactory.initElements(driver, GroupTestpg);

		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test", "MTC-GT-093-02", GroupTestsPage.testscolumnPopuptestsheading, "Tests Column Icon Pop up Screen Tests Heading Properties");
	}
}
