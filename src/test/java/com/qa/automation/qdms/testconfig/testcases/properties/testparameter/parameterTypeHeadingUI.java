...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* parameter Table "parameter tpe" UI Heading  Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-PAR-0075             26/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class parameterTypeHeadingUI extends DriverIntialization{


@Test
	public void parametertypeHeadingUI() throws InterruptedException, IOException {
		//login test
		LoginTest.Login();
	...
	public void parametertpeTablecolHeading() {
		TestParameterPage tcp=new TestParameterPage();
		PageFactory.initElements(driver, tcp);
//      GET PROPERTIES OF STATUS HEADING BY TEXT PROPERTIES COMMON METHOD
      PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test", "TC-TC-0075-02", TestParameterPage.parametertableheading,
              "Checking TEST TABLE TEST parameter tpe COLOUM Heading UI Properties :");
