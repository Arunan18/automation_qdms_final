...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test - Material Test Table - Add Test-Pop up Screen "Save" button Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
public class addTestSaveButtonUI extends DriverIntialization{


@Test
	public void addtestSaveButtonUI() throws InterruptedException, IOException {
		//login test
		LoginTest.Login();
	...
	public void addtestsaveButtonUI() {
		TestConfigPage tcp=new TestConfigPage();
		PageFactory.initElements(driver, tcp);
//      GET PROPERTIES OF STATUS POPUP TEXTBOX BY TEXTBOX PROPERTTIES COMMON METHOD
//		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test", "TC-TC-0059-02", TestConfigPage.addtestsavebtn,
//              "Checking TEST TABLE TEST add save button UI Properties :");
	}
