...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test End Table Save Button Properties  
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0069           07/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestEndTableSaveButtonProperties   extends DriverIntialization {

	static configGroupTestsPage lk = new configGroupTestsPage();
	   
	@Test

	public static void configureConfigGroupTestTopBarConfigGroupTestEndTableSaveButtonProperties   ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0069-01");
		...
		// Check Properties
		configGroupTestTopBarConfigGroupTestEndTableSaveButtonProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestEndTableSaveButtonProperties() throws InterruptedException {
		PageFactory.initElements(driver, lk);
		Thread.sleep(2000);
		
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0069-02", configGroupTestsPage.configGroupTest_AfterDropDownconfiguregroupendtablesavebutton,
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Configure Group Table Test End Save Button Properties");
