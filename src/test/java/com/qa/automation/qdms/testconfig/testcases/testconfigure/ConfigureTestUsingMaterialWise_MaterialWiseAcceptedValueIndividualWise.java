...
* Description
*------------
**TC-TCN-0368-Configure Test Using Material wise  (Material wise accepted value)(Individual wise)
*******************************************************************************************************
*
...
* ================       ====         =====        ========
*TC-TCN-0368          09/06/2023      RAHUL.S       Original Version
*                     
*******************************************************************************************************/
...
public class ConfigureTestUsingMaterialWise_MaterialWiseAcceptedValueIndividualWise extends DriverIntialization {
...
//        Configure Test Configure Test Step
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0368-first");
		Thread.sleep(500);

//        Select Parameter in Parameter Step
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0368-second");
		Thread.sleep(500);

//        Add parameter in Parameter Step
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0368-second");
		Thread.sleep(500);

//        Add Equation in Equation Step
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0368-third");
		Thread.sleep(3000);
...
//        Next Button Click in Equation
		...
		AcceeptedCretiaStep.accepted("Test Configuragtion Module", "Test_Configure", "TC-TCN-0368-fourth");
		Thread.sleep(3000);
...
//        Add Key Test in Key Test Step
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0368-fifth");
...
//        Add Additional Information in Additional Information Step
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0368-seventh");
...
//		Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0368-first",
				"TC-TCN-0368-second", "TC-TCN-0368-third", "TC-TCN-0368-fourth", "TC-TCN-0368-fifth",
				"", "TC-TCN-0368-seventh");
...
//		Done Button Click
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0368-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "second",
