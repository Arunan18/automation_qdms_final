...
* Description
*------------
* Test Configure Manage Test Configuration Tab Main Header Button Properties  
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-106           07/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureManageTestConfigurationTabMainHeaderButtonProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();

	@Test

	public static void configureManageTestConfigurationTabMainHeaderButtonProperties() throws InterruptedException, IOException {
	...
	public static void manageTestConfigurationTabMainHeaderButtonProperties() {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-106-02", ManageTestsPage.mainManagetestConfigureNavication,
				"Step-4--Test Configure Manage Test Configuration Tab Main Header Button Properties");
	}
}