...
//* Description
//*------------
//* Edit Additional Information Validation
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0225 	      09/05/2023   Gobithan     Original Version
//*
//************************************************************************************
...
public class AditionalInformationEditValidation extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		AddGroupKey.actionS(0, 10, managepage.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Test_Configure", "TC-TCN-0225-01", 1);

		/* SELECT THE ADDITIONAL INFORMATION DISPLAYED & ENABLED */
		extent.createTest("STEP_04-- ADDITIONAL INFORMATION  EDIT BUTTON PROPERTIES");
		ActionCommonMethod.actionS(0, 4, testnav.additionaltable, "edit", "Test Configuragtion Module.xlsx",
				"Test_Configure", "TC-TCN-0225-01", 2);

		/* CLEAR THE DATA IN FIELDS */
		testnav.caption.sendKeys(Keys.CONTROL, "a", Keys.DELETE);
		testnav.maxlength.sendKeys(Keys.CONTROL, "a", Keys.DELETE);

		extent.createTest("STEP :5 ADD ADDITIONAL INFORMATION EDIT VALIDATION");
		/* CAPTION CAN'T BE EMPTY */
		validation(testnav.captionvalidation, 0);
		/* MAX LENGTH CAN'T BE EMPTY */
		validation(testnav.maxlengthvalidation, 1);
	...
	public static void validation(WebElement validation_xpath, int j) {
		try {
			...
			testnav.savebtnadditional.click();
			Thread.sleep(1000);
