...
//* Description
//*------------
//*CONFIGURE EQUATION TAB FUNCTION
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-TCN-0010    12/05/2023  Niluxy    Original Version
//*
//************************************************************************************
...
public class ConfigureEquationTabFunction extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		AddGroupKey.actionS(0, 14, mangetest.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Test_Configure", "TC-TCN-0010-01", 1);

		//CLICK ON THE CONFIGURE TEST BUTTON
		driver.findElement(By.xpath("(//div[@class='ant-steps-item-icon'])[3]")).click();
		...
		boolean value2 = TestConfigNavigation.function("STEP_06--TEST PARAMETER", testnav.TestParameter,
				"rgba(255, 255, 255, 1)", "01--TEST PARAMETER ICON", "02--TEST PARAMETER ICON");
		boolean value3 = TestConfigNavigation.function("STEP_07--CONFIGURE EQUATION", testnav.Configureequation,
				"rgba(24, 144, 255, 1)", "01--CONFIGURE EQUATION", "02--CONFIGURE EQUATION");
		...
		Thread.sleep(2000);
		TestConfigNavigation.expectedwindow("STEP_14--CONFIGURE EQUATION TAB BUTTON HAS BEEN TESTED",
				testnav.configEquationtabheading, "01--EXPECTED WINDOW HEADING DISPLAYED", "Configure Equation");
