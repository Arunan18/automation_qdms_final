...
* Description
*------------
*Test Configure Manage Test Configuration Tab- Accepted Value Pop up Screen Edit Accepted Value Heading UI Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*  MTC-MT-215           17/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class ManageTestConfigurationTabAcceptedValuePopupScreenActionEditAcceptedValueHeadingUIProperties
		extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();

	@Test

	public static void popupScreenActionEditAcceptedValueHeadingUIProperties() throws InterruptedException, IOException {
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-215-01");
		...
		actionEditAcceptedValueHeadingUIProperties();
	...
	// Check the Accepted Value Pop up Screen Accepted Value Action Edit Accepted Value Heading UI Properties
	public static void actionEditAcceptedValueHeadingUIProperties() {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests", "MTC-MT-215-02",
				ManageTestsPage.acceptedValueActionEditHeadingUIProperties,
