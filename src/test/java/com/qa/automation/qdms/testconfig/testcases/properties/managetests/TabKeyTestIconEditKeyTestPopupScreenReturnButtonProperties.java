...
* Description
*------------
* Test Configure - Manage Test Configuration Tab Key Test Icon Edit Key Test Pop up Screen Return Button Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-132           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class TabKeyTestIconEditKeyTestPopupScreenReturnButtonProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
    static String test =null;
	@Test

	public static void keyTestIconEditKeyTestPopupScreenReturnButtonProperties ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-132-01");
		...
		testIconEditKeyTestPopupScreenReturnButtonProperties();
	...
	public static void testIconEditKeyTestPopupScreenReturnButtonProperties () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		Thread.sleep(1000);
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-132-02",ManageTestsPage.testIconEditKeyTestPopupScreenReturnButtonProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test Pop up Screen Select Subcategory Screen Return Button Properties");
	}
