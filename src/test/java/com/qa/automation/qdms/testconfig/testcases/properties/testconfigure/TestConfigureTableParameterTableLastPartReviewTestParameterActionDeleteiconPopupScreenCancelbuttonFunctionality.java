...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action- "Delete icon"  Pop up Screen "Cancel" button Functionality
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0569          13/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableLastPartReviewTestParameterActionDeleteiconPopupScreenCancelbuttonFunctionality extends DriverIntialization {
	...
	public static void commonMethodTextBoxProperties() throws InterruptedException, IOException {
		...
		testCase = extent.createTest("DELETE ICON POP UP CANCEL BUTTON FUNCTIONALITY");

		wait.until(ExpectedConditions
				.elementToBeClickable(TestConfigPage.reviewTestParaMeterDeleteIconPopCancelButton));

		try {
			if (TestConfigPage.reviewTestParaMeterDeleteIconPopCancelButton.isDisplayed()) {

				testCase = extent.createTest("STEP-1-CANCEL BUTTON IS DISPLAYED");
				testCase.log(Status.PASS, "TEST PASS ☑");

				if (TestConfigPage.reviewTestParaMeterDeleteIconPopCancelButton.isEnabled()) {
					...
					try {
						...
						TestConfigPage.reviewTestParaMeterDeleteIconPopCancelButton.click();
