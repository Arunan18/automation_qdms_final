 ...
 * "Raw Material ", Drop-down Properties
 **********************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0685		    12/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class AcceptedCriteriaTableTwoActionColEditPopRawMaterialDropdown extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Edit Icon Pop-Up: 'Raw Material' Drop-down Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Get Edit Icon Pop-Up: 'Raw Material' Drop-down Properties
			methodDropdownProperties();			
	...
	public static void methodDropdownProperties() {
		PageFactory.initElements(driver, testPage);
		//Get Edit Icon Pop-Up: 'Raw Material' Drop-down Properties
		ProCommonMethods.dropDown("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0685-02", TestConfigPage.tableTwoActionColEditPopRawMaterialDropTextBox, "'Raw Material' Drop-down Properties", "1");
