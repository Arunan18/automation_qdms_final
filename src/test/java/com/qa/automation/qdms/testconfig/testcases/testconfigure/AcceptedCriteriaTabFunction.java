...
//* Description
//*------------
//*ACCEPETED CRITERIA TAB FUNCTION -TEST CONFIGURE
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-TCN-0012            12/05/2023    Niluxy       Original Version
//*
//************************************************************************************
...
public class AcceptedCriteriaTabFunction extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		extent.createTest("TC-TCN-0012-ACCEPETED CRITERIA TAB FUNCTION -TEST CONFIGURE");
		// LOGIN TO THE SYSTEM
		LoginTest.Login();
		...
		SampleCommonMethods.mainmethod("STEP_02-- MANAGE TEST CONFIGURE TOP NAVIGATION PROPERTIES",
				TestConfigPage.ManageCofigureMenuBar, "01--MANAGE TEST CONFIGER TOP NAVIGATION BUTTON DISPLAYED",
				"02--MANAGE TEST CONFIGER TOP NAVIGATION BUTTON ENABLED", TestConfigPage.GroupTest,
				TestConfigPage.managetest,
		...
		SampleCommonMethods.methodoneclick("STEP_03-- MANAGE TEST PROPERTIES", TestConfigPage.managetest,
				...
				"02--CONFIGURE TEST LEFT NAVIGATION BUTTON ENABLED", ManageTestsPage.managetestconfigure,
		...
		AddGroupKey.actionS(0, 14, ManageTestsPage.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Test_Configure", "TC-TCN-0012-01", 1);

		// CLICK ON THE CONFIGURE TEST BUTTON
		driver.findElement(By.xpath("(//div[@class='ant-steps-item-icon'])[4]")).click();
		...
		TestConfigNavigation.expectedwindow("STEP_14-- ACCEPETED CRITERIA TAB BUTTON HAS BEEN TESTED",
				TestConfigPage.acceptedcriteria, "01--EXPECTED WINDOW HEADING DISPLAYED", "Accepted criteria");
