...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test Parameter Table "Parameter type" Search Pop up  Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-PAR-0077             27/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class parametertypeSearchpopup extends DriverIntialization{
...
@Test
		...
		try {
			...
			try {
				...
				try {
					...
					Thread.sleep(1000);
					parametertabparametertypeSearchpopupUI();
	...
	public void parametertabparametertypeSearchpopupUI() {
		TestParameterPage tcp=new TestParameterPage();
		PageFactory.initElements(driver, tcp);
//      GET THE PROPERTIES OF INCOMING SAMPLE TABLE SAMPLE CODE SEARCH POPUP BY POPUP PROPERTIES COMMON METHOD
      PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Test", "TC-TC-0077-02", TestParameterPage.parametertypesearchpop,
              "Checking parameter TABLE parameter type search POPUP UI Properties :");
	}
