...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen -"Cancel" Button Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0559         11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class EditiconPopupScreenCancelButtonProperties extends DriverIntialization {
	...
	public static void commonMethodButtonProperties() throws InterruptedException, IOException {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0559-02", TestConfigPage.reviewTestParaMeterEditIconPopCancelButtonProps,
				"Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen -Cancel Button Properties");
