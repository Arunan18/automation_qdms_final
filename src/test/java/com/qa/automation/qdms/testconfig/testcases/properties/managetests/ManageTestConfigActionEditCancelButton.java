 ...
 * ================       ====         =====          ========
 * MTC-MT-257           17/07/2023   M.Shangeetha   Original Version  *          	                                            
 **************************************************************************************************************************************************/
...
public class ManageTestConfigActionEditCancelButton extends DriverIntialization{
	...
	public static void manageTestConfigActionEditPopup() throws InterruptedException, IOException {
		...
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 9, "Description", "Test Configuration Properties",
				"Manage_Tests", "MTC-MT-257");
		Thread.sleep(2000);

		// Calling The Method To Check The Edit Icon Pop-Up, "Cancel" Button Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Check Edit Icon Pop-Up, "Cancel" Button Properties
			editIconPopUpEditPopCancelBtn();			
	...
	public static void editIconPopUpEditPopCancelBtn() {
		PageFactory.initElements(driver, testPage);
		//Get Edit Icon Pop-Up Heading, "Cancel" Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests","MTC-MT-257-02", ManageTestsPage.eqIconPopEditPopUpCancelButton,"Edit Icon Pop-Up,'Cancel' Button Properties");
