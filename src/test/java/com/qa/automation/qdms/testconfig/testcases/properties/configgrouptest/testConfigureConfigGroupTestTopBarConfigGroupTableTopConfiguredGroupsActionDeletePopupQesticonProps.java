...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test Table Top Configured Groups Action Delete Pop up Screen "?" icon Properties 
******************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0061           06/07/2023   M.Mathushan    Original Version
*
*******************************************************************************************************************************************/
...
public class testConfigureConfigGroupTestTopBarConfigGroupTableTopConfiguredGroupsActionDeletePopupQesticonProps  extends DriverIntialization {

	static configGroupTestsPage lk = new configGroupTestsPage();
	   
	@Test

	public static void configureConfigGroupTestTopBarConfigGroupTableTopConfiguredGroupsActionDeletePopupQesticonProps   ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0061-01");
		...
		// Check Properties
		configGroupTestTopBarConfigGroupTableTopConfiguredGroupsActionDeletePopupQesticonProps();
	...
	public static void configGroupTestTopBarConfigGroupTableTopConfiguredGroupsActionDeletePopupQesticonProps   () throws InterruptedException {
Thread.sleep(1000);
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0061-02", configGroupTestsPage.configGroupTest_AfterDropDownconfiguredeletepopupquestionicon,
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Configure Group Delete popup ? Icon Properties");
