 ...
 * Description
 *------------
 *Test Configure - Manage Test Configuration Tab-Equation Column, Equation Icon's Pop-Up: Action Column: "Edit" Pop up,
 ...
 * ================       ====         =====          ========
 * MTC-MT-256           17/07/2023   M.Shangeetha   Original Version 
 *          	                                            
 **************************************************************************************************************************************************/
...
public class ManageTestConfigActionEditEquationTextbox extends DriverIntialization{
	...
	public static void manageTestConfigActionEditPopup() throws InterruptedException, IOException {
		...
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 9, "Description", "Test Configuration Properties",
				"Manage_Tests", "MTC-MT-256");
		Thread.sleep(2000);

		// Calling The Method To Check The Edit Icon Pop-Up, "Edit Equation" Text Box Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			editIconPopUpEditEqTextBoxProperties();			
	...
	public static void editIconPopUpEditEqTextBoxProperties() {
		PageFactory.initElements(driver, testPage);
		//Get Edit Icon Pop-Up Heading, "Edit Equation" Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Manage_Tests","MTC-MT-256-02", ManageTestsPage.eqIconPopEditPopUpEditEqTextBox,"Edit Icon Pop-Up,'Edit Equation' Text Box Properties");
