...
//* Description
//*------------
//* RM_WithoutActive_ConfigureTestUsingMainCategorywiseMaterialwiseAcceptedValue_Common
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-TCN-0285            8/06/2023    Niluxy       Orginal Version
//*
//************************************************************************************
...
public class RM_WithoutActive_ConfigureTestUsingMainCategorywiseMaterialwiseAcceptedValue_Common
	...
	public static void action() throws InterruptedException, IOException {
		...
		extent.createTest(
				"TC-TCN-0285:RM_WithoutActive_ConfigureTestUsingMainCategorywiseMaterialwiseAcceptedValue_Common");
		// LOGIN TO THE SYSTEM
		LoginTest.Login();
		...
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0285-second");
		Thread.sleep(3000);
		// STEP3 :ADD THE PARAMETER
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0285-second");
		Thread.sleep(3000);
		...
		AcceeptedCretiaStep.accepted("Test Configuragtion Module", "Test_Configure", "TC-TCN-0285-fourth");
		Thread.sleep(3000);
		// MOVE TO DOWN
		...
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0285-first",
				"TC-TCN-0285-second", "TC-TCN-0285-third", "TC-TCN-0285-fourth", "TC-TCN-0285-fifth", "",
				"TC-TCN-0285-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0285-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "First",
