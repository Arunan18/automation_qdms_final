...
//* Description
//*------------
//*Configure Test Using SubCategory wise Material wise accepted value Common wise
//***********************************************************************************
//*
//* Author           : MATHUSAN
...
//* ================       ====         =====        ========
//* TC-TCN-0286			 26/05/2023    MATHUSAN     Original Version
//* 
//************************************************************************************
...
public class ConfigureTestUsingSubCategorywiseMaterialwiseacceptedvalueCommonwise extends DriverIntialization  {
	...
	public static void action() throws InterruptedException, IOException {
		...
		//TEST PARAMETER FIELD 
				TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0286-secound");
				Thread.sleep(3000);

		// ADD PARAMETER FIELD 
				TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0286-secound");
				Thread.sleep(2000);
		...
		// CONFIGURE EQUATION FIELD 
				...
				Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0286-fourth");
				Thread.sleep(3000);
				TestConfigPage.nextBtn.click();
				Thread.sleep(3000);
				...
				//Thread.sleep(3000);
				//AcceptCondition.condition("Test Configuragtion Module", "Test_Configure", "TC-TCN-0286-sixth");
				//TestConfigPage.nextBtn.click();
				//Thread.sleep(3000);
				...
				ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0286-first",
						"TC-TCN-0286-secound", "TC-TCN-0286-third", "TC-TCN-0286-fourth", "TC-TCN-0286-fifth", " ",
						"TC-TCN-0286-seventh");
				...
				TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
						"TC-TCN-0286-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "secound",
