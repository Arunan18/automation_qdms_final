...
* Description
*------------
Test Configure Table - Parameter Table-Add Parameter Pop up Screen- "Test Parameter"  Search icon  Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0478     03/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableAddParameterPopupScreenTestParameterSearchiconProperties
	...
	public static void addParaMeterAddGroupPopUpParameterSearchIcon() throws InterruptedException, IOException {
		...
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0478-02",
				TestConfigPage.paraMeterAddParaMeterAddGroupPopUpScreenTestParameterSearchICon,
				"Test Configure Table - Parameter Table-Add Parameter Pop up Screen- Test Parameter  Search icon  Properties");
