...
//* Description
//*------------
//*FPTestActiveConfigureTestUsingMaterialwiseWithKeyTest
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0330            26/05/2023    Priyanka       Orginal Version
//*
//************************************************************************************
...
public class FPTestActiveConfigureTestUsingMaterialwiseWithKeyTest extends DriverIntialization {
	...
	public static void FPTestActiveWithKeyTest() throws IOException, InterruptedException {
		...
		extent.createTest("TC-TCN-0330:FPTestActiveConfigureTestUsingMaterialwiseWithKeyTest");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0330-first");
		Thread.sleep(2000);
		// STEP2 :SELECTING THE PARAMETER IN TEST PARAMETER PAGE
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0330-secound");
		Thread.sleep(3000);
		// STEP3 :ADD THE PARAMETER
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0330-secound");
		Thread.sleep(2000);
		// STEP4 :ADD THE EQUATIONS
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0330-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0330-fourth");
		Thread.sleep(3000);
		// CLICK ON NEXT BUTTON
		...
		Thread.sleep(3000);
		// STEP6 :ADD TEST KEYS
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0330-fifth");
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

		// STEP8 :ADD ADITIONAL INFORMATION
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0330-seventh");
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();

		TestConfigPage.nextBtn.click();

		// Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0330-first",
				"TC-TCN-0330-secound", "TC-TCN-0330-third", "TC-TCN-0330-fourth", "TC-TCN-0330-fifth",
				"TC-TCN-0330-sixth", "TC-TCN-0330-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0330-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "first",
