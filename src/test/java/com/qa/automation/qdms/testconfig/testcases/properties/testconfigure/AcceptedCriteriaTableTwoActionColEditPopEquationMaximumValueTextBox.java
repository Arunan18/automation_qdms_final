 ...
 * ================        ====         =====          ========
 * TC-TCN-0690		    13/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class AcceptedCriteriaTableTwoActionColEditPopEquationMaximumValueTextBox extends DriverIntialization{
	...
	public static void methodTextBoxProperties() {
		...
		//Get Edit Icon Pop-Up: 'Equation Maximum Value's' Text Box Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0690-02", TestConfigPage.tableTwoActionColEditPopEquationMaximumTextBox, "'Equation Maximum Value's' Text Box Properties");
