...
//* Description
//*------------
//* Test Configure - "Accepted Condition" - Action Column Edit Icon Pop up Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0745         14/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class AcceptedConditionActionColumnEditIconPopup extends DriverIntialization {
	static TestConfigPage testconfigurebutton = new TestConfigPage();
	static String code = null;
	@Test
	public static void actionColumnEditIconPopup() throws InterruptedException, IOException {
		// Calling The Common Method To Navigate From The Login Page To Scrolling In The Manage Test Page and Click on Edit Configure Icon
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 14, "Description", "Test Configuration Properties","Test_Configure", "TC-TCN-0745");
	...
	public static void  editIconPopupProperties(){
		...
		ProCommonMethods.modal("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0744-02", TestConfigPage.actioncolumnediticonpopup , "Action Column Edit Icon Pop up Properties");
	}	
}
