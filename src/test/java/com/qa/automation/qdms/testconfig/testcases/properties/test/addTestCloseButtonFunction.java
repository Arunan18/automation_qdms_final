...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test - Material Test Table - Add Test-Pop up Screen "Close" button Functionality
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-TC-0059             23/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class addTestCloseButtonFunction extends DriverIntialization {


@Test
	public void addtestclosebtnfunI() throws InterruptedException, IOException {
		//login test
		LoginTest.Login();
	...
	public void addtestclosebtnfun() {
		TestConfigPage tcp=new TestConfigPage();
		PageFactory.initElements(driver, tcp);
		try {
//			boolean value1= TestConfigPage.addtestclosebtn.isDisplayed();
//			SampleCommonMethods.TestCasePrint("close button visiblity", "true",String.valueOf(value1));
//			boolean value2 = TestConfigPage.addtestclosebtn.isEnabled();
//			SampleCommonMethods.TestCasePrint("close button enablity", "true",String.valueOf(value2));
		} catch (NoSuchElementException e) {
			testCase = extent.createTest("Checking The add test close button function");
            testCase.log(Status.INFO, "Unable to Locate the element 'add test close button function'");
            testCase.log(Status.FAIL, "TEST FAIL ❎");
        }
        catch (ElementClickInterceptedException e) {
        	testCase = extent.createTest("Checking The add test close button function");
            testCase.log(Status.INFO, "Unable to Click on the element 'add test close button function'");
            testCase.log(Status.FAIL, "TEST FAIL ❎");
        }
        catch (Exception e) {
        	testCase = extent.createTest("Checking The add test close button function");
