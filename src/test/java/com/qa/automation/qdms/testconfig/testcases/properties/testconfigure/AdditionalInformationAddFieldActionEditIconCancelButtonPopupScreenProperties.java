...
//* Description
//*------------
//* Test Configure Configure Test Table Top Bar Additional Information Add Field Action Edit Icon Cancel Button Pop up Screen Properties
//***************************************************************************************************************************************
//*
//* Author           :M.Mathushan
...
//* ================       ====         =====        ========
//* TC-TCN-0788			14/07/2023    M.Mathushan   Original Version  
//*                    
//***************************************************************************************************************************************
...
public class AdditionalInformationAddFieldActionEditIconCancelButtonPopupScreenProperties extends DriverIntialization {
	static TestConfigPage testconfigpg = new TestConfigPage();

	@Test
	public static void informationAddFieldActionEditIconCancelButtonPopupScreenProperties() throws InterruptedException, IOException {

		// MANAGE TEST PAGE PATH FROM LOGIN
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 14, "Description", "Test Configuration Properties",
				"Test_Configure", "TC-TCN-0788");
		// Get the Data For Excel
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Test_Configure", "TC-TCN-0788-01");
		...
		// Field Action Edit Icon Cancel Button PoPup Screen Properties
		addFieldActionEditIconCancelButtonPopupScreenProperties();
	...
	// Information Add Field Action Edit  Cancel Button PoPup Screen Properties

	public static void addFieldActionEditIconCancelButtonPopupScreenProperties() {
		PageFactory.initElements(driver, testconfigpg);
		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0788-02",TestConfigPage.addFieldActionEditIconCancelButtonPopupScreenProperties,
				"Additional Information  Add Field Status Add Field Action Edit Cancel Button PopupScreen Properties");
