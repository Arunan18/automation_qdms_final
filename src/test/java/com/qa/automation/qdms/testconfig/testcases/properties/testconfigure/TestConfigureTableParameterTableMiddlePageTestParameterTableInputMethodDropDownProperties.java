...
* ================       ====         =====        ========
TC-TCN-0509         06/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableMiddlePageTestParameterTableInputMethodDropDownProperties
	...
	public static void commonMethodTextBoxProperties() throws InterruptedException, IOException {
		...
		ProCommonMethods.dropDown("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0509-02",
				TestConfigPage.paraMeterTestParaMeterInputMethodDropdown,
