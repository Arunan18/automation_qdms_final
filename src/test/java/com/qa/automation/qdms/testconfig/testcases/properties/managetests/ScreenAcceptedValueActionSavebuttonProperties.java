...
* Description
*------------
*Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen - Accepted Value-Action - "Save" button Properties
***************************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
*  
*MTC-MT-238       17/07/2023    THAKSHILA    Modified Version    */
...
public class ScreenAcceptedValueActionSavebuttonProperties extends DriverIntialization {
	...
	public static void buttonProperties() {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-238-02", ManageTestsPage.acceptValuePopDeletePopUpSaveButton,
				"Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen - Accepted Value-Action - Save button Properties");
