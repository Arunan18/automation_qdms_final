...
//* Description
//*------------
//* Configure Test  Using Material wise  (with due day)
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0337        	30/05/2023     Saranka     Orginal Version
//*
//************************************************************************************
...
public class Configure_Test_Using_Material_Wise_With_Due_Day extends DriverIntialization {
	static TestConfigPage catDueDay = new TestConfigPage();
	static configGroupTestsPage configPage = new configGroupTestsPage();

	@Test
	public void configureTestMaterialDueFunc() throws InterruptedException, IOException {
...
// _______________________________
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0337-first");
		Thread.sleep(2000);
...
// __________________________________________________________
		...
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0337-Second");
		Thread.sleep(3000);
...
//_______________________________________        
		...
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0337-Second");
		Thread.sleep(2000);
...
//_______________________________________        
		...
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0337-Third");
		Thread.sleep(3000);
...
//______________________________________ 
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0337-fourth");
		Thread.sleep(3000);
...
//_______________________________
		...
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0337-fifth");
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();
		TestConfigPage.nextBtn.click();
...
//_________________________________        
		...
		Thread.sleep(3000);
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0337-seventh");
...
//___________________________________        
		...
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0337-first",
				"TC-TCN-0337-Second", "TC-TCN-0337-Third", "TC-TCN-0337-fourth", "TC-TCN-0337-fifth",
				"TC-TCN-0337-sixth", "TC-TCN-0337-seventh");
...
// _________________________________
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0337-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "First",
