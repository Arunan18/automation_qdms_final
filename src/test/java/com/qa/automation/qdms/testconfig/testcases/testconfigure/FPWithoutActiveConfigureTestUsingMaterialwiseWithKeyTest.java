...
//* Description
//*------------
//*FPWithoutActiveConfigureTestUsingMaterialwiseWithKeyTest
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0361           31/05/2023    Priyanka       Orginal Version
//*
//************************************************************************************
...
public class FPWithoutActiveConfigureTestUsingMaterialwiseWithKeyTest extends DriverIntialization {
	...
	public static void FPTestActiveWithKeyTest() throws IOException, InterruptedException {
		...
		extent.createTest("TC-TCN-0361:FPWithoutActiveConfigureTestUsingMaterialwiseWithKeyTest");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0361-first");
		Thread.sleep(2000);
		// STEP2 :SELECTING THE PARAMETER IN TEST PARAMETER PAGE
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0361-secound");
		Thread.sleep(3000);
		// STEP3 :ADD THE PARAMETER
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0361-secound");
		Thread.sleep(2000);
		// STEP4 :ADD THE EQUATIONS
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0361-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0361-fourth");
		Thread.sleep(3000);
		// CLICK ON NEXT BUTTON
		...
		Thread.sleep(3000);
		// STEP6 :ADD TEST KEYS
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0361-fifth");
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

		// STEP8 :ADD ADITIONAL INFORMATION
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0361-seventh");
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();

		TestConfigPage.nextBtn.click();

		// Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0361-first",
				"TC-TCN-0361-secound", "TC-TCN-0361-third", "TC-TCN-0361-fourth", "TC-TCN-0361-fifth",
				"TC-TCN-0361-sixth", "TC-TCN-0361-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0361-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "first",
