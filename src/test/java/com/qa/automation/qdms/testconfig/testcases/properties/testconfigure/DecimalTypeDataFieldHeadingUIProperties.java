...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen - "Decimal Type" Data Field Heading UI Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0557           11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class DecimalTypeDataFieldHeadingUIProperties extends DriverIntialization {
	...
	public static void commonMethodHeadingProperties() throws InterruptedException, IOException {
		...
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0557-02", TestConfigPage.reviewTestParaMeterEditIconPopRelevantDecimalTypeHead,
				"Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen -Decimal Type Data Field Heading UI Properties");
