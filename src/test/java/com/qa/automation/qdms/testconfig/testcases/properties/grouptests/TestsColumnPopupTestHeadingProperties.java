...
//* Description
//*------------
//* Manage Test "Tests" - Pop up Screen Tests Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-054         05/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class TestsColumnPopupTestHeadingProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void testsPopupTestHeading() throws InterruptedException, IOException {
	...
	public static void testPopupheadingProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			testCase = extent.createTest("Checking Tests ColumnIcon");
			testCase.log(Status.INFO, "Tests Column Icon Click is not Occured");
			testCase.log(Status.FAIL, "TEST FAIL");
		}
	}
	public static void testHeadingPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Column Pop up Screen Test Heading UI Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-054-02", GroupTestsPage.testcolumnpopuptestheading, "Tests Column Popup Screen Test Heading UI Properties");
	}
}
