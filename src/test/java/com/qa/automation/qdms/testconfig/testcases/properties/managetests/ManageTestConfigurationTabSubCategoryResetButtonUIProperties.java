...
* Description
*------------
* Test Configure Manage Test Configuration Tab Sub Category Reset Button  UI Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-145           12/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class  ManageTestConfigurationTabSubCategoryResetButtonUIProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
	@Test

	public static void testConfigurationTabSubCategoryResetButtonUIProperties    ()
		...
		//Check the Manage Test Configuration TabKey Test Icon Properties
		 configurationTabSubCategoryResetButtonUIProperties();
	...
	public static void configurationTabSubCategoryResetButtonUIProperties () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-145-02",ManageTestsPage.testConfigureManageTestConfigurationTabedsubcategorysearchbutton,
