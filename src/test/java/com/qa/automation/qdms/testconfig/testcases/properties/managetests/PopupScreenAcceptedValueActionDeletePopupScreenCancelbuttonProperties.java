...
* Description
*------------
Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen - Accepted Value-Action  - Delete Pop up Screen  "Cancel" button Properties 
***************************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
*  
*MTC-MT-236     17/07/2023    THAKSHILA    Modified Version    */
...
public class PopupScreenAcceptedValueActionDeletePopupScreenCancelbuttonProperties extends DriverIntialization {
	...
	public static void popUpScreenButtonProperties() {
		PageFactory.initElements(driver, manageTest);

		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests", "MTC-MT-236-02",
				ManageTestsPage.acceptValuePopDeletePopUpCancelButton,
				"Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen - Accepted Value-Action - Delete Pop up Screen  Cancel  button Properties ");
