...
* Description
*------------
*Test Configure - Manage Test Configuration Tab Key Test Icon Edit Key Test Pop up Screen Material UI Heading  Properties
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-121           10/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenMaterialUIHeadingProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
static String test =null;
	@Test

	public static void configureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenMaterialUIHeadingProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-121-01");
		...
		manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenMaterialUIHeadingProperties();
	...
	public static void manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenMaterialUIHeadingProperties() {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-121-02",ManageTestsPage.testConfigureManageTestConfigurationTabeditKeytestmaterialheadingProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test Material UI Heading Properties");
	}
