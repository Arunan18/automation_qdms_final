...
* Description
*------------
Test Configure Table - Parameter Table-Add Parameter Pop up Screen- "Test Parameter" (3rd Table) Filed UI Heading  Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0491         05/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TesConfigureTableParameterTableAddParameterPopupScreenTesParameter3rdTableWithoutDataCheckNoDataProperties
	...
	public static void addParaMeterAddGroupButton() throws InterruptedException, IOException {
		...
		try {
			...
			// If clicks
			commonMethodForGetNODataIconoperties();
	...
	public static void commonMethodForGetNODataIconoperties() throws InterruptedException, IOException {

		PageFactory.initElements(driver, testConfig);

		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0491-02",
				TestConfigPage.paraMeterAddParaMeterNoDataIcon,
				"Test Configure Table - Parameter Table-Add Parameter Pop up Screen- Test Parameter (3rd Table) Without Data - Check No Data Properties");
