 ...
 * ================        ====         =====          ========
 * TC-TCN-0694		    12/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaTabActionColEditconPopCancelBtn extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check 'Edit' Icon Pop-Up, 'Cancel' Button Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			editIconPopUpCancelButtonProperties();			
	...
	public static void editIconPopUpCancelButtonProperties() {
		PageFactory.initElements(driver, testPage);
		//Check 'Edit' Icon Pop-Up, 'Cancel' Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0694-02", TestConfigPage.acceptedCriteriaTableTwoActionColEditPopCancelBtn,"Edit Icon Pop-Up, 'Cancel' Button Properties");
