...
* Description
*------------
*Test Configure - Configure Test Table-  Top Bar Review Test - Key Test - Material Pop up Screen - "Close" Button  Properties
...
* ================       ====         =====        ========
*TC-TCN-0844           22/06/2023   Quenthan     Orginal Version
*
************************************************************************************/
...
public class ReviewTest_Material_Popup_CloseButtonProperties extends DriverIntialization {
	...
	public void modalproperties() throws InterruptedException, IOException {
		...
		TestConfiRev_MaterialSubHeadingProperties.navicateAndProperties("Test_Configure", "TC-TCN-0844-01", 2);

		// Click Material View Icon
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Test_Configure", "TC-TCN-0844-01");
...
//		Check Properties
	...
	public static void propertiesKeyTestCloseButton() {
		...
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0844-02",TestConfigPage.materialPuModalCloseButton ,
				"Step-5-Modal -Key Test Cancal Ok Properties");
