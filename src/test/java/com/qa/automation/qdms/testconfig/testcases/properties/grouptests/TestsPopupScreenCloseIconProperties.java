...
//* Description
//*------------
//* Manage Test "Tests" - Pop up Screen Close Icon Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-062        05/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class TestsPopupScreenCloseIconProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void testsPopupCloseIcon() throws InterruptedException, IOException {
	...
	public static void testPopupCloseIconProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void testCloseIconProperties() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Column Pop up Screen Close Icon Properties
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-062-02", GroupTestsPage.testspopupcloseicon, "Tests Column Popup Screen Close Icon Properties");
	}
}
