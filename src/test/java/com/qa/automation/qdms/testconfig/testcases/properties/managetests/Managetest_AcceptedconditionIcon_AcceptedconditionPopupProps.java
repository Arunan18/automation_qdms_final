...
//* Description
//*------------
//* Test Configure - Manage Test Configuration Tab- Accepted Condition- "Accepted Condition" Pop up Screen UI  Properties
//***************************************************************************************
//*
//* Author           : N.Karunya
...
//* ================       ====         =====        ========
//* MTC-MT-319          04/07/2023    N.Karunya   Original Version                
//************************************************************************************
...
public class Managetest_AcceptedconditionIcon_AcceptedconditionPopupProps extends DriverIntialization {
	...
	@Test
	public static void acceptedconditionPopup() throws InterruptedException, IOException {

		// CALLING THE COMMON METHOD FOR NAVIGATE FROM-LOGIN TO SCROLLING IN THE MANAGE
		// TEST PAGE
		NavigateManageTestFromLogin.navigateManageTestFromLogin("Manage Tests", 11);

		// Check Accepted Condition Popup UI Properties
		acceptedconditionPopupExcel();
	...
	public static void acceptedconditionPopupExcel() throws IOException {
		...
		try {
			...
			acceptedconditionPopupProperties();
	...
	public static void acceptedconditionPopupProperties() throws InterruptedException {

		PageFactory.initElements(driver, mtp);

		ProCommonMethods.modal("Test Configuration Properties.xlsx", "Manage_Tests", "MTC-MT-319-02",
				ManageTestsPage.acceptedconditionpopup, "Manage Test - Accepted Condition Popup UI Properties");
