...
* Description
*------------
Test Configure Table - Parameter Table-Add Parameter Pop up Screen- "GroupKeys" UI Heading  Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
*TC-TCN-0476         03/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableAddParameterPopupScreenGroupKeysUIHeadingPropertie
	...
	public static void addParaMeterAddGroupButton() throws InterruptedException, IOException {
		...
		try {
			...
			// If clicks
			addParaMeterAddGroupPopUpScreenKeysHeading();
	...
	public static void addParaMeterAddGroupPopUpScreenKeysHeading() throws InterruptedException, IOException {

		PageFactory.initElements(driver, testConfig);

		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0476-02", TestConfigPage.paraMeterAddParaMeterAddGroupPopUpScreenGroupKeysHead,
				"Test Configure Table - Parameter Table-Add Parameter Pop up Screen- GroupKeys UI Heading  Properties");
