...
------------
 ...
 "Select Parameter for create equation" Table: "Unit" Column Heading
*************************************************************************************************************************************************
 ...
 ================       ====         =====        ========
 TC-TCN-0585          14/07/2023    Shangeetha      Original Version
***************************************************************************************************************************************************/
...
public class ResultsSelectParameterForCreatEquationTableUnitColumnHeading extends DriverIntialization{
	...
	public static void configureEquation() throws InterruptedException, IOException {
      ...
      //Check "Unit" Column Heading Properties
	...
	public static void methodTextProperties() {
		PageFactory.initElements(driver, testPage);
		//Check "Unit" Column Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0585-02", TestConfigPage.configureEquationTestUnitColumnHeading, "'Unit' Column Heading Properties");
