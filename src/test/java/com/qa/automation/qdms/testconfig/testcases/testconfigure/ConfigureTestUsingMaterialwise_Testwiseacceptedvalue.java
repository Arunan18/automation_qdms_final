...
* ================       ====         =====        ========
*TC-TCN-0352          31/05/2023   Quenthan     Orginal Version
*
************************************************************************************/
...
public class ConfigureTestUsingMaterialwise_Testwiseacceptedvalue extends DriverIntialization {
	...
	public static void ConfigureTestUsingMaterialwise() throws InterruptedException, IOException {
		...
		LoginTest.Login();
		extent.createTest(
				"TC-TCN-0352-Configure Test  Using Material wise  (Test wise accepted value)--FINISH PRODUCT  TEST-Without Active");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0352-first");
		Thread.sleep(2000);

		// TEST PARAMETER FIELD
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0352-secound");
		Thread.sleep(3000);

		// ADD PARAMETER FIELD
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0352-secound");
		Thread.sleep(2000);

		// CONFIGURE EQUATION FIELD
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0352-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0352-fourth");
		Thread.sleep(3000);
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

		// ACCEPTED CRITERIA FIELD
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0352-fifth");
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

//		//ADD CONDITION IN CONDITION STEP
//				Thread.sleep(3000);
//				AcceptCondition.condition("Test Configuragtion Module", "Test_Configure", "TC-TCN-0352-sixth");
//				TestConfigPage.nextBtn.click();
//				Thread.sleep(3000);

		// ADD INFORMATION
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0352-seventh");
		...
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0352-first",
				"TC-TCN-0352-secound", "TC-TCN-0352-third", "TC-TCN-0352-fourth", "TC-TCN-0352-fifth",
				"TC-TCN-0352-sixth", "TC-TCN-0352-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0352-eight", AddConfigureTest.testname, AddConfigureTest.testtype, "second",
