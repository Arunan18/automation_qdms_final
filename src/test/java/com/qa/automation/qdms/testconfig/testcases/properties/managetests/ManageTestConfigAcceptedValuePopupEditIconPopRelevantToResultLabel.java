 ...
 *  "Relevant To Result", Label Properties
 ****************************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * MTC-MT-225		    14/07/2023      Shangeetha    Original Version  
 **************************************************************************************************************************************/
...
public class ManageTestConfigAcceptedValuePopupEditIconPopRelevantToResultLabel extends DriverIntialization{
	...
	public static void relevantToResultsLabelProperties() {
		...
		//Get Edit Icon Pop-Up: 'Relevant to Results' Label Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests","MTC-MT-225-02", ManageTestsPage.tableTwoActionColEditPopRelevantToTestLabel,"'Relevant to Results' Label Properties");
