 ...
 * "Parameter", Drop-down Properties
 **********************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0681		    12/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class AcceptedCriteriaTableTwoActionColEditPopParameterDropdown extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Edit Icon Pop-Up: 'Parameter' Drop-down Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Get Edit Icon Pop-Up: 'Parameter' Drop-down Properties	
	...
	public static void methodDropdownProperties() {
		...
		//Get Edit Icon Pop-Up: 'Parameter' Drop-down Properties
		ProCommonMethods.dropDown("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0681-02", TestConfigPage.tableTwoActionColEditPopParameterDropdownTextBox, "'Parameter' Drop-down Properties", "1");
