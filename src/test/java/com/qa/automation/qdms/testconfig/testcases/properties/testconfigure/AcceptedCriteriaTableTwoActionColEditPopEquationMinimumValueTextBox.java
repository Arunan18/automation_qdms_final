 ...
 * "Equation Minimum Value's", Text Box Properties
 **********************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0689		    13/07/2023      Shangeetha    Original Version  
 ********************************************************************************************************************************/
...
public class AcceptedCriteriaTableTwoActionColEditPopEquationMinimumValueTextBox extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Edit Icon Pop-Up: 'Equation Minimum Value's'' Text Box Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Get Edit Icon Pop-Up: 'Equation Minimum Value's'' Text Box Properties	
	...
	public static void methodTextBoxProperties() {
		...
		//Get Edit Icon Pop-Up: 'Equation Minimum Value's' Text Box Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0689-02", TestConfigPage.tableTwoActionColEditPopEquationMinimumTextBox, "'Equation Minimum Value's' Text Box Properties");
