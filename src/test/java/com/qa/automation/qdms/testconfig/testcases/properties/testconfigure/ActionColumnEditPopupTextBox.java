...
//* Description
//*------------
//* Test Configure - "Accepted Condition" - Action Column Edit Icon Pop up Screen - TextBox Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0747        14/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ActionColumnEditPopupTextBox extends DriverIntialization{
	static TestConfigPage testconfigurebutton = new TestConfigPage();
	static String code = null;
	@Test
	public static void editIconPopupTextBox() throws InterruptedException, IOException {
		// Calling The Common Method To Navigate From The Login Page To Scrolling In The Manage Test Page and Click on Edit Configure Icon
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 14, "Description", "Test Configuration Properties","Test_Configure", "TC-TCN-0747");
		...
		//Calling the method
		editIconPopupTextBoxProperties();
	...
	public static void editIconPopupTextBoxProperties() throws InterruptedException, IOException {
		...
		try {
			...
			//Calling the method
			editIconPopupTextBoxPropertiess();
	...
	public static void  editIconPopupTextBoxPropertiess(){
		PageFactory.initElements(driver, testconfigurebutton);

		//Check Action Column Edit Icon Properties
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0747-02", TestConfigPage.editiconpopuptextbox, "Action Column Edit Icon Pop up Screen TextBox Properties");
	}	
}
