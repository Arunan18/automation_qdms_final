...
* Description
*------------
* Test Configure Table - Parameter  Table - "Data Type"  Reset Button  Properties
***********************************************************************************
*
...
* ================       ====         =====        ========
* TC-TCN-0452         23/06/2023      RAHUL.S    Original Version
*
*************************************************************************************/
...
public class ParameterTableDataTypeResetButton extends DriverIntialization {
	...
	public static void dataTypeResetButton() throws InterruptedException, IOException {
		PageFactory.initElements(driver, testConfig);
		WebDriverWait wait = new WebDriverWait(driver, 20);
		wait.until(ExpectedConditions
				.visibilityOf(TestConfigPage.dataTypeResetButton));
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0452-02", TestConfigPage.dataTypeResetButton,
				"PARAMETER DATATYPE RESET BUTTON");
