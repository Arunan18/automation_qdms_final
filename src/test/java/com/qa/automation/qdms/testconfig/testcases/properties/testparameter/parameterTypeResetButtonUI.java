...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test Parameter Table "Parameter type" reset button  Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*     TC-PAR-0080             26/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class parameterTypeResetButtonUI extends DriverIntialization{



@Test
	public void parametertyperesetbuttonUIProperties() throws InterruptedException, IOException {
		//login test
		LoginTest.Login();
		...
		try {
			...
			try {
				...
				try {
					...
					Thread.sleep(1000);
					parametertabparametertperestbuttonUI();
	...
	public void parametertabparametertperestbuttonUI() {
		TestParameterPage tp=new TestParameterPage();
		PageFactory.initElements(driver, tp);
//      GET PROPERTIES OF STATUS POPUP TEXTBOX BY TEXTBOX PROPERTTIES COMMON METHOD
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Parameter", "TC-PAR-0080-02", TestParameterPage.parametertyperestbutton,
