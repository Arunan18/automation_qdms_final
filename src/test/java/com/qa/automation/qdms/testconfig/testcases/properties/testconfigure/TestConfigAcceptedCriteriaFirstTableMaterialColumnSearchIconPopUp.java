 ...
 * "Material" Column Search Pop-Up Properties
 ****************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0642		    12/07/2023      Shangeetha    Original Version  
 ***************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaFirstTableMaterialColumnSearchIconPopUp extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Accepted criteria Tab, Select "Between" Condition, First Table :Check 'Material' Column Search Icon Pop-Up Properties  
	...
	public static void methodAcceptCriteriaTabMaterialColumnSearchIconPopUp() {
		PageFactory.initElements(driver, testPage);
		// Accepted criteria Tab, Select "Between" Condition, First Table :Check 'Material' Column Search Icon Pop-Up Properties 
		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0642-02", TestConfigPage.equationConditionBetweenMaterialColSearchPopUp, "'Material' Column Search Icon's Pop-Up Properties");
	}
}