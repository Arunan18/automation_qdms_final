 ...
 * "Material" Column Search Pop-Up, "Search" Button Properties
 ****************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0644		    12/07/2023      Shangeetha    Original Version  
 ***************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaFirstTableMaterialColumnSearchPopUpSearchBtn extends DriverIntialization{
	...
	public static void acceptedCriteria() throws InterruptedException, IOException {
		...
		// Accepted criteria Tab, Select "Between" Condition, First Table :Check "Material" Column Search Pop-Up's "Search" Button Properties 
	...
	public static void methodClickOnColumnSearchIcon() {
		...
		try {
			...
			// Check 'Material' Column Search Pop-Up's 'Search' Button Properties
			methodMaterialColumnSearchIconPopUpSearchButton();
	...
	public static void methodMaterialColumnSearchIconPopUpSearchButton() {
		PageFactory.initElements(driver, testPage);
		// Accepted criteria Tab, Select "Between" Condition, First Table :Check "Material" Column Search Pop-Up's "Search" Button Properties 
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0644-02", TestConfigPage.equationConditionBetweenMaterialColSearchPopSearchBtn, "'Search' Button Properties on 'Material' Column Search Pop-Up");
	}
}
