...
//* Description
//*------------
//*Test Configure - Configure Test Table- Top Bar - Add Key Test Tab - Material icon - Under Sub Category Drop Down - "Name" Heading UI Properties
//***************************************************************************************
//*
//* Author           : THAKSHILA
...
//* ================       ====         =====        ========
//*  
//*TC-TCN-0724         14/07/2023    THAKSHILA    Modified Version                   
//************************************************************************************
...
public class ConfigureTestTableTopBarAddKeyTestTabMaterialiconUnderSubCategoryDropDownNameHeadingUIProperties
...
// ADD KEY TEST SUB CATEGORY ICON PROPERTIES
	...
	public static void addkeySubCategoryHeadingProperties() {
		...
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0724-02", TestConfigPage.selectForKeyNameHeading,
				"Test Configure - Configure Test Table- Top Bar - Add Key Test Tab - Material icon - Under Sub Category Drop Down - Name Heading UI Properties");
