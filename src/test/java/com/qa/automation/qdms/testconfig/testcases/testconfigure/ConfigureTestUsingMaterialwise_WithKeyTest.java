...
* Description
*------------
*Configure Test  Using Material wise  (With Key Test)
*****************************************************
*
* Author           : S.Quenthan
...
* ================       ====         =====        ========
*TC-TCN-0299          30/05/2023   Quenthan     Orginal Version
*
************************************************************************************/
...
public class ConfigureTestUsingMaterialwise_WithKeyTest extends DriverIntialization {
	...
	@Test
	public static void materialWiseTest() throws InterruptedException, IOException {
		...
		LoginTest.Login();
		extent.createTest(
				"TC-TCN-0299-Configure Test  Using Material wise  (With Key Test)--RAW MATERIAL TEST-Without Active");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0299-first");
		Thread.sleep(2000);

		// TEST PARAMETER FIELD
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0299-secound");
		Thread.sleep(3000);

		// ADD PARAMETER FIELD
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0299-secound");
		Thread.sleep(2000);

		// CONFIGURE EQUATION FIELD
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0299-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0299-fourth");
		Thread.sleep(3000);
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

		// ACCEPTED CRITERIA FIELD
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0299-fifth");
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

//		//ADD CONDITION IN CONDITION STEP
//				Thread.sleep(3000);
//				AcceptCondition.condition("Test Configuragtion Module", "Test_Configure", "TC-TCN-0299-sixth");
//				TestConfigPage.nextBtn.click();
//				Thread.sleep(3000);

		// ADD INFORMATION
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0299-seventh");
		...
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0299-first",
				"TC-TCN-0299-secound", "TC-TCN-0299-third", "TC-TCN-0299-fourth", "TC-TCN-0299-fifth",
				"TC-TCN-0299-sixth", "TC-TCN-0299-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0299-eight", AddConfigureTest.testname, AddConfigureTest.testtype, "second",
