...
//* Description
//*------------
//* Configure Equation Next Button
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0151		 	15/05/2023    Gobithan     Original Version
//* 
//************************************************************************************
...
public class ConfigureEquationNextButton extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		AddGroupKey.actionS(0, 14, mangetest.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Test_Configure", "TC-TCN-0151-01", 2);
		...
		Thread.sleep(2000);
		ButtonFunction.buttonfunction("Test Configuragtion Module", "Test_Configure", "TC-TCN-0151",
				"STEP_05--CONFIGURE EQUATION TAB NEXT BUTTON PROPERTYS",
				"01--CONFIGURE EQUATION TAB NEXT BUTTON DISPLAYED", "02--CONFIGURE EQUATION TAB NEXT BUTTON ENABLED",
				TestConfigPage.acceptedvalue, "Accepted Value",
