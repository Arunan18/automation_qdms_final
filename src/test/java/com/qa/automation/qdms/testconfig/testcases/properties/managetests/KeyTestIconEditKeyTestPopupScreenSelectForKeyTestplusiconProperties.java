...
* ================       ====         =====        ========
*MTC-MT-126           11/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class KeyTestIconEditKeyTestPopupScreenSelectForKeyTestplusiconProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
    static String test =null;
	@Test

	public static void testIconEditKeyTestPopupScreenSelectForKeyTestplusiconProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-126-01");
		...
		testIconEditKeyTestPopupScreenSelectForKeyTestplusiconProperties(TestConfiRev_MaterialSubHeadingProperties.adddata.get(1));
	...
	public static void testIconEditKeyTestPopupScreenSelectForKeyTestplusiconProperties (String keytest) throws InterruptedException {
Thread.sleep(1000);
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-126-02",driver.findElement(By.xpath("//div[@class='ant-modal-content']//td[text()='"+keytest+"']//button")),
