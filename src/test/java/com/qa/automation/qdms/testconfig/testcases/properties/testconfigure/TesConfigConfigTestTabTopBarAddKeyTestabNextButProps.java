...
//* Description
//*------------
//*Test Configure - Configure Test Table-  Top Bar "Add Key Test" Tab -  "Next"  Button Properties
//***************************************************************************************
//*
//* Author           : THAKSHILA
...
//* ================       ====         =====        ========
//*  
//*TC-TCN-0726         14/07/2023    THAKSHILA    Modified Version                   
//************************************************************************************
...
public class TesConfigConfigTestTabTopBarAddKeyTestabNextButProps extends DriverIntialization {
...
// ADD KEY TEST SUB CATEGORY ICON PROPERTIES
	...
	public static void addkeySubCategoryButtonProperties() {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0726-02", TestConfigPage.selectForKeyMaterNextButton,
				"Test Configure - Configure Test Table-  Top Bar Add Key Test Tab -  Next  Button Properties");
