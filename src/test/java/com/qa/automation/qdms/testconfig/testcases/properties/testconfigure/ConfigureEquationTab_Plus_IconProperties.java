...
public class ConfigureEquationTab_Plus_IconProperties extends DriverIntialization {
	...
	public static void configureEquation() throws InterruptedException, IOException {
		...
		// CALLING THE METHOD FOR CHECKING PLUS ICON PROPERTIES
		plusIconProperties();
	...
	public static void plusIconProperties() {
		PageFactory.initElements(driver, testPage);
		// CHECK '+' ICON PROPERTIES
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0588-02",
				TestConfigPage.plusIcon, "'+' ICON PROPERTIES");
	}
