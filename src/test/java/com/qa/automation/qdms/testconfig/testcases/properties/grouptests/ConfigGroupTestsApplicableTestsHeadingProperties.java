...
//* Description
//*------------
//* Config Group Test - "Applicable Tests" Heading Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-082       06/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfigGroupTestsApplicableTestsHeadingProperties extends DriverIntialization{
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void applicableTestsHeading() throws InterruptedException, IOException {
		...
		//Calling the method
		applicableTestsHeadingProperties();
	...
	public static void applicableTestsHeadingProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void applicableTestsHeadProperties() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Applicable Tests Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-082-02", GroupTestsPage.editiconpopupapplicabletestsheading, "Applicable Tests Heading Properties");
	}
}
