...
//* Description
//*------------
//* Manage Test - Edit Icon Pop up Screen Special Category CheckBox Icon Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-076          05/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class SpecialCategoryCheckBoxIconProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void specialcheckboxIcon() throws InterruptedException, IOException {
	...
	public static void checkboxIconProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void actioncheckboxIconPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Column Pop up Properties
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-076-02", GroupTestsPage.editiconpopupspecialcategorycheckbox, "Special Category Check Box Icon Properties");
	}
}
