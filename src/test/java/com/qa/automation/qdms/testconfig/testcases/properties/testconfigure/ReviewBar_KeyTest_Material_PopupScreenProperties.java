...
* Description
*------------
Test Configure - Configure Test Table-  Top Bar Review Test - Key Test -"Material" Pop up Screen Properties
...
* ================       ====         =====        ========
*TC-TCN-0836           22/06/2023   Quenthan     Orginal Version
*
************************************************************************************/
...
public class ReviewBar_KeyTest_Material_PopupScreenProperties extends DriverIntialization{
	...
	public void modalproperties() throws InterruptedException, IOException {
		...
		TestConfiRev_MaterialSubHeadingProperties.navicateAndProperties("Test_Configure", "TC-TCN-0836-01", 2);

		// Click Material View Icon
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Test_Configure", "TC-TCN-0836-01");
...
//		Check Properties
	...
	public static void propertiesMatrialModal() {
		...
		ProCommonMethods.modal("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0836-02", TestConfigPage.materialPuModalkeyTestModal, "Step-5-Modal Of Key Test Properties");
