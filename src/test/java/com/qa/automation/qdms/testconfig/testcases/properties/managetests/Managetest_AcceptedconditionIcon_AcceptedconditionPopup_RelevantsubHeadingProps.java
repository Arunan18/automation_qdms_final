...
//* Description
//*------------
//* Test Configure - Manage Test Configuration Tab- Accepted Condition- Accepted Condition Pop up Screen- "Relevant" UI Sub Heading  Properties
//***************************************************************************************
//*
//* Author           : N.Karunya
...
//* ================       ====         =====        ========
//* MTC-MT-323          05/07/2023    N.Karunya   Original Version                
//************************************************************************************
...
public class Managetest_AcceptedconditionIcon_AcceptedconditionPopup_RelevantsubHeadingProps
	...
	@Test
	public static void relevantsubHeading() throws InterruptedException, IOException {
		...
		// Check Accepted Condition Popup Relevant Heading UI Properties
		relevantsubHeadingExcel();
	...
	public static void relevantsubHeadingExcel() throws IOException {
	...
	public static void relevantsubHeadingProperties() {

		PageFactory.initElements(driver, mtp);

		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-323-02", ManageTestsPage.relevantheading,
				"Manage Test - Accepted Condition Popup Relevant Heading Properties");
