...
//* Description
//*------------
//* Config Group Test - Configured Groups Table- Action Column - Delete Icon Pop up Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-098        10/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfiguredGroupsActionColumnDeleteIconPopup extends DriverIntialization {
	...
	public static void actionColumnDeleteIcon() throws InterruptedException, IOException {
		...
		//Calling the method
		actionColumnDeleteIconPopupProperties();
	...
	public static void actionColumnDeleteIconPopupProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
	...
	public static void deleteIconPopupProperties() {	
		...
		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Group_Test", "MTC-GT-098-02", GroupTestsPage.actioncolumndeleteiconpopup, "Action Column Delete Icon Pop up Properties");
	}
}
