...
* Description
*------------
* Test Configure Manage Test Configuration Tab Key Test Icon Edit Key Test Pop up Screen Return Button Functionality
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-133           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class  KeyTestIconEditKeyTestPopupScreenReturnButtonFunctionality extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
    static String test =null;
	@Test

	public static void testIconEditKeyTestPopupScreenReturnButtonFunctionality  ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-133-01");
		...
		iconEditKeyTestPopupScreenReturnButtonFunctionality();
	...
	public static void iconEditKeyTestPopupScreenReturnButtonFunctionality  () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		Thread.sleep(1000);
		try {
            if (ManageTestsPage.testIconEditKeyTestPopupScreenReturnButtonProperties.isDisplayed()) {
                testCase = extent.createTest("Key Test Icon Edit Key Test Pop up Screen Return Button is Displayed");
                testCase.log(Status.INFO, "Key Test Icon Edit Key Test Pop up Screen Return Button is Displayed");
                testCase.log(Status.PASS, "TEST PASS");
            if (ManageTestsPage.testIconEditKeyTestPopupScreenReturnButtonProperties.isEnabled()) {
                testCase = extent.createTest("Key Test Icon Edit Key Test Pop up Screen Return Button is Enabled");
                testCase.log(Status.INFO, "Key Test Icon Edit Key Test Pop up Screen Return Button is Enabled");
                testCase.log(Status.PASS, "TEST PASS");
            
                } else {
              testCase = extent.createTest("Key Test Icon Edit Key Test Pop up Screen Return Button is not Enabled");
              testCase.log(Status.INFO, "Key Test Icon Edit Key Test Pop up Screen Return Button is not Enabled");
              testCase.log(Status.FAIL, "TEST FAIL");
                }
                 } else {
            testCase = extent.createTest("Key Test Icon Edit Key Test Pop up Screen Return Button not Displayed");
            testCase.log(Status.INFO, "Key Test Icon Edit Key Test Pop up Screen Return Button is not Displayed");
            testCase.log(Status.FAIL, "TEST FAIL");
                }        
                } catch (NoSuchElementException e) {
             testCase = extent.createTest("Checking The Key Test Icon Edit Key Test Pop up Screen Return Button");
             testCase.log(Status.INFO, "Key Test Icon Edit Key Test Pop up Screen Return Button is not available");
             testCase.log(Status.FAIL, "TEST FAIL");
             } catch (Exception e) {
            testCase = extent.createTest("Checking The Key Test Icon Edit Key Test Pop up Screen Return Button");
            testCase.log(Status.INFO,"Unable to check the functionality of Key Test Icon Edit Key Test Pop up Screen Return Button");
            testCase.log(Status.FAIL, "TEST FAIL");
