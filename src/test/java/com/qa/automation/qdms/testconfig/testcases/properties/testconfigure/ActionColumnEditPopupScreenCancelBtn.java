...
//* Description
//*------------
//* Test Configure - "Accepted Condition" - Action Column Edit Icon Pop up Screen - Cancel Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0748        14/07/2023      K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ActionColumnEditPopupScreenCancelBtn extends DriverIntialization {
	static TestConfigPage testconfigurebutton = new TestConfigPage();
	static String code = null;
	@Test
	public static void editIconPopupCancelBtn() throws InterruptedException, IOException {
		// Calling The Common Method To Navigate From The Login Page To Scrolling In The Manage Test Page and Click on Edit Configure Icon
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 14, "Description", "Test Configuration Properties","Test_Configure", "TC-TCN-0748");
		...
		//Calling the method
		editIconPopupCancelBtnProperties();
	...
	public static void editIconPopupCancelBtnProperties() throws InterruptedException, IOException {
		...
		try {
			...
			//Calling the method
			editIconPopupCancelBtnPropertiess();
	...
	public static void  editIconPopupCancelBtnPropertiess(){
		PageFactory.initElements(driver, testconfigurebutton);

		//Check Action Column Edit Icon Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0748-02", TestConfigPage.editiconpopupcancelbtn, "Action Column Edit Icon Pop up Screen Cancel Button Properties");
	}	
}
