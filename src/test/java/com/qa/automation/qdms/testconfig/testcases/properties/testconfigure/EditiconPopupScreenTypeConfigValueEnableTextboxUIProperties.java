...
* Description
*------------
EditiconPopupScreenTypeConfigValueEnablTextboxUIProperties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0552           11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class EditiconPopupScreenTypeConfigValueEnableTextboxUIProperties extends DriverIntialization {
	...
	public static void commonMethodTextBoxProperties() throws InterruptedException, IOException {
		...
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0552-02",
				TestConfigPage.reviewTestParaMeterEditIconPopRInputTextBox,
				"Edit icon  Pop up Screen -(Type - Config)Value Enable Text box  UI Properties");
