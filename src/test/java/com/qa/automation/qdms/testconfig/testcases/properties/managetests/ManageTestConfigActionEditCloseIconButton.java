 ...
 * ================       ====         =====          ========
 * MTC-MT-260          17/07/2023   M.Shangeetha   Original Version           	                                            
 *********************************************************************************************************************************/
...
public class ManageTestConfigActionEditCloseIconButton extends DriverIntialization{
	...
	public static void editIconPopUpEditPopCloseBtn() {
		PageFactory.initElements(driver, testPage);
		//Get Edit Icon Pop-Up, "Close-Icon" Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests","MTC-MT-260-02", ManageTestsPage.eqIconPopEditPopUpCloseButton,"Edit Icon Pop-Up,'Close' Button Properties");
