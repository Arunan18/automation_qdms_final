...
* ================       ====         =====        ========
TC-TCN-0537          10/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConTabParaTabLastPartRevTesParaActEditProps
	...
	public static void excelMethodCheckBox() throws InterruptedException, IOException {
		...
		// Get Properties
		commonMethodEditiconProperties(test1);

	}

	public static void commonMethodEditiconProperties(String test1) throws InterruptedException, IOException {

		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0537-02",
				driver.findElement(
