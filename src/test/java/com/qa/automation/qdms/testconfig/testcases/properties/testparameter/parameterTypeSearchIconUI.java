...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test Parameter Table "Parameter type" Search icon Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-PAR-0076             26/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class parameterTypeSearchIconUI extends DriverIntialization{



@Test
	public void parametertpesearchiconUI() throws InterruptedException, IOException {
		//login test
		LoginTest.Login();
	...
	public void clicktestconfigrationcard() {
		...
		try {
			...
			try {
				...
				Thread.sleep(500);
				parametertabparametertpeSearchIcon();
	...
	public void parametertabparametertpeSearchIcon() {
		TestParameterPage tcp=new TestParameterPage();
		PageFactory.initElements(driver, tcp);
//      GET PROPERTIES OF STATUS SEARCH ICON BY ICON PROPERTIES COMMON METHOD
      PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Test", "TC-TC-0076-02", TestParameterPage.parameterTypesearchicon,
              "Checking PARAMETER TABLE PARAMETER tpe COLOUM search icon UI Properties :");
	}
