...
//* Description
//*------------
//*Test Configure - Configure Test Table- Top Bar - Add Key Test Tab - Material icon - Under Table - Select Sub Category- After that View "Search Material" Text Box Properties
//***************************************************************************************
//*
//* Author           : THAKSHILA
...
//* ================       ====         =====        ========
//*  
//*TC-TCN-0722         14/07/2023    THAKSHILA    Modified Version                   
//************************************************************************************
...
public class SelectSubCategoryAfterthatViewSearchMaterialTextBoxProperties extends DriverIntialization {
...
// ADD KEY TEST SUB CATEGORY ICON PROPERTIES
	public static void addkeySubCategoryclickPlusIcon() throws IOException {
		...
		try {
			...
			// Get Properties
			addkeySubCategoryTextBoxProperties();
	...
	public static void addkeySubCategoryTextBoxProperties() {

		PageFactory.initElements(driver, testconfigpg);
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0722-02",
				TestConfigPage.selectForKeyMaterSearchMatTextBox,
