...
//* Description
//*------------
//* Add_additionalinformation_in_testconfig_under_the_additionalinformation_without_active
//*******************************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0386          08/06/2023    Priyanka       Original Version
//* 
//*******************************************************************************************
...
public class Addadditionalinformationintestconfigundertheadditionalinformationwithoutactive
	...
	public static void FPTestActiveWithKeyTest() throws IOException, InterruptedException {
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0386-first");
		Thread.sleep(2000);
		// STEP2 :SELECTING THE PARAMETER IN TEST PARAMETER PAGE
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0386-secound");
		Thread.sleep(3000);

		// STEP3 :ADD THE PARAMETER
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0386-secound");
		Thread.sleep(2000);

		// STEP4 :ADD THE EQUATIONS
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0386-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0386-fourth");
		...
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0386-seventh");
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();
		String excelPath = System.getProperty("user.dir")
				+ "\\src\\test\\resources\\Excel\\Test Configuragtion Module.xlsx";
		String excelSheetName = "Test_Configure";
		String testCaseId = "TC-TCN-0386-seventh";
		...
		for (int i = firstRow; i <= lastRow; i++) {
			...
			active = (String) row.getCell(5).getStringCellValue();

			Boolean datas = driver
					.findElement(By.xpath("//td[contains(text(),'" + data + "')]/following-sibling::td[3]//input"))
					.isSelected();
			String datass = datas.toString();

			testCase = extent.createTest("ADDITIONAL INFORMATION CONFIRMATION");

			try {

				Assert.assertEquals(datass, active);
				testCase.log(Status.INFO, "Actual Data :- " + datass);
				testCase.log(Status.INFO, "Expected Data :- " + active);
