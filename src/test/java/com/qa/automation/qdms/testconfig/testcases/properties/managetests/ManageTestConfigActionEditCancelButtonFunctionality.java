 ...
 * ================       ====         =====          ========
 * MTC-MT-259           17/07/2023   M.Shangeetha   Original Version  *          	                                            
 **************************************************************************************************************************************************/
...
public class ManageTestConfigActionEditCancelButtonFunctionality extends DriverIntialization{
	...
	public static void manageTestConfigActionEditPopup() throws InterruptedException, IOException {
		...
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 9, "Description", "Test Configuration Properties",
				"Manage_Tests", "MTC-MT-259");
		Thread.sleep(2000);

		// Calling The Method To Check The Edit Icon Pop-Up, "Cancel" Button Functionality
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			editIconPopUpEditPopCancelBtnFunctionality();			
	...
	public static void editIconPopUpEditPopCancelBtnFunctionality() {
		PageFactory.initElements(driver, testPage);
		//Check Edit Icon Pop-Up, "Cancel" Button Functionality
		functionality.ButtonAndIconunctionalityMtd("'Cancel' Button Functionality", ManageTestsPage.eqIconPopEditPopUpCancelButton, "Button");
	}
}
