...
* Description
*------------
*Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen - Accepted Value-Action -"Delete Pop up Screen "?" icon Properties 
***************************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
*  
*MTC-MT-234       17/07/2023    THAKSHILA    Modified Version    */
...
public class AcceptedValueActionDeletePopupScreenQuesiconPropertie extends DriverIntialization {
	...
	public static void popUpScreenProperties() {
		PageFactory.initElements(driver, manageTest);

		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Manage_Tests", "MTC-MT-234-02",
				ManageTestsPage.acceptValuePopDeletePopUpQuesIcon,
				"Test Configure - Manage Test Configuration Tab- Accepted Value Pop up Screen - Accepted Value-Action -Delete Pop up Screen ? icon Properties ");
