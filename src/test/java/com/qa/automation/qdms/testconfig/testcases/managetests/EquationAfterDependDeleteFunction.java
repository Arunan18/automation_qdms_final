...
//* ================       ====         =====        ========
//* MTC-MT-079           18/05/2023     Saranka     Original Version
//*
//***********************************************************************************
...
public class EquationAfterDependDeleteFunction extends DriverIntialization {
	static ManageTestsPage afterDeleteDepend = new ManageTestsPage();
	static TestConfigPage afterDependPage = new TestConfigPage();
...
//======================================================  M E T H O D  =====================================================
	...
	@Test
	public void methodCallingForDeleteFun() throws InterruptedException, IOException {
		
		LoginTest.Login();
		
		EquationAfterDependDeleteFunction.beforeDeleteDependFunctionality();
...
//______________________________________________	
	...
	public static void beforeDeleteDependFunctionality() throws InterruptedException, IOException {
		PageFactory.initElements(driver, afterDeleteDepend);
		PageFactory.initElements(driver, afterDependPage);
...
// ______________________________________________
		...
		AddGroupKey.actionS(0, 9, TestConfigPage.TableManageConfigure, "Description",
				"Test Configuragtion Module.xlsx", "Manage_Tests", "MTC-MT-079-01", 1);
...
// ____________________________________________
		...
		SampleCommonMethods.dataaddedsuccessmsg("STEP:2 CAN'T DELETED SUCESSFULL MESSAGE", validationMessage,
				SucessMessage);
