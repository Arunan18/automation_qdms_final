...
* Description
*------------
* Test Configure Manage Test Configuration Tab Key Test Icon Edit Key Test Pop up Screen Select For Key Test  UI Heading Properties
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-123           10/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSelectForKeyTestUIHeadingProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
static String test =null;
	@Test

	public static void configureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSelectForKeyTestUIHeadingProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-123-01");
		...
		manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSelectForKeyTestUIHeadingProperties();
	...
	public static void manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSelectForKeyTestUIHeadingProperties() {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-123-02",ManageTestsPage.testConfigureManageTestConfigurationTabeditKeytestselectforkeytestUIProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test Pop up Screen Select for Key Test UI Heading Properties");
	}
