...
* Description
*------------
* Test Configure Manage Test Configuration Tab Key Test Icon Edit Key Test Pop up Screen Edit Key Test UI Heading  Properties 
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-118           10/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenEditKeyTestUIHeadingProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
static String test =null;
	@Test

	public static void configureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenEditKeyTestUIHeadingProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-118-01");
		...
		//Check the Manage Test Configuration TabKey Test Icon Properties
		 manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenEditKeyTestUIHeadingProperties();
	...
	public static void manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenEditKeyTestUIHeadingProperties() {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-118-02",ManageTestsPage.testConfigureManageTestConfigurationTabeditKeytestheadingProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test Heading Properties");
	}
