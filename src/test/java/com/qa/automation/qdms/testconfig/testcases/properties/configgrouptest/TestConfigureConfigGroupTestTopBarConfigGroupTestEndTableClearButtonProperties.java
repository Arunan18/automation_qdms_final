...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test End Table Clear Button Properties  
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0068           07/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestEndTableClearButtonProperties  extends DriverIntialization {

	static configGroupTestsPage lk = new configGroupTestsPage();
	   
	@Test

	public static void configureConfigGroupTestTopBarConfigGroupTestEndTableClearButtonProperties   ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0068-01");
		...
		// Check Properties
		configGroupTestTopBarConfigGroupTestEndTableClearButtonProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestEndTableClearButtonProperties() throws InterruptedException {
		PageFactory.initElements(driver, lk);
		Thread.sleep(2000);
		
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0068-02", configGroupTestsPage.configGroupTest_AfterDropDownconfiguregroupendtableclearbutton,
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Configure Group Table Test End Clear Button Properties");
