 ...
 * ================        ====         =====          ========
 * TC-TCN-0605			 07/07/2023   Shangeetha    Original Version  
 ***************************************************************************************************************/
...
public class ConfigEquActEditIconPopUpUpdateBtnProperties extends DriverIntialization{
	...
	public static void configureEquation() throws InterruptedException, IOException {
		...
		// Calling The Method To Check The Edit Icon Pop-Up, Update Button Properties
	...
	public static void editIconPopUpUpdateButtonProperties() {
		...
		//Check 'Edit' Icon Pop-Up, Update Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0605-02", TestConfigPage.configEquActionEditIconPopUpdateBtn,"Edit Icon Pop-Up, 'Update' Button Properties");
