...
//* ================       ====         =====        ========
//* TC-PAR-0062		    26/04/2023   Gobithan     Orginal Version
//*
//************************************************************************************ 
...
public class EditParameterAfterDepend extends DriverIntialization {
	...
	static ActionCommonMethod actionmethod = new ActionCommonMethod();
	...
	public static void action() throws InterruptedException, IOException {
		...
		PageFactory.initElements(driver, actionmethod);
		...
		ActionCommonMethod.actionS(0, 3, testpage.productionSampleTable, "edit", "Test Configuragtion Module.xlsx",
				"Test_Parameter", "TC-PAR-0062-01", 1);
		
		/* EDIT AFTER DEPEND METHOD*/
		editafterdependmethod();
	}
	...
	public static void editafterdependmethod() throws InterruptedException, IOException
	{
		PageFactory.initElements(driver, methods);
		...
		/* EDIT FOR PARAMETER TYPE FIELD DISPLAYED & ENABLED & SELECTED */  
		SampleCommonMethods.fieldmethoddropdown("STEP_5-- PARAMETER TYPE FIELD PROPERTYS", testpage.parametertype,"01-- PARAMETER TYPE FIELD DISPLAYED", "02-- PARAMETER TYPE FIELD ENABLED" , "//div[@title='"+parametertype+"']" , "03-- DATA SUCCESSFULLY SELECTED");

		/* EDIT FOR PARAMETER DATA TYPE FIELD DISPLAYED & ENABLED & SELECTED */  
		SampleCommonMethods.fieldmethoddropdown("STEP_6-- PARAMETER DATA TYPE FIELD PROPERTYS", testpage.parameterdatatype,"01-- PARAMETER DATA TYPE FIELD DISPLAYED", "02-- PARAMETER DATA TYPE FIELD ENABLED" , "//div[@title='"+parameterdatatype+"']", "03-- DATA SUCCESSFULLY SELECTED");
		
		/* UPDATE BUTTON DISPLAYED & ENABLED & SELECTED */
		SampleCommonMethods.singleclick("STEP_7-- UPDATE BUTTON PROPERTIES", testpage.updatebtn,"01-- UPDATE BUTTON DISPLAYED", "02-- UPDATE BUTTON ENABLED");

	    /* DATA DEPENDED MESSAGE */
		SampleCommonMethods.dataaddedsuccessmsg("STEP_8-- DATA DEPENDED VALIDATION MESSAGE SHOWS",testpage.alreaydependvalidation, expectedmessage);
