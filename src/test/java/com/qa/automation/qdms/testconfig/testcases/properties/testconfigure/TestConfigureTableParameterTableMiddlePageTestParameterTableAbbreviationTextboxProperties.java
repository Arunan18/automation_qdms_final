...
* Description
*------------
Test Configure Table - Parameter Table Middle Page- Test Parameter Table- "Abbreviation " Text box Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0505         06/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableMiddlePageTestParameterTableAbbreviationTextboxProperties
	...
	public static void commonMethodTextBoxProperties() throws InterruptedException, IOException {
		...
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0505-02",
				TestConfigPage.paraMeterTestParaMeterInputMethodSubHead,
				"Test Configure Table - Parameter Table Middle Page- Test Parameter Table- Abbreviation Text box Properties");
