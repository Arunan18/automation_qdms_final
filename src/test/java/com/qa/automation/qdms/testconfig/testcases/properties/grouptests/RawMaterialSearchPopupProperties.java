...
//* Description
//*------------
//* Manage Test Tab Group Test - "Raw Material" Search PopUp Screen Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*    MTC-GT-041         27/06/2023    Sasi     Original Version
//*
//************************************************************************************
...
public class RawMaterialSearchPopupProperties extends DriverIntialization{
	static GroupTestsPage GroupTestpg = new GroupTestsPage();

	@Test
	public static void rawMaterialPopUp() throws InterruptedException, IOException {
	...
	public static void GroupTestClickIcon() throws IOException, InterruptedException {
		...
		try {
			...
			testCase = extent.createTest("Raw Material Search PopUp Screen");
	...
	public static void rawMaterialPopUpProperties() {
		...
		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Group_Test",
				"MTC-GT-041-02", GroupTestsPage.rawMaterialSearchpopup, "Raw Material PopUp Screen Properties");
	}
}
