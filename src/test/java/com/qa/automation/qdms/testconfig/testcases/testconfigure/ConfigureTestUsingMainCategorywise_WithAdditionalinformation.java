...
* Description
*------------
* Configure Test  Using Main Category wise (With Additional information)
*****************************************************
*
* Author           : S.Quenthan
...
* ================       ====         =====        ========
*TC-TCN-0353          31/05/2023   Quenthan     Orginal Version
*
************************************************************************************/
...
public class ConfigureTestUsingMainCategorywise_WithAdditionalinformation extends DriverIntialization {
	...
	@Test
	public static void ConfigureTestUsingMainCategorywise() throws InterruptedException, IOException {
		...
		LoginTest.Login();
		extent.createTest(
				"TC-TCN-0353--Configure Test  Using Main Category wise (With Additional information)--FINISH PRODUCT  TEST-Without Active");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0353-first");
		Thread.sleep(2000);

		// TEST PARAMETER FIELD
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0353-secound");
		Thread.sleep(3000);

		// ADD PARAMETER FIELD
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0353-secound");
		Thread.sleep(2000);

		// CONFIGURE EQUATION FIELD
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0353-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0353-fourth");
		Thread.sleep(3000);
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

		// ACCEPTED CRITERIA FIELD
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0353-fifth");
		TestConfigPage.nextBtn.click();
		Thread.sleep(3000);

//	//ADD CONDITION IN CONDITION STEP
//			Thread.sleep(3000);
//			AcceptCondition.condition("Test Configuragtion Module", "Test_Configure", "TC-TCN-0353-sixth");
//			TestConfigPage.nextBtn.click();
//			Thread.sleep(3000);

		// ADD INFORMATION
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0353-seventh");
		...
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0353-first",
				"TC-TCN-0353-secound", "TC-TCN-0353-third", "TC-TCN-0353-fourth", "TC-TCN-0353-fifth",
				"TC-TCN-0353-sixth", "TC-TCN-0353-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0353-eight", AddConfigureTest.testname, AddConfigureTest.testtype, "second",
