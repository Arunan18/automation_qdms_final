...
------------
 ...
 "Select Parameter for create equation" Table: Parameter Column Heading
*************************************************************************************************************************************************
 ...
 ================       ====         =====        ========
 TC-TCN-0583          14/07/2023    Shangeetha      Original Version
***************************************************************************************************************************************************/
...
public class ResultsSelectParameterForCreatEquationTableParameterColumnHeading extends DriverIntialization{
	...
	public static void configureEquation() throws InterruptedException, IOException {
      ...
      //Check "Parameter" Column Heading Properties
	...
	public static void methodTextProperties() {
		PageFactory.initElements(driver, testPage);
		//Check "Parameter" Column Heading Properties
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0583-02", TestConfigPage.configureEquationTestParameterColumnHeading, "'Parameter' Column Heading Properties");
