...
* Description
*------------
* Test Configure - Config Group Test Top Bar Config Group Test Table Top Create Group Report Format Drop Down Properties
**************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0043           05/07/2023   M.Mathushan    Original Version
*
***************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopCreateGroupReportFormatDropDownProperties extends DriverIntialization{
static configGroupTestsPage lk = new configGroupTestsPage();
	
	@Test
	
	public static void configureConfigGroupTestTopBarConfigGroupTestTableTopCreateGroupReportFormatDropDownProperties() throws InterruptedException, IOException {
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0043-01");
		...
		//Check Properties
		configGroupTestTopBarConfigGroupTestTableTopCreateGroupReportFormatDropDownProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopCreateGroupReportFormatDropDownProperties() throws InterruptedException {

		PageFactory.initElements(driver, lk);
        Thread.sleep(2000);
		ProCommonMethods.dropDownMulti("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0043-02", configGroupTestsPage.configGroupTest_AfterDropDowncreatereportformatdropdown,
				"Step-4--Config Group Test- After Drop Down Table - Create Group Report Format Dropdown Properties","3",2);
