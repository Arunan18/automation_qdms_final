...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test Parameter Table "Parameter" Search button  Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-PAR-0073             26/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class parameterSearchButtonUI extends DriverIntialization{
...
@Test
		...
		try {
			...
			try {
				...
				try {
					...
					Thread.sleep(1000);
					parametertabparameterSearchbuttonUI();
	...
	public void parametertabparameterSearchbuttonUI() {
		TestParameterPage tp=new TestParameterPage();
		PageFactory.initElements(driver, tp);
//      GET PROPERTIES OF STATUS POPUP TEXTBOX BY TEXTBOX PROPERTTIES COMMON METHOD
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Parameter", "TC-PAR-0073-02", TestParameterPage.parameterSearchbutton,
