...
* Description
*------------
* Test Configure  Manage Test Configuration Tab Key Test Icon  Edit Key Test Pop up Screen Sub Category Radio Button Properties
************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-120           10/07/2023   M.Mathushan    Original Version
*
************************************************************************************************************************************************/
...
public class TestConfigureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSubCategoryRadioButtonProperties extends DriverIntialization {
...
static String test =null;
	...
	public static void configureManageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSubCategoryRadioButtonProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-120-01");
		...
		manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSubCategoryRadioButtonProperties();
	...
	public static void manageTestConfigurationTabKeyTestIconEditKeyTestPopupScreenSubCategoryRadioButtonProperties() {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-120-02",ManageTestsPage.testConfigureManageTestConfigurationTabeditKeytestsubcategoryradiobuttonProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test SubCategory Radio Button Properties");
	}
