...
//* Description
//*------------
//* Config Group Test - "Report Type" CheckBox Icon Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-074          05/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ReportTypeCheckBoxIconProperties extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void reportTypeCheckboxIcon() throws InterruptedException, IOException {
	...
	public static void checkboxIconPropertiess() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			//Calling the method
			reportTypecheckboxIconPropertiess();
		} 
	...
	public static void reportTypecheckboxIconPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Column Pop up Properties
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-074-02", GroupTestsPage.editiconpopupreporttypecheckbox, "Report Type Check Box Icon Properties");
	}
}
