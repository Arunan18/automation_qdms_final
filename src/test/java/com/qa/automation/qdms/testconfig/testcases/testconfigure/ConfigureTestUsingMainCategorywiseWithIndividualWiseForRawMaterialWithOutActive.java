...
* Description
*------------
* Configure Test  Using Main Category wise (Material wise accepted value)(Individual wise) Raw Material Without Active
***********************************************************************************
*
...
* ================       ====         =====        ========
*TC-TCN-0369           11/06/2023     ARUNAN     Original Version
...
public class ConfigureTestUsingMainCategorywiseWithIndividualWiseForRawMaterialWithOutActive extends DriverIntialization{
		...
		public static void ConfigureTestUsingMaterialwiseMaterialwiseAcceptedValue() throws InterruptedException, IOException{
	        ...
	        PageFactory.initElements(driver, action);
		        ...
		        extent.createTest("TC-TCN-0369:Configure Test Using Main Category wise to Raw Material Without Active(Material Individual wise accepted value)");
		        // LOGIN TO THE SYSTEM
		        LoginTest.Login();
		...
		//STEP1 :ADD  THE CONFIGURETEST    
		        AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0369-first");
		        Thread.sleep(2000);
		//STEP2 :SELECTING THE PARAMETER IN TEST PARAMETER PAGE
		        TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0369-second");
		        Thread.sleep(3000);
		//STEP3 :ADD THE PARAMETER        
		        TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0369-second");
		        Thread.sleep(3000);
		//STEP4 :ADD THE EQUATIONS
		        configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0369-third");
		        Thread.sleep(3000);
		//MOVE TO NEXT PAGE
		        TestConfigPage.nextBtn.click();
		        Thread.sleep(3000);
		//STEP5 : ADD THE ACCEPTCRETERIA
		        AcceeptedCretiaStep.accepted("Test Configuragtion Module", "Test_Configure", "TC-TCN-0369-fourth");
		        Thread.sleep(3000);
		//MOVE TO DOWN 
		...
		//MOVE TO NEXT PAGE 
		        ...
		        Thread.sleep(3000);
		//STEP6 :ADD TEST KEYS 
		        AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0369-fifth");
		//MOVE TO NEXT PAGE    
		        Thread.sleep(3000);
		        actions.sendKeys(Keys.PAGE_DOWN).build().perform();
		        TestConfigPage.nextBtn.click();
		//STEP7 :ADD ADITIONAL INFORMATION
		        Thread.sleep(3000);
		        Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0369-seventh");
		//DOWN THE PAGE        
		        actions.sendKeys(Keys.PAGE_DOWN).build().perform();
		//MOVE TO NEXT PAGE        
		        TestConfigPage.nextBtn.click();
		...
		// STEP8:  REVIEW TEST CHECK IN REVIEW TAB 
		        ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0369-first",
		                "TC-TCN-0369-second", "TC-TCN-0369-third", "TC-TCN-0369-fourth", "TC-TCN-0369-fifth",
		                "", "TC-TCN-0369-seventh");
		...
		//STEP10 :CONFIRM THE TEST HAS BEEN ADDED OR NOT IN SAMPLES    
		        TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
		                "TC-TCN-0369-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "Second",
