...
* Description
*------------
* Configure Test  Using Main Category wise (one results parameter)(without due day) (RAW MATERIAL TEST-Without Active)
***********************************************************************************
*
...
* ================       ====         =====        ========
* TC-TCN-0279           24/05/2023   Arunan     Original Version
*                       08/06/2023   RAHUL.S    Rechecked
************************************************************************************/
...
public class ConfigureTestUsingMainCategorywiseOneResultsParametarForRawMaterialInActive extends DriverIntialization {
	...
	public static void addgroupconfigure() throws InterruptedException, IOException {
		...
		extent.createTest(
				"TC-TCN-0279:Configure Test Using Main Category wise(one results parameter)(without due day) (RAW MATERIAL TEST-Without Active)");
//		LOGIN TO THE SYSTEM
		LoginTest.Login();
...
//        Configure Test Configure Test Step
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0279-first");
		Thread.sleep(500);

//        Select Parameter in Parameter Step
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0279-second");
		Thread.sleep(500);

//        Add parameter in Parameter Step
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0279-second");
		Thread.sleep(500);

//        Add Equation in Equation Step
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0279-third");
		Thread.sleep(3000);
...
//        Add Accepted Value in Accepted criteria Step
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0279-fourth");
		Thread.sleep(3000);
...
//        Add Key Test in Key Test Step
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0279-fifth");
...
//        Add Additional Information in Additional Information Step
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0279-seventh");
...
//		Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0279-first",
				"TC-TCN-0279-second", "TC-TCN-0279-third", "TC-TCN-0279-fourth", "TC-TCN-0279-fifth",
				"TC-TCN-0279-sixth", "TC-TCN-0279-seventh");
...
//		Done Button Click
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0279-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "second",
