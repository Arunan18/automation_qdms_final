...
* Description
*------------
* Configure Test  Using Material wise (more than one results parameter)   (RAW MATERIAL TEST-Without Active)
***********************************************************************************
*
...
* ================       ====         =====        ========
* TC-TCN-0284           25/05/2023   Arunan     Original Version
*                       07/05/2023   RAHUL.S    Redone
************************************************************************************/
...
public class ConfigureTestUsingMaterialCategorywiseMOREthanOneResultsParametarForRawMaterialInActiv
	...
	public static void addgroupconfigure() throws InterruptedException, IOException {
		...
		extent.createTest("TC-TCN-0284:Configure Test  Using Material wise (more than one results parameter)(RAW MATERIAL TEST-Without Active)");
...
//        Configure Test Configure Test Step
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0284-first");
		Thread.sleep(500);

//        Select Parameter in Parameter Step
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0284-second");
		Thread.sleep(500);

//        Add parameter in Parameter Step
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0284-second");
		Thread.sleep(500);

//        Add Equation in Equation Step
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0284-third");
		Thread.sleep(3000);
...
//        Add Accepted Value in Accepted criteria Step
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0284-fourth");
		Thread.sleep(3000);
...
//        Add Key Test in Key Test Step
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0284-fifth");
...
//		Add condition in Condition Step
		AcceptCondition.condition("Test Configuragtion Module", "Test_Configure", "TC-TCN-0284-sixth");
...
//        Add Additional Information in Additional Information Step  
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0284-seventh");

//      Next Button Click in Additional Information
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();
		TestConfigPage.nextBtn.click();

//		Revie test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0284-first",
				"TC-TCN-0284-second", "TC-TCN-0284-third", "TC-TCN-0284-fourth", "TC-TCN-0284-fifth",
				"TC-TCN-0284-sixth", "TC-TCN-0284-seventh");
...
//		Done Button Click
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0284-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "second",
