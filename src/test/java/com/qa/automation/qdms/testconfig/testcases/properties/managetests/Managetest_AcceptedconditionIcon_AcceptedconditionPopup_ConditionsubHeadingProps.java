...
//* Description
//*------------
//* Test Configure - Manage Test Configuration Tab- Accepted Condition- Accepted Condition Pop up Screen- "Condition" UI Sub Heading  Properties
//***************************************************************************************
//*
//* Author           : N.Karunya
...
//* ================       ====         =====        ========
//* MTC-MT-330          05/07/2023    N.Karunya   Original Version                
//************************************************************************************
...
public class Managetest_AcceptedconditionIcon_AcceptedconditionPopup_ConditionsubHeadingProps
	...
	@Test
	public static void conditionsubHeading() throws InterruptedException, IOException {

		// CALLING THE COMMON METHOD FOR NAVIGATE FROM-LOGIN TO SCROLLING IN THE MANAGE
		// TEST PAGE
		NavigateManageTestFromLogin.navigateManageTestFromLogin("Manage Tests", 11);

		// Check Accepted Condition Popup Condition Heading UI Properties
		conditionsubHeadingExcel();
	...
	public static void conditionsubHeadingExcel() throws IOException {
	...
	public static void conditionsubHeadingProperties() {
		
		PageFactory.initElements(driver, mtp);

		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-330-02", ManageTestsPage.conditionheading,
				"Manage Test - Accepted Condition Popup Screen Condition Heading Properties");
