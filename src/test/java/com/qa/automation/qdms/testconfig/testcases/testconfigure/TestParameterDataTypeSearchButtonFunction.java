...
//* ================       ====         =====        ========
//* TC-TCN-0102         02/05/2023   Saranka     Original Version
//*
//************************************************************************************
...
public class TestParameterDataTypeSearchButtonFunction extends DriverIntialization {
	static TestConfigPage DataTypeSearchIcon = new TestConfigPage();
...
//==================================== M ET H O D  ======================================== 
	...
	public void methodCalling() throws InterruptedException, IOException {
		...
		TestParameterDataTypeSearchButtonFunction.naviagteToTestConfigurationParameter();
...
//______________________________________________________________________
		...
		TestParameterDataTypeSearchButtonFunction.ParameterSearchIconFunction();
...
//_________________________________________________________________ 
	public static void naviagteToTestConfigurationParameter() throws InterruptedException {
		PageFactory.initElements(driver, DataTypeSearchIcon);
...
//__________________________________________________________________
	...
	public static void ParameterSearchIconFunction() throws InterruptedException {
		...
		SampleActionMethods.clicking(TestConfigPage.SearchIconDataType, 2, "PARAMETER SEARCH ICON");
...
//________________________________________________________________________	
		...
		WebElement searchInput = searchModal.findElement(By.xpath("(//div[@name='parameterDataType'])[1]"));
		...
		WebElement searchButton = searchModal
				.findElement(By.xpath("//button[@class='ant-btn ant-btn-primary ant-btn-sm']"));
		...
		Thread.sleep(2000);
		TestConfigPage.PlaceHolderSearchDataType.click();
		WebElement ClickDropDown = driver.findElement(By.xpath("//div[contains(@title,'Number')]"));
		ClickDropDown.click();
