...
//* Description
//*------------
//* Configured Group Test - Configured Group Tests Table Pagination Next Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-103          10/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfiguredGroupTestsPaginationNextBtn extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void configuredPaginationNextBtn() throws InterruptedException, IOException {
		...
		//Calling the method
		configuredPaginationNextBtnProperties();
	...
	public static void configuredPaginationNextBtnProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			//Calling the method
			configuredPaginationNextBtnPropertiess() ;
		} 
	...
	public static void configuredPaginationNextBtnPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Heading Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-103-02", GroupTestsPage.configuredgrouppaginationnextbtn, "Configured Group Tests Table Pagination Next Button Properties");
	}
}
