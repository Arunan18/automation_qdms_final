...
* Description
*------------
Test Configure Table - Parameter Table Last Part- Review Test Parameter- Action -Edit icon  Pop up Screen -(Type - Input) "Value" Disable Text box  UI Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0553          11/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class EditiconPopupScreenTypeInputValuEDisableTextboxUIProperties extends DriverIntialization {
	...
	public static void commonMethodTextBoxProperties() throws InterruptedException, IOException {
		...
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0553-02",
				TestConfigPage.reviewTestParaMeterEditIconPopRInputTextBox,
				"Edit icon  Pop up Screen -(Type -input)Value Enable Text box  UI Properties");
