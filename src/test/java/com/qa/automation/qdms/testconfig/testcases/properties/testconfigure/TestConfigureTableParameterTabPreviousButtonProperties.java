...
* Description
*------------
Test Configure Table - Parameter Tab-  "Previous"  Button Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0571          13/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTabPreviousButtonProperties extends DriverIntialization {
	...
	public static void commonMethodButtonProperties() throws InterruptedException, IOException {
		...
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0571-02", TestConfigPage.reviewTestParaMeterPreviousButton,
				"Test Configure Table - Parameter Tab-  Previous  Button Properties");
