 ...
 * "Close-Icon" Button Functionality
 ***********************************************************************************************************************************
 *
 * Author           : Shangeetha
 ...
 * ================       ====         =====          ========
 * MTC-MT-261          17/07/2023   M.Shangeetha   Original Version           	                                            
 *********************************************************************************************************************************/
...
public class ManageTestConfigActionEditCloseIconButtonFunctionality extends DriverIntialization{
	...
	public static void manageTestConfigActionEditPopup() throws InterruptedException, IOException {
		...
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 9, "Description", "Test Configuration Properties",
				"Manage_Tests", "MTC-MT-261");
		Thread.sleep(2000);

		// Calling The Method To Check The Edit Icon Pop-Up, "Close" Button Functionality
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Check Edit Icon Pop-Up, "Close-Icon" Button Functionality
			editIconPopUpEditPopCloseBtnFunctionality();			
	...
	public static void editIconPopUpEditPopCloseBtnFunctionality() {
		PageFactory.initElements(driver, testPage);
		//Get Edit Icon Pop-Up, "Close-Icon" Button Functionality
		functionality.ButtonAndIconunctionalityMtd("'Close' Button Functionality", ManageTestsPage.eqIconPopEditPopUpCloseButton, "Button");
	}
}
