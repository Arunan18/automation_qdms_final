...
* Description
*------------
* Test Configure  Manage Test Configuration Tab Main Category Search Icon UI Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-137           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class   ManageTestConfigurationTabMainCategorySearchIconUIProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
	@Test

	public static void testConfigurationTabMainCategorySearchIconUIProperties  ()
		...
		configurationTabMainCategorySearchIconUIProperties();
	...
	public static void configurationTabMainCategorySearchIconUIProperties  () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-137-02",ManageTestsPage.testConfigureManageTestConfigurationTabedmaincategorysearchiconProperties,
				"Step-4--testConfigure ManageTest Configuration Tab maincategory Search Icon Properties");
	}
}
