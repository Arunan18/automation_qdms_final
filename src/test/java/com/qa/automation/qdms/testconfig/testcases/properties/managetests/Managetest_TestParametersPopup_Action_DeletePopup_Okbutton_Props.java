...
//* Description
//*------------
//* Test Configure - Manage Test Configuration Tab- Test Parameters Pop up Screen- Action - Delete Pop up Screen  "Ok " button Properties 
//***************************************************************************************
//*
//* Author           : N.Karunya
...
//* ================       ====         =====        ========
//* MTC-MT-179         17/07/2023    N.Karunya   Original Version                
//************************************************************************************
...
public class Managetest_TestParametersPopup_Action_DeletePopup_Okbutton_Props extends DriverIntialization {
	...
	public static void actionDeletePopupOkbutton() throws InterruptedException, IOException {
		...
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 7, "Description", "Test Configuration Properties",
				"Manage_Tests", "MTC-MT-179");

		Thread.sleep(1000);

		// Check Test Parameters  Popup Screen Action Delete Popup Ok button
		// Properties
	...
	public static void deleteIcon(String Value1) {
		...
		try {
			...
			actionDeletePopupOkbuttonProps();
	...
	public static void actionDeletePopupOkbuttonProps() {

		PageFactory.initElements(driver, mtp);

		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-179-02", ManageTestsPage.testParametersdeletepopupokBtn,
				"Test Parameters - Action -Delete Icon -Popup Ok button Properties");
