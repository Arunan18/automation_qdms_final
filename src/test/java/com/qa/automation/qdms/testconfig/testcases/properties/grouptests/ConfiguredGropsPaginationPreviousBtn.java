...
//* Description
//*------------
//* Configured Group Test - Configured Group Tests Table Pagination Previous Button Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-104          10/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ConfiguredGropsPaginationPreviousBtn extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void configuredPaginationPreviousBtn() throws InterruptedException, IOException {
		...
		//Calling the method
		configuredPaginationPreviousBtnProperties();
	...
	public static void configuredPaginationPreviousBtnProperties() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			//Calling the method
			configuredPaginationPreviousBtnPropertiess() ;
		} 
	...
	public static void configuredPaginationPreviousBtnPropertiess() {
		PageFactory.initElements(driver, GroupTestpg);

		//Check Tests Heading Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-104-02", GroupTestsPage.configuredgrouppaginationpreviousbtn, "Configured Group Tests Table Pagination Previous Button Properties");
	}
}
