...
* ================       ====         =====        ========
TC-TCN-0490         05/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableAddParameterPopupScreenTestParameter3rdTableFiledUIHeadingProperties
	...
	public static void addParaMeterAddGroupButton() throws InterruptedException, IOException {
		...
		try {
			...
			// If clicks
			commonMethodForGetHeadingProperties();
	...
	public static void commonMethodForGetHeadingProperties() throws InterruptedException, IOException {

		PageFactory.initElements(driver, testConfig);

		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0490-02", TestConfigPage.paraMeterAddParaMeterTestParaDataHead,
				"Test Configure Table - Parameter Table-Add Parameter Pop up Screen- Test Parameter (3rd Table) Filed UI Heading  Properties");
