...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test Table Top Applicable Tests Test Name UI Heading Properties
**************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0045           05/07/2023   M.Mathushan    Original Version
*
***************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopApplicableTestsTestNameUIHeadingProperties extends DriverIntialization {

static configGroupTestsPage lk = new configGroupTestsPage();
	
	@Test
	
	public static void configureConfigGroupTestTopBarConfigGroupTestTableTopApplicableTestsTestNameUIHeadingProperties () throws InterruptedException, IOException {
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0045-01");
		...
		//Check Properties
		configGroupTestTopBarConfigGroupTestTableTopApplicableTestsTestNameUIHeadingProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopApplicableTestsTestNameUIHeadingProperties() {

		PageFactory.initElements(driver, lk);

		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0045-02", configGroupTestsPage.configGroupTest_AfterDropDownapplicabletesttestnamesheading,
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Test Name Heading Properties");
