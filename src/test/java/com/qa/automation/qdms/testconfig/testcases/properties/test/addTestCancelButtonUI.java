...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test - Material Test Table - Add Test-Pop up Screen "cancel" button Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
public class addTestCancelButtonUI extends DriverIntialization{
	
@Test
	public void addtestCancelButtonUI() throws InterruptedException, IOException {
		//login test
		LoginTest.Login();
	...
	public void addtestcancelButtonUI() {
		TestConfigPage tcp=new TestConfigPage();
		PageFactory.initElements(driver, tcp);
//      GET PROPERTIES OF BUTTON PROPERTTIES COMMON METHOD
//		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test", "TC-TC-0058-02", TestConfigPage.addtestcancelbtn,
//              "Checking TEST TABLE TEST cancel button UI Properties :");
	}
