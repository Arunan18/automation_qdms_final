...
//* Description
//*------------
//* Configure Test Using Sub Category Wise One Results Parameter (FINISH PRODUCT TEST- WITH ACTIVE)
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-TCN-0311        	22/05/2023   Gobithan     Orginal Version
//*
//************************************************************************************
...
public class ConfigureTestUsingSubCategoryWise_OneResultsParameter_FinishProduct_WithActive
	...
	public static void configuretest() throws InterruptedException, IOException {
		...
		// TESTCASE REPORT
		extent.createTest(
				"TC-TCN-0311-Configure Test Using Sub Category Wise One Results Parameter (FINISH PRODUCT TEST- WITH ACTIVE)");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0311-first");

		// TEST PARAMETER FIELD
		Thread.sleep(2000);
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0311-second");

		// ADD PARAMETER FIELD
		Thread.sleep(3000);
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0311-second");

		// CONFIGURE EQUATION FIELD
		Thread.sleep(2000);
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0311-third");
		...
		Thread.sleep(3000);
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0311-fourth");
		...
		// ACCEPTED CRITERIA FIELD
		Thread.sleep(3000);
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0311-fifth");
		...
		Thread.sleep(3000);
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0311-seventh");
		TestConfigPage.nextBtn.click();

		// Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0311-first",
				"TC-TCN-0311-second", "TC-TCN-0311-third", "TC-TCN-0311-fourth", "TC-TCN-0311-fifth", "",
				"TC-TCN-0311-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0311-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "first",
