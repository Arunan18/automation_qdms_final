...
* DESCRIPTION
*---------------------------------------------------------------------------------------------------
* Test - Material Test Table - Add Test-Pop up Screen "Close" button Properties
****************************************************************************************************
*
* @author      : kajan
* 
...
* ===================================================================================================
*       TC-TC-0060             23/06/2023            kajan         Original Version
*                                       
*****************************************************************************************************/
...
public class addTestCloseButtonUI extends DriverIntialization{


@Test
	public void addtestcloseButtonUI() throws InterruptedException, IOException {
		//login test
		LoginTest.Login();
	...
	public void addtestCloseButtonUI() {
		TestConfigPage tcp=new TestConfigPage();
		PageFactory.initElements(driver, tcp);
//      GET PROPERTIES OF BUTTON PROPERTTIES COMMON METHOD
//		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test", "TC-TC-0060-02", TestConfigPage.addtestclosebtn,
//              "Checking TEST TABLE TEST CLOSE button UI Properties :");
	}
