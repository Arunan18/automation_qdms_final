...
//* ================       ====         =====        ========
//*TC-TCN-0006    11/05/2023  Niluxy    Original Version
//*
//************************************************************************************
...
public class ConfigTestTabFunction extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException {
		...
		AddGroupKey.actionS(0, 14, mangetest.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Test_Configure", "TC-TCN-0006-01", 1);

		//CLICK ON THE CONFIGURE TEST BUTTON
		driver.findElement(By.xpath("(//div[@class='ant-steps-item-icon'])[1]")).click();
		...
		boolean value1 = TestConfigNavigation.function("STEP_05--CONFIGURE TEST", testnav.configuretest,
				"rgba(24, 144, 255, 1)", "01--CONFIGURE TEST ICON", "02--CONFIGURE TEST ICON");
		boolean value2 = TestConfigNavigation.function("STEP_06--TEST PARAMETER", testnav.TestParameter,
				"rgba(24, 144, 255, 1)", "01--TEST PARAMETER ICON", "02--TEST PARAMETER ICON");
		...
		if ((value1 && value2 && value3 && value4 && value5 && value6 && value7 && value8) == true) {
			...
			testCase.log(Status.PASS, "TAB NOT SELECTED IN CORRECT STEP");
			testCase.log(Status.PASS, "TEST FAIL");
		}

		
		// CHECK EXPECTED WINDOW DISPLY OR NOT
		TestConfigNavigation.expectedwindow("STEP_14--CONFIGURE TEST TAB BUTTON HAS BEEN TESTED",
				testnav.configtesttabheading, "01--EXPECTED WINDOW HEADING DISPLAYED", "Configure Test");
