...
//* Description
//*------------
//* Manage Test - Action Column Delete Pop up Screen "?" icon Properties 
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-110         05/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class ActionColumnDeleteIconPopupQuestionIcon extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	@Test
	public static void actionPopupQuestionIcon() throws InterruptedException, IOException {
	...
	public static void questionIconPropertiess() {
		...
		//Check Action Pop up Screen Question Icon Properties
		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Group_Test","MTC-GT-110-02", GroupTestsPage.actionpopupquestionicon, "Action Popup Screen Question Icon Properties");
	}
}
