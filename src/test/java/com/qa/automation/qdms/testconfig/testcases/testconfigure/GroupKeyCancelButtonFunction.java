...
public class GroupKeyCancelButtonFunction extends DriverIntialization {
...
//====================================================  M E T H O D ========================================================
		...
		public void method() throws InterruptedException, IOException {
			...
			GroupKeyCancelButtonFunction.CancelButtonFunctionality();
...
//____________________________________
				...
				WebElement CloseBtn = driver.findElement(By.xpath("(//button[@type='button'])[13]"));
				Thread.sleep(2000);
				SampleActionMethods.clicking(CloseBtn, 2, "STEP:2 CANCEL BUTTON");
