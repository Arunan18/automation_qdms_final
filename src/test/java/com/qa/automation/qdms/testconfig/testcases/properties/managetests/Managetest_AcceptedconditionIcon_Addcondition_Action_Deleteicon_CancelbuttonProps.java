...
//* Description
//*------------
//* Test Configure - Manage Test Configuration Tab- Accepted Condition -Add Condition - Action - Delete Pop up Screen  "Cancel" button Properties 
//***************************************************************************************
//*
//* Author           : N.Karunya
...
//* ================       ====         =====        ========
//* MTC-MT-349         05/07/2023    N.Karunya   Original Version                
//************************************************************************************
...
public class Managetest_AcceptedconditionIcon_Addcondition_Action_Deleteicon_CancelbuttonProps
	...
	public static void deleteIconClick(String Value1) {
		...
		try {
			...
			deletepopupCancelbuttonProperties();
	...
	public static void deletepopupCancelbuttonProperties() {

		PageFactory.initElements(driver, mtp);

		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-349-02", ManageTestsPage.deletepopupcancelbutton,
				"Manage Test - Accepted Condition- Delete Popup Cancel Button UI Properties");
