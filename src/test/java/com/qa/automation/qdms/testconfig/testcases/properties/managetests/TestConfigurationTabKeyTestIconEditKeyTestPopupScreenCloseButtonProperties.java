...
* Description
*------------
* Test Configure Manage Test Configuration Tab Key Test Icon Edit Key Test Pop up Screen Close Button Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-134           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class TestConfigurationTabKeyTestIconEditKeyTestPopupScreenCloseButtonProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
    static String test =null;
	@Test

	public static void configurationTabKeyTestIconEditKeyTestPopupScreenCloseButtonProperties ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-134-01");
		...
		tabKeyTestIconEditKeyTestPopupScreenCloseButtonProperties();
	...
	public static void tabKeyTestIconEditKeyTestPopupScreenCloseButtonProperties  () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		Thread.sleep(1000);
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-134-02",ManageTestsPage.testIconEditKeyTestPopupScreenCloseButtonProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test Pop up Screen Select Subcategory Screen Close Button Properties");
	}
