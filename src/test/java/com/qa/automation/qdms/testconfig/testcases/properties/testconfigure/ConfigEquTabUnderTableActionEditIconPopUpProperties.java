 ...
 * ================        ====         =====          ========
 * TC-TCN-0602 			 07/07/2023   Shangeetha    Original Version  
 **************************************************************************************************************/
...
public class ConfigEquTabUnderTableActionEditIconPopUpProperties extends DriverIntialization{
	...
	public static void editIconPopUpProperties() {
		...
		ProCommonMethods.modal("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0602-02", TestConfigPage.configEquActionEditIconPop,"Edit Icon Pop-Up Properties");
