...
//* Description
//*------------
//**TC-TCN-0348 - (Configure Test   Using Sub Category wise (Material wise accepted value)(Common wise)
...
//* ================       ====         =====        ========
//*TC-TCN-0348          26/05/2023      RAHUL.S       Original Version
...
public class ConfigureTestUsingSubCategorywise_MaterialWiseAcceptedValue_Commonwise extends DriverIntialization {
...
//        Configure Test Configure Test Step
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0348-first");
		Thread.sleep(500);

//        Select Parameter in Parameter Step
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0348-second");
		Thread.sleep(500);

//        Add parameter in Parameter Step
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0348-second");
		Thread.sleep(500);

//        Add Equation in Equation Step
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0348-third");
		Thread.sleep(3000);
...
//        Next Button Click in Equation
		...
		AcceeptedCretiaStep.accepted("Test Configuragtion Module", "Test_Configure", "TC-TCN-0348-fourth");
		Thread.sleep(3000);
...
//        Add Key Test in Key Test Step
		AddKeyTestfunction.AddTestEquation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0348-fifth");
...
//        Add Additional Information in Additional Information Step
		Addaditionalinformation.adddata("Test Configuragtion Module", "Test_Configure", "TC-TCN-0348-seventh");
...
//		Review test Check in Review Tab
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0348-first",
				"TC-TCN-0348-second", "TC-TCN-0348-third", "TC-TCN-0348-fourth", "TC-TCN-0348-fifth",
				"TC-TCN-0348-sixth", "TC-TCN-0348-seventh");
...
//		Done Button Click
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0348-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "second",
