 ...
 * ================       ====         =====          ========
 * MTC-MT-258           17/07/2023   M.Shangeetha   Original Version           	                                            
 *********************************************************************************************************************************/
...
public class ManageTestConfigActionEditSaveButton extends DriverIntialization{
	...
	public static void manageTestConfigActionEditPopup() throws InterruptedException, IOException {
		...
		NavigateManageTestFromLogin.clickIcon("Manage Tests", 9, "Description", "Test Configuration Properties",
				"Manage_Tests", "MTC-MT-258");
		Thread.sleep(2000);

		// Calling The Method To Check The Edit Icon Pop-Up, "Save" Button Properties
	...
	public static void methodLocateAndClick(String searchCode) {
		...
		try {	
			...
			//Check Edit Icon Pop-Up, "Save" Button Properties
			editIconPopUpEditPopSaveBtn();			
	...
	public static void editIconPopUpEditPopSaveBtn() {
		PageFactory.initElements(driver, testPage);
		//Get Edit Icon Pop-Up, "Save" Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests","MTC-MT-258-02", ManageTestsPage.eqIconPopEditPopUpSaveButton,"Edit Icon Pop-Up,'Save' Button Properties");
