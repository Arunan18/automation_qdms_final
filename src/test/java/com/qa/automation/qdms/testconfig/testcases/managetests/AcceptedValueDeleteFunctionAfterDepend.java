...
//* Description
//*------------
//*ACCEPTED VALUE DELETE FUNCTION AFTER DEPEND-MANAGE TEST CONFIGURE
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//MTC-MT-062              17/05/2023  Niluxy    Orginal Version
//************************************************************************************
...
public class AcceptedValueDeleteFunctionAfterDepend extends DriverIntialization {
	...
	public static void search() throws IOException, InterruptedException {
		...
		extent.createTest("MTC-MT-062:ACCEPTED VALUE DELETE FUNCTION AFTER DEPEND-MANAGE TEST CONFIGURE");
		// LOGIN TO THE SYSTEM
		LoginTest.Login();
		...
		AddGroupKey.actionS(0, 8, ManageTestsPage.managetexttablecontainer, "Description",
				"Test Configuragtion Module.xlsx", "Manage_Tests", "MTC-MT-062-01", 1);
		...
		ActionCommonMethod.actionS(0, 4, ManageTestsPage.testparametertablecontainer, "delete",
				"Test Configuragtion Module.xlsx", "Manage_Tests", "MTC-MT-062-01", 2);
		...
		String successmessage = TestConfigNavigation.excel("Test Configuragtion Module", "Manage_Tests", "MTC-MT-062",
				3);

		// DELETE MESSAGE 
		SampleCommonMethods.dataaddedsuccessmsg("STEP 6:DELETE CONFERMATION MESSAGE AFTER DEPEND",
