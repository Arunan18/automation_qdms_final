...
* Description
*------------
* Test Configure Config Group Test Top Bar Config Group Test Table Top Configured Groups Action Delete Icon Pop up Screen Properties
******************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*TC-CGT-0060           06/07/2023   M.Mathushan    Original Version
*
*******************************************************************************************************************************************/
...
public class TestConfigureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionDeleteIconPopupScreenProperties  extends DriverIntialization {

	static configGroupTestsPage lk = new configGroupTestsPage();
	   
	@Test

	public static void configureConfigGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionDeleteIconPopupScreenProperties  ()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Config_Group_Test", "TC-CGT-0060-01");
		...
		// Check Properties
		configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionDeleteIconPopupScreenProperties();
	...
	public static void configGroupTestTopBarConfigGroupTestTableTopConfiguredGroupsActionDeleteIconPopupScreenProperties   () throws InterruptedException {
Thread.sleep(1000);
		PropertiesCommonMethods.searchBoxPropertiesq("Test Configuration Properties.xlsx", "Config_Group_Test",
				"TC-CGT-0060-02", configGroupTestsPage.configGroupTest_AfterDropDownconfiguredeletepopupscreen,
				"Step-4--Config Group Test- After Drop Down Table - Applicable Test Configure Group Delete popup Properties");
