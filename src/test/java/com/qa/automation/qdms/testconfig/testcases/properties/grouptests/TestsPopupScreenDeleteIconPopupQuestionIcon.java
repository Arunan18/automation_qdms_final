...
//* Description
//*------------
//* Groups Tests - "Tests" Column Icon Pop up Screen- Delete Icon Pop up - Question Icon Properties
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-058         10/07/2023   K.Saranga     Original Version
//*
//************************************************************************************/
...
public class TestsPopupScreenDeleteIconPopupQuestionIcon extends DriverIntialization {
	static GroupTestsPage GroupTestpg = new GroupTestsPage();
	static String code = null;
	static String codetype = null;
	@Test
	public static void deleteIconPopupQuestionIcon() throws InterruptedException, IOException {
		...
		//Calling the method
		deleteIconPopupQuestionIconPropertiess();
	...
	public static void deleteIconPopupQuestionIconPropertiess() throws InterruptedException, IOException {
		PageFactory.initElements(driver, GroupTestpg);
		...
		try {
			...
			try {
				...
				deleteIconPopupQuestionIconProperties();
	...
	public static void deleteIconPopupQuestionIconProperties() {	
		PageFactory.initElements(driver, GroupTestpg);

		PropertiesCommonMethods.getIconPPt("Test Configuration Properties.xlsx", "Group_Test", "MTC-GT-058-02", GroupTestsPage.actionColumnDeleteIconPopupquestionIcon, "Action Column Delete Icon Pop up Screen Question Icon Properties");
	}
}
