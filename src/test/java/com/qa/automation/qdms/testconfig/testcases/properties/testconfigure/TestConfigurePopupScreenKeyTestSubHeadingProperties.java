...
* Description
*------------
*Test Configure - Configure Test Table-  Top Bar Review Test - Key Test - Material Pop up Screen - "Key Test" Sub  Heading  Properties
...
* ================       ====         =====        ========
*TC-TCN-0839           22/06/2023   Quenthan     Orginal Version
*
************************************************************************************/
...
public class TestConfigurePopupScreenKeyTestSubHeadingProperties extends DriverIntialization {
...
@Test
	public void modalproperties() throws InterruptedException, IOException {
		...
		TestConfiRev_MaterialSubHeadingProperties.navicateAndProperties("Test_Configure", "TC-TCN-0839-01", 2);

		// Click Material View Icon
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Test_Configure", "TC-TCN-0839-01");
...
//		Check Properties
	...
	public static void propertiesMatrialModal() {
		...
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Test_Configure",
				"TC-TCN-0839-02", TestConfigPage.materialPuModalkeyTestHeding, "Step-5--Modal-Key Test Heading Properties");
