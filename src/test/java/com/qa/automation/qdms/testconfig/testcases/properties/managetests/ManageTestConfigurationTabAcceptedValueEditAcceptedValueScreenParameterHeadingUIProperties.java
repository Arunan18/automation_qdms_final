...
* Description
*------------
*Test Configure Manage Test Configuration Tab Accepted Value Pop up Screen Edit Accepted Value Screen Parameter Heading UI Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*  MTC-MT-216           17/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class ManageTestConfigurationTabAcceptedValueEditAcceptedValueScreenParameterHeadingUIProperties
	...
	public static void acceptedValueEditAcceptedValueScreenParameterHeadingUIProperties() throws InterruptedException, IOException {
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-216-01");
		
		//Click the Edit Icon
		acceptedvalueeditbutton();

		// Check the Accepted Value Pop up Screen Accepted Value Action Edit Accepted Value Heading UI Properties
		editAcceptedValueScreenParameterHeadingUIProperties();
	...
	// Check the Accepted Value Pop up Screen Accepted Value Action Edit Accepted Value Heading UI Properties
	public static void editAcceptedValueScreenParameterHeadingUIProperties() {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getTextPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests", "MTC-MT-216-02",
				ManageTestsPage.acceptedValueActionEditacceptedparameterHeadingUIProperties,
