...
//* Description
//*------------
//*FPTestWithoutActiveConfigureTestUsingSubCategorywisewithoutdueday
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-TCN-0339            26/05/2023    Priyanka       Orginal Version
//*
//*******************************************************************************
...
public class FPTestWithoutActiveConfigureTestUsingSubCategorywisewithoutdueday extends DriverIntialization {
	...
	public static void FPTestActiveWithKeyTest() throws IOException, InterruptedException {
		...
		extent.createTest("TC-TCN-0339:FPTestWithoutActiveConfigureTestUsingMaterialwisewithoutdueday");
		...
		AddConfigureTest.addConfigureTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0339-first");
		Thread.sleep(2000);
		// STEP2 :SELECTING THE PARAMETER IN TEST PARAMETER PAGE
		TestParameterStep.selectParameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0339-secound");
		Thread.sleep(3000);
		// STEP3 :ADD THE PARAMETER
		TestParameterStep.addPaameter("Test Configuragtion Module", "Test_Configure", "TC-TCN-0339-secound");
		Thread.sleep(2000);
		// STEP4 :ADD THE EQUATIONS
		configureEquationStep.equation("Test Configuragtion Module", "Test_Configure", "TC-TCN-0339-third");
		Thread.sleep(3000);
		...
		Acceptedcriteria.Acceptedcriteriatest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0339-fourth");
		Thread.sleep(3000);
		// CLICK ON NEXT BUTTON
		...
		ReviewTestConfig.ReviewTest("Test Configuragtion Module", "Test_Configure", "TC-TCN-0339-first",
				"TC-TCN-0339-secound", "TC-TCN-0339-third", "TC-TCN-0339-fourth", "TC-TCN-0339-fifth",
				"TC-TCN-0339-sixth", "TC-TCN-0339-seventh");
		...
		TestConfigureConfirmStep.confirmTestConfigure("Test Configuragtion Module", "Test_Configure",
				"TC-TCN-0339-eighth", AddConfigureTest.testname, AddConfigureTest.testtype, "first",
