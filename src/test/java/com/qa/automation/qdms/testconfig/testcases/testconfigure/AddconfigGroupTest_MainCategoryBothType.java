...
//* Description
//*------------
//* Add Config Group Test Main Category Both Type
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* TC-CGT-0021        	19/05/2023   Gobithan     Orginal Version
//*
//************************************************************************************
...
public class AddconfigGroupTest_MainCategoryBothType extends DriverIntialization {
    ...
    public static void addgroupconfigure() throws InterruptedException, IOException {
        ...
        AddConfigGroupTest.addConfigGroupTest("Test Configuragtion Module","Config_Group_Test","TC-CGT-0021");  
