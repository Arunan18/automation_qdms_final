 ...
 * ================        ====         =====          ========
 * TC-TCN-0606			 07/07/2023   Shangeetha    Original Version  
 ***************************************************************************************************************/
...
public class ConfigEquActEditIconPopUpCancelBtnProperties extends DriverIntialization{
	...
	public static void editIconPopUpCancelButtonProperties() {
		...
		//Check 'Edit' Icon Pop-Up, 'Cancel' Button Properties
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure","TC-TCN-0606-02", TestConfigPage.configEquActionEditIconPopCancelBtn,"Edit Icon Pop-Up, 'Cancel' Button Properties");
