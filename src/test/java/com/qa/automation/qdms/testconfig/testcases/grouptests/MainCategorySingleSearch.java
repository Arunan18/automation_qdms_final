...
//* Description
//*------------
//* MAIN CATEGORY SINGLE SEARCH & RESET FOR GROUP TEST
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//* MTC-GT-008			 28/04/2023   Gobithan     Orginal Version
//* MTC-GT-009			 28/04/2023   Gobithan     RESET
//************************************************************************************
...
public class MainCategorySingleSearch extends DriverIntialization {
	...
	public static void action() throws InterruptedException, IOException
	{
		...
		int beforedatacount = PropertiesCommonMethods.CountOfData2(grouptest.tablecontainer);
		 System.out.println("gobi"+beforedatacount);
		
		/* REFERESH THE PAGE */
		driver.navigate().refresh(); 
		
		/* COMMEN METHOD FOR SINGLE SEARCH */
		SampleSingleSearchMethods.newSingleSearch(grouptest.maincatsearchicon, grouptest.maincatsearchtextbox,
				grouptest.maincatsearchbutton, "MAIN CATEGORY SINGLE SEARCH",
				"Test Configuragtion Module", "Group_Tests", "MTC-GT-008", 1, 2, grouptest.tableColoumnoMaincategory,
				"//tbody[@class='ant-table-tbody']/tr[", "]/td[2]", testdata);
...
/*Excel Sheet Value Passing*/	
		...
		XSSFSheet sheet = workbook.getSheet("Group_Tests");
		 ...
		 /* DATA COUNT AFTER SEARCH */
			SampleCommonMethods.dataaddedmsg("BEFORE AND AFTER DATA COUNT",  aftersearch, datacount);
