...
* Description
*------------
* Test Configure Manage Test Configuration Tab Main Category Reset Button  UI Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-140           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class ManageTestConfigurationTabMainCategoryResetButtonUIProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
	@Test

	public static void testConfigurationTabMainCategoryResetButtonUIProperties  ()
		...
		configurationTabMainCategoryResetButtonUIProperties();
	...
	public static void configurationTabMainCategoryResetButtonUIProperties   () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-140-02",ManageTestsPage.testConfigureManageTestConfigurationTabedmaincategoryresetbuttonProperties,
				"Step-4--testConfigure ManageTest Configuration Tab maincategory Reset Button Properties");
	}
