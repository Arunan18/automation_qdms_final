...
* Description
*------------
Test Configure Table - Parameter Table Middle Page- Test Parameter Table- "Unit" Drop Down  Properties
***********************************************************************************
*
* Author           : THAKSHILA
...
* ================       ====         =====        ========
TC-TCN-0516        07/07/2023     THAKSHILA    Original Version
*
*************************************************************************************/
...
public class TestConfigureTableParameterTableMiddlePageTestParameterTableUnitDropDownProperties
	...
	public static void commonMethodTextBoxProperties() throws InterruptedException, IOException {
		...
		ProCommonMethods.dropDown("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0516-02",
				TestConfigPage.paraMeterTestParaMeterUnitDropdown,
				"Test Configure Table - Parameter Table Middle Page- Test Parameter Table-Unit Drop Down  Properties","1");
