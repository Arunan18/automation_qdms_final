 ...
 * Description
 *------------
 * Test Configure Module, Top Bar Accepted criteria, Accepted Value, Second Table, "Material" Column Search Icon's Pop-Up, "Search"
 * Button Properties
 ***************************************************************************************************************************************
 *
 ...
 * ================        ====         =====          ========
 * TC-TCN-0663 		    10/07/2023      Shangeetha    Original Version  
 *************************************************************************************************************************************/
...
public class TestConfigAcceptedCriteriaTabMaterialColSearchPopSearchBtn extends DriverIntialization{
	...
	public static void AcceptedCriteria() throws InterruptedException, IOException {
		...
		// Check 'Search' Button Properties on 'Material' Column Search Pop-Up  
	...
	public static void methodSearchButtonProperties() {
		PageFactory.initElements(driver, testPage);
		// Check 'Search' Button Properties on 'Material' Column Search Pop-Up 
		PropertiesCommonMethods.getButtonPropertiesq("Test Configuration Properties.xlsx", "Test_Configure", "TC-TCN-0663-02", TestConfigPage.acceptedCriteriaTableTwoMaterialColSrchPopSearchBtn, "'Search' Button Properties on 'Material' Column Search Pop-Up");
	}
}
