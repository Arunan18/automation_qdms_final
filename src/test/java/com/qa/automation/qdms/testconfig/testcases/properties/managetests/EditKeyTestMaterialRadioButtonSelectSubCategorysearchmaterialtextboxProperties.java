...
* Description
*------------
* Test Configure - Manage Test Configuration Tab Key Test Icon Edit Key Test Pop up Screen Material  Radio Button Select Sub Category Search Material Text Box Properties
**************************************************************************************************************************************************************************
*
* Author           : M.Mathushan
...
* ================       ====         =====        ========
*MTC-MT-129           11/07/2023   M.Mathushan    Original Version
*
*****************************************************************************************************************************************************************************/
...
public class  EditKeyTestMaterialRadioButtonSelectSubCategorysearchmaterialtextboxProperties extends DriverIntialization {
	static ManageTestsPage mtp = new ManageTestsPage();
    static String test =null;
	@Test

	public static void KeyTestMaterialRadioButtonSelectSubCategorysearchmaterialtextboxProperties()
		...
		TestConfiRev_MaterialSubHeadingProperties.dataExcel("Manage_Tests", "MTC-MT-129-01");
		...
		keyTestPopupScreenMaterialRadioButtonSelectSubCategoryDropDownProperties();
	...
	public static void keyTestPopupScreenMaterialRadioButtonSelectSubCategoryDropDownProperties () throws InterruptedException {
		PageFactory.initElements(driver, mtp);
		Thread.sleep(1000);
		ProCommonMethods.textBoxProperties("Test Configuration Properties.xlsx", "Manage_Tests",
				"MTC-MT-129-02",ManageTestsPage.editKeyTestPopupmaterialselectsubcategorysearchmaterialtextboxProperties,
				"Step-4--Test Configure Manage Test Configuration Tab Manage configure Tab Key Test Pop up Screen Material TextBox Properties");
	}
