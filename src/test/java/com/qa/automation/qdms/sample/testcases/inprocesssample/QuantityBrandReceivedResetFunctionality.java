...
//		DESCRIPTION
//------------------
//					IN-PROCESS SAMPLE QUALITY & BRAND RECEIVED RESET TEST FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   28:04:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0155	 	 28:04:2023     @SASIKALA     Original Version
//* 
//*****************************************************************************************

/*
* Process Sample  "QUALITY & BRAND RECEIVED"  Reset Button UI Functionality - TC-PRO-SAM-0155
*/
...
public class QuantityBrandReceivedResetFunctionality extends DriverIntialization {
...
// ***************In-Process Sample QUALITY & BRAND RECEIVED Search Screen Method ****************************************
	...
	public static void InProcessCodeSearchScreenMethod() throws InterruptedException, IOException {
		...
		if (InprocessSamplePage.QBRsearchpopup.isDisplayed()) {
			...
			testCase = extent.createTest("INPROCESS QUALITY & BRAND RECEIVED SEARCH TEXTBOX VISIBLE");
			testCase.log(Status.FAIL, "TEST FAIL");
		}
		...
		if (InprocessSamplePage.QBRsearchtextbox.isDisplayed()) {
			...
			if (InprocessSamplePage.QBRsearchtextbox.isEnabled()) {
				...
				try {
					...
					String testCaseId = "TC-PRO-SAM-0155";
					...
					for (int i = firstRow; i <= lastRow; i++) {
						...
						TestCasePrint("CONFIRM QUALITY & BRAND RECEIVED SEARCH DATA", SampleCodeSearchconfirmData,
...
// ***************In-Process Sample QUALITY & BRAND RECEIVED Reset button Method ****************************************
	@Test(priority = 5)
	public static void InProcessCodeResetbuttonMethod() throws InterruptedException, IOException {
		PageFactory.initElements(driver, inprocesssample);

		Thread.sleep(2000);
		if (InprocessSamplePage.QBRreseticon.isDisplayed()) {
			testCase = extent.createTest("INPROCESS QUALITY & BRAND RECEIVED RESET BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.QBRreseticon.isEnabled()) {
				testCase = extent.createTest("INPROCESS QUALITY & BRAND RECEIVED RESET BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.QBRreseticon.click();
					Thread.sleep(2000);
				} catch (Exception e) {
		...
		String Values = InprocessSamplePage.QBRreseticon.getAttribute("Value");
		TestCasePrint("CONFIRM RESET", "null", String.valueOf(Values));
		Thread.sleep(2000);
	}

// ***************In-Process Sample QUALITY & BRAND RECEIVED Search After Count Method****************************************
