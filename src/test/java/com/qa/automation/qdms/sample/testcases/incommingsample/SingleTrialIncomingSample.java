...
//* Description
//*------------
//* Incoming Sample Single Trial Test
//*************************************************************************************************
//*
...
public class SingleTrialIncomingSample extends DriverIntialization {

	@Test
	public static void IncomingSampleSingleTrial() throws InterruptedException, IOException {
		...
		TestStatus.clickTestAndResults("Samples Module", "Incoming Sample", "TC-INC-SAM-0297-data",
		...
		TestStatus.inputTestDataForRawMaterial("TC-INC-SAM-0297-Input");

		// **********************************************************************************
		// STEP-06 COMPARE TRIAL EXPECTED VALUES
		// **********************************************************************************

		TestStatus.testExpected("TC-INC-SAM-0297-Expected");
