...
//* ================       ====         =====        ========
//*TC-INC-SAM-0316       16/05/2023   Priyanka     Orginal Version
//*  
//*
//************************************************************************************
...
public class IncSamTrialProcessStatus extends DriverIntialization {

	static IncomingSamplePage incomingsample = new IncomingSamplePage();

	@Test
	public static void TrialProcessStatus() throws InterruptedException, IOException {
		...
		IncSamTestTrialInputValue.TestTrialInputValueIncSamProcess();

		IncSamTestTrialInputValue.ClickTestResultTestProcess();
		...
		Thread.sleep(2000);
		IncSamTestTrialInputValue.ProcessStatus();
