...
//* Description
//*------------
//* Test Trial Validation In Coming Sample
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*  TC-INC-SAM-0317     15/05/2023   Sayan     Orginal Version
//*
//************************************************************************************
...
public class TestTrialValidationInComingSample extends DriverIntialization {
	...
	public static void incomingSampleTrlValidation() throws InterruptedException, IOException {
...
//		SEND VALUES TO NO OF TRIAL AND CLICK THE SUBMIT BUTTON
//		-------------------------------------------------------

		driver.findElement(By.xpath("//input[@class='ant-input-number-input']")).sendKeys(noOfTrial);
...
//__________________________________________________________________________________________________
	...
	public static void excel() throws InterruptedException, IOException {
		...
		String testCaseId = "TC-INC-SAM-0317-TD";
	...
	public static void codeClick() throws InterruptedException {
		...
		try {
			Thread.sleep(1000);
			if (driver
					.findElement(By.xpath("(//td[text()='" + code
							+ "']//following-sibling::td[8])[2]//span[@class='anticon anticon-experiment']"))
					.isDisplayed()) {
				...
				if (driver
					...
					try {
						driver.findElement(By.xpath("(//td[text()='" + code
								+ "']//following-sibling::td[8])[2]//span[@class='anticon anticon-experiment']"))
								.click();
	...
	public static void validation() throws InterruptedException, IOException {
		...
		String excelPath = System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx";
		String excelSheetName = "Incoming Sample";
		String testCaseId = "TC-INC-SAM-0317";
...
//			first field
			...
			try {
				if (IncomingSamplePage.firstTrialTextBox.isDisplayed()) {
					if (IncomingSamplePage.firstTrialTextBox.isEnabled()) {
						IncomingSamplePage.firstTrialTextBox.click();
						IncomingSamplePage.firstTrialTextBox.sendKeys(Keys.CONTROL,"a",Keys.DELETE);
						Thread.sleep(2000);
						IncomingSamplePage.firstTrialTextBox.sendKeys(String.valueOf(trialValue1), Keys.ENTER);
					}
				}
...
//	Second Field
			...
			Thread.sleep(2000);
			try {
				if (IncomingSamplePage.secondTrialTextBox.isDisplayed()) {
					if (IncomingSamplePage.secondTrialTextBox.isEnabled()) {
						IncomingSamplePage.secondTrialTextBox.click();
						IncomingSamplePage.secondTrialTextBox.sendKeys(Keys.CONTROL,"a",Keys.DELETE);
						Thread.sleep(2000);
						IncomingSamplePage.secondTrialTextBox.sendKeys(String.valueOf(trialValue2), Keys.ENTER);
					}
				}
...
//			Third Field
			...
			Thread.sleep(2000);
			try {
				if (IncomingSamplePage.thirdTrialTextBox.isDisplayed()) {
					if (IncomingSamplePage.thirdTrialTextBox.isEnabled()) {
						IncomingSamplePage.thirdTrialTextBox.click();
						IncomingSamplePage.thirdTrialTextBox.sendKeys(Keys.CONTROL,"a",Keys.DELETE);
						Thread.sleep(2000);
						IncomingSamplePage.thirdTrialTextBox.sendKeys(String.valueOf(trialValue3), Keys.ENTER);
					}
				}
			...
			IncomingSamplePage.trialButton.click();

			if (IncomingSamplePage.trialButton.isDisplayed()) {

				
					try {
						testCase = extent.createTest(forReporttrialValue);
						String ActualValidation = IncomingSamplePage.trialValueValidation.getText();
