...
//* Description
//*------------
//* OK  BUTTON FUNCTIONALITY TEST AND TRAIL IN PROCESS SAMPLE
//***********************************************************************************
//*
...
//* ================      ====       =====      ========
//*TC-PRO-SAM-0223   	11/05/2023   @SASI     	Original Version
//*  
//************************************************************************************

/*
 * TC-PRO-SAM-0223	InProcess sample Test & Result OK button Functionality
 */
...
//  ******************* EXCEL SHEET DATA ****************************
	...
	public static void selectSampleExcelData() throws InterruptedException, IOException {
		...
		int firstrow = CommonMethods.getFirstRowNum(
				System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx",
				"Process Sample", "TC-PRO-SAM-0223");
...
// ***************************** OK BUTTON FUNCTIONALITY **********************************	
	...
	public static void okbuttonfunction() throws InterruptedException, IOException {
		PageFactory.initElements(driver, inprocessPg);
		if (InprocessSamplePage.okbtn.isDisplayed()) {
			testCase = extent.createTest("OK BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.okbtn.isEnabled()) {
				testCase = extent.createTest("OK BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.okbtn.click();
				} catch (Exception e) {
