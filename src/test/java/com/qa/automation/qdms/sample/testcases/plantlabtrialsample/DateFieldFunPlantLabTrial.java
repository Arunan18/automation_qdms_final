...
//* Description
//*------------
//* Date Field Functionality Plant Lab Trial Sample
//*************************************************************************************************
//*
//* Author           : S.Sayanthan
...
//* ================       ====         =====        ========
//*  TC-P-LAB-SAM-0228    11/05/2023    Sayanthan    Orginal Version
//
//************************************************************************************
...
public class DateFieldFunPlantLabTrial extends DriverIntialization {
...
//  --------------------------------------
		...
		String ActualData = driver.findElement(By.xpath("//input[@placeholder='Select date']")).getAttribute("value");
...
// ____________________________________________________________________________________________
	...
	public static void selectSampleExcelData() throws InterruptedException, IOException {
		...
		int firstrow = CommonMethods.getFirstRowNum(
				System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx",
				"Plant Lab Trial Sample", "TC-P-LAB-SAM-0228");
