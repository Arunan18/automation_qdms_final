...
//		DESCRIPTION
//------------------
//					IN-PROCESS SAMPLE SUPPLIER TEST FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   19:04:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0032	 	 19:04:2023     @SASIKALA     Original Version
//* TC-PRO-SAM-0034
//* TC-PRO-SAM-0036
//*****************************************************************************************

/*
* Process Sample  "Supplier"  Search Icon UI Functionality - TC-PRO-SAM-0032
* Process Sample  "Supplier" Text Box UI Functionality - TC-PRO-SAM-0034
* Process Sample  "Supplier"  Search Button UI Functionality -TC-PRO-SAM-0036 
*/
...
public class SupplierSearchFunctionality extends DriverIntialization {
	static InprocessSamplePage inprocesssample = new InprocessSamplePage();

	static String ExpectedData = "";

//*******************************NAVIGATE IN-PROCESS SAMPLE********************
...
// ***************IN-PROCESS SAMPLE "SUPPLIER" SEARCH ICON METHOD************************

	@Test(priority = 2)
	public static void InProcessCodeSearchiconMethod() throws InterruptedException, IOException {
		PageFactory.initElements(driver, inprocesssample);

		if (InprocessSamplePage.Suppliersearchicon.isDisplayed()) {
			testCase = extent.createTest("INPROCESS SUPPLIER SEARCH ICON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.Suppliersearchicon.isEnabled()) {
				testCase = extent.createTest("INPROCESS SUPPLIER SEARCH ICON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.Suppliersearchicon.click();
					Thread.sleep(2000);
				} catch (Exception e) {
...
// ***************IN-PROCESS SAMPLE "SUPPLIER" SEARCH SCREEN METHOD****************************

	@Test(priority = 3)
	public static void InProcessCodeSearchScreenMethod() throws InterruptedException, IOException {
		PageFactory.initElements(driver, inprocesssample);

		if (InprocessSamplePage.Suppliersearchpopup.isDisplayed()) {
			testCase = extent.createTest("INPROCESS SUPPLIER SEARCH SCREEN VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.Suppliersearchpopup.isEnabled()) {
				testCase = extent.createTest("INPROCESS SUPPLIER SEARCH SCREEN ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.Suppliersearchpopup.click();
					Thread.sleep(2000);
				} catch (Exception e) {
				...
				testCase = extent.createTest("INPROCESS SUPPLIER SEARCH TEXTBOX ENABLED");
				testCase.log(Status.PASS, "TEST FAIL");
			}
		} else {
			testCase = extent.createTest("INPROCESS SUPPLIER SEARCH TEXTBOX VISIBLE");
			testCase.log(Status.FAIL, "TEST FAIL");
		}

	}

// ***************IN-PROCESS SAMPLE "SUPPLIER" SEARCH DATA TEXT BOX METHOD ***************************************
	...
	public static void InProcessCodeSearchdataboxMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		if (InprocessSamplePage.Suppliersearchtextbox.isDisplayed()) {
			testCase = extent.createTest("SUPPLIER SEARCH TEXTBOX IS VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.Suppliersearchtextbox.isEnabled()) {
				testCase = extent.createTest("SUPPLIER SEARCH TEXTBOX IS ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.Suppliersearchtextbox.click();

					String excelPath = System.getProperty("user.dir")
							+ "\\src\\test\\resources\\Excel\\Samples Module.xlsx";
					String excelSheetName = "Process Sample";
					String testCaseId = "TC-PRO-SAM-0032";
					...
					for (int i = firstRow; i <= lastRow; i++) {
						...
						InprocessSamplePage.Suppliersearchtextbox.sendKeys(SampleCodeSearchData);
						String Value = InprocessSamplePage.Suppliersearchtextbox.getAttribute("value");
						TestCasePrint("CONFIRM SUPPLIER SEARCH", SampleCodeSearchconfirmData, String.valueOf(Value));
						Thread.sleep(2000);
			...
			testCase = extent.createTest("SUPPLIER SEARCH TEXTBOX VISIBLE");
			testCase.log(Status.FAIL, "TEST FAIL");
		}

	}

// ***************IN-PROCESS SAMPLE "SUPPLIER" SEARCH BUTTON METHOD*******************************
	...
	public static void InProcessCodeSearchbuttonMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		if (InprocessSamplePage.Suppliersearchbutton.isDisplayed()) {
			testCase = extent.createTest("INPROCESS SUPPLIER SEARCH BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.Suppliersearchbutton.isEnabled()) {
				testCase = extent.createTest("INPROCESS SUPPLIER SEARCH BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.Suppliersearchbutton.click();
					Thread.sleep(2000);
				} catch (Exception e) {
...
// ***************IN-PROCESS SAMPLE "SUPPLIER" SEARCH AFTER COUNT METHOD***************************
