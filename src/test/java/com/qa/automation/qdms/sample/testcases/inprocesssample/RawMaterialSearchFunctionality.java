...
//		DESCRIPTION
//------------------
//					IN-PROCESS SAMPLE RAW MATERIAL TEST FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   19:04:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0050	 	 19:04:2023     @SASIKALA     Original Version
//* TC-PRO-SAM-0052
//* TC-PRO-SAM-0054
//*****************************************************************************************

/*
* Process Sample  "Raw Material"  Search Icon UI Functionality - TC-PRO-SAM-0050
* Process Sample  "Raw Material" Text Box UI Functionality - TC-PRO-SAM-0052
* Process Sample  "Raw Material"  Search Button UI Functionality -TC-PRO-SAM-0054 
*/
...
public class RawMaterialSearchFunctionality extends DriverIntialization {
...
// ***************IN-PROCESS SAMPLE "RAW MATERIAL" SEARCH ICON METHOD************************
	...
	public static void InProcessCodeSearchiconMethod() throws InterruptedException, IOException {
		...
		if (InprocessSamplePage.RMsearchicon.isDisplayed()) {
			testCase = extent.createTest("INPROCESS RAW MATERIAL SEARCH ICON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.RMsearchicon.isEnabled()) {
				testCase = extent.createTest("INPROCESS RAW MATERIAL SEARCH ICON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					boolean pass = false;
					for (int i = 0; i < 100; i++) {
						if (!pass) {
							try {
								InprocessSamplePage.RMsearchicon.click();
								pass = true;
							} catch (Exception e) {
							}
						}
...
// ***************IN-PROCESS SAMPLE "RAW MATERIAL" SEARCH SCREEN METHOD**********************
	...
	public static void InProcessRawMaterialSearchScreenMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		if (InprocessSamplePage.RMsearchpopup.isDisplayed()) {
			testCase = extent.createTest("INPROCESS RAW MATERIAL SEARCH SCREEN VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.RMsearchpopup.isEnabled()) {
				testCase = extent.createTest("INPROCESS RAW MATERIAL SEARCH SCREEN ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.RMsearchpopup.click();
					Thread.sleep(2000);
				} catch (Exception e) {
				...
				testCase = extent.createTest("INPROCESS RAW MATERIAL SEARCH TEXTBOX ENABLED");
				testCase.log(Status.PASS, "TEST FAIL");
			}
		} else {
...
// ***************IN-PROCESS SAMPLE "RAW MATERIAL" SEARCH DATA TEXT BOX METHOD**************
	...
	public static void InProcessRawMaterialSearchdataboxMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		if (InprocessSamplePage.RMsearchtextbox.isDisplayed()) {
			testCase = extent.createTest("RAW MATERIAL SEARCH TEXTBOX IS VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.RMsearchtextbox.isEnabled()) {
				testCase = extent.createTest("RAW MATERIAL SEARCH TEXTBOX IS ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.RMsearchtextbox.click();

					String excelPath = System.getProperty("user.dir")
							+ "\\src\\test\\resources\\Excel\\Samples Module.xlsx";
					String excelSheetName = "Process Sample";
					String testCaseId = "TC-PRO-SAM-0050";
					...
					for (int i = firstRow; i <= lastRow; i++) {
						...
						InprocessSamplePage.RMsearchtextbox.sendKeys(SampleCodeSearchData);
						String Value = InprocessSamplePage.RMsearchtextbox.getAttribute("value");
			...
			testCase = extent.createTest("RAW MATERIAL SEARCH TEXTBOX VISIBLE");
			testCase.log(Status.FAIL, "TEST FAIL");
		}

	}

// ***************IN-PROCESS SAMPLE "RAW MATERIAL" SEARCH BUTTON METHOD*****************
	...
	public static void InProcessRawMaterialSearchbuttonMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		if (InprocessSamplePage.RMsearchbutton.isDisplayed()) {
			testCase = extent.createTest("INPROCESS RAW MATERIAL SEARCH BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.RMsearchbutton.isEnabled()) {
				testCase = extent.createTest("INPROCESS RAW MATERIAL SEARCH BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.RMsearchbutton.click();
					Thread.sleep(2000);
				} catch (Exception e) {
...
// ***************IN-PROCESS SAMPLE "RAW MATERIAL" SEARCH AFTER COUNT METHOD********************
