...
//* Description
//*------------
//* Trial Button Functionality Plant Lab Trial Sample
//***********************************************************************************
//*
//* Author           : S Sayanthan
...
//* ================       ====         =====        ========
//* TC-P-LAB-SAM-0237   15/05/2023    Sayan     Original Version
//*
//************************************************************************************
...
public class TrialBtnFunPlantLabTrial extends DriverIntialization{
...
//	 ADDING THE TRIAL VALUE AND CLICK ON THE TRIAL BUTTON
//	------------------------------------------------------
		
		
		driver.findElement(By.xpath("//input[@placeholder=' g']")).sendKeys(trialValue);
		
		Thread.sleep(100);
		driver.findElement(By.xpath("//button[@class='ant-btn sc-gZMcBi dMdnOw']")).click();
		
		
//		VERIFY THE TRIAL BUTTON FUNCTIONALITY
//		--------------------------------------
		
		Thread.sleep(2000);
		String ActualData = driver.findElement(By.xpath("//button[@class='ant-btn sc-gZMcBi dMdnOw']")).getText();
        String ExpectedData = "View Results";
        System.out.println("text : " + ActualData);
        testCase = extent.createTest("VERIFY THE TRIAL BUTTON FUNCTIONALITY");
        if (ActualData.equals("View Results")) {
//            Assert.assertEquals(ActualData, ExpectedData);
...
// ____________________________________________________________________________________________
	...
	public static void selectSampleExcelData() throws InterruptedException, IOException {
		...
		int firstrow = CommonMethods.getFirstRowNum(
				System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx",
				"Plant Lab Trial Sample", "TC-P-LAB-SAM-0237");
		...
		for (int i = firstrow; i <= lastrow; i++) {
            ...
            trialValue = (String) row.getCell(6).getStringCellValue();
		}
	}
