...
//		DESCRIPTION
//------------------
//					IN-PROCESS SAMPLE RAW MATERIAL RESET TEST FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   20:04:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0056	 	 20:04:2023     @SASIKALA     Original Version
//* 
//*****************************************************************************************

/*
* Process Sample  "Raw Material"  Reset Button UI Functionality - TC-PRO-SAM-0056
*/
...
public class RawMaterialResetFunctionality extends DriverIntialization {
		...
		if (InprocessSamplePage.RMsearchtextbox.isDisplayed()) {
			...
			if (InprocessSamplePage.RMsearchtextbox.isEnabled()) {
				...
				try {
					...
					String testCaseId = "TC-PRO-SAM-0056";
					...
					for (int i = firstRow; i <= lastRow; i++) {
						...
						TestCasePrint("CONFIRM RAW MATERIAL SEARCH DATA", SampleCodeSearchconfirmData,
...
// ***************In-Process Sample Raw Material Reset button Method ****************************************
	...
	public static void InProcessCodeResetbuttonMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		if (InprocessSamplePage.RMreseticon.isDisplayed()) {
			testCase = extent.createTest("INPROCESS RAW MATERIAL RESET BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.RMreseticon.isEnabled()) {
				testCase = extent.createTest("INPROCESS RAW MATERIAL RESET BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.RMreseticon.click();
					Thread.sleep(2000);
				} catch (Exception e) {
		...
		String Values = InprocessSamplePage.RMreseticon.getAttribute("Value");
