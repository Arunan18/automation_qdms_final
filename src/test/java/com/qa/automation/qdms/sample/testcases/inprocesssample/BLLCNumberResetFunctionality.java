...
//		DESCRIPTION
//------------------
//					IN-PROCESS SAMPLE BLLC NUMBER RESET TEST FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   26:04:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0137	 	 27:04:2023     @SASIKALA     Original Version
//* 
//*****************************************************************************************

/*
* Process Sample  "BLLC No"  Reset Button UI Functionality - TC-PRO-SAM-0137
*/
...
public class BLLCNumberResetFunctionality extends DriverIntialization {
...
// ****************Count Number of elements Before search**************
	...
	// ***************In-Process Sample BLLC No Search Icon Method
	// *****************************************
...
// ***************In-Process Sample BLLC No Search Screen Method************************************
...
// ***************In-Process Sample BLLC No Search Data Text Box Method*************************************

	@Test(priority = 4)
	public static void InProcessBllcNoSearchdataboxMethod() throws InterruptedException, IOException {
		PageFactory.initElements(driver, inprocesssample);
		...
		if (InprocessSamplePage.Bllcsearchtextbox.isDisplayed()) {
			...
			if (InprocessSamplePage.Bllcsearchtextbox.isEnabled()) {
				...
				try {
					...
					String testCaseId = "TC-PRO-SAM-0137";
...
// ***************In-Process Sample Raw Material Reset button Method ****************************************
	...
	public static void InProcessCodeResetbuttonMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		if (InprocessSamplePage.Bllcreseticon.isDisplayed()) {
			testCase = extent.createTest("INPROCESS BLLC NUMBER RESET BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.Bllcreseticon.isEnabled()) {
				testCase = extent.createTest("INPROCESS BLLC NUMBER RESET BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.Bllcreseticon.click();
					Thread.sleep(2000);
				} catch (Exception e) {
		...
		String Values = InprocessSamplePage.Bllcreseticon.getAttribute("Value");
