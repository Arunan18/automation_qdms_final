...
//* Description
//*------------
//* Status Field Functionality Plant Lab Trial Sample
//*************************************************************************************************
//*
//* Author           : S.Sayanthan
...
//* ================       ====         =====        ========
//*  TC-P-LAB-SAM-0232    12/05/2023    Sayanthan    Orginal Version
//
//************************************************************************************
...
public class StatusFieldFunPlantLabTrial extends DriverIntialization {
	...
	public static void statusFieldFunction() throws InterruptedException, IOException {
...
//		CHECKIN THE FUNCTIONALITY OF STATUS FIELD
//		-------------------------------------------
		Thread.sleep(1000);
		...
		if (driver.findElement(By.id("status")).isDisplayed()) {
			...
			if (driver.findElement(By.id("status")).isEnabled()) {
				testCase = extent.createTest("STATUS FIELD IS ENABLED");
				testCase.log(Status.PASS, "TEST PASS ☑");

			WebElement testStatus = driver.findElement(By.id("status"));
...
// ____________________________________________________________________________________________
	...
	public static void selectSampleExcelData() throws InterruptedException, IOException {
		...
		int firstrow = CommonMethods.getFirstRowNum(
				System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx",
				"Plant Lab Trial Sample", "TC-P-LAB-SAM-0232");
