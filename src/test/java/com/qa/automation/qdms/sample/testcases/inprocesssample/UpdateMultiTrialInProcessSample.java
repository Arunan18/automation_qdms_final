...
//		DESCRIPTION
//------------------
//					IN-PROCESS SAMPLE UPDATE MULTI TRAIL  FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   15:05:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0298	 	 15:05:2023     @SASIKALA     Original Version
//*****************************************************************************************

/*
* TC-PRO-SAM-0298	If sample Already conducted Check the To trail - (Update trail - Multi Trail)
*/
...
public class UpdateMultiTrialInProcessSample extends DriverIntialization {
	@Test
...
// STEP-04 SEARCH SAMPLE CODE
		TestStatus.clickTestAndResults("Samples Module", "Process Sample", "TC-PRO-SAM-0298-data",
				driver.findElements(By.xpath("//tbody[@class='ant-table-tbody']/tr/td[1]")), 1, 18);

// STEP-05 CLICK TEST AND ENTER TRIAL VALUES
		TestStatus.inputTestDataForRawMaterial("TC-PRO-SAM-0298-Input");

// STEP-06 COMPARE TRIAL EXPECTED VALUES
		TestStatus.testExpected("TC-PRO-SAM-0298-Expected");
