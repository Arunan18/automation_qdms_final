...
//		DESCRIPTION
//------------------
//					IN-PROCESS SAMPLE DATE RESET TEST FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   25:04:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0074	 	 25:04:2023     @SASIKALA     Original Version
//* 
//*****************************************************************************************

/*
* Process Sample  "Date"  Reset Button UI Functionality - TC-PRO-SAM-0074
*/
...
public class DateResetFunctionality extends DriverIntialization{
...
// ***************************Reach In-Process Sample**************
	...
	//******************Excel Method**********************
		...
		String testCaseId = "TC-PRO-SAM-0074";
			...
			if (InprocessSamplePage.Datesearchtextbox.isDisplayed()) {
				...
				if (InprocessSamplePage.Datesearchtextbox.isEnabled()) {
					...
					try {
						...
						SelectDate.dateSelect("Samples Module.xlsx", "Process Sample", "TC-PRO-SAM-0074-01", 1,InprocessSamplePage.Datesearchtextbox);
						Thread.sleep(1000);
...
// ***************In-Process Sample Date Reset button Method ****************************************
	@Test(priority = 5)
	public static void InProcessCodeResetbuttonMethod() throws InterruptedException, IOException {
		PageFactory.initElements(driver, inprocesssample);

		Thread.sleep(2000);
		if (InprocessSamplePage.Datereseticon.isDisplayed()) {
			testCase = extent.createTest("INPROCESS DATE RESET BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.Datereseticon.isEnabled()) {
				testCase = extent.createTest("INPROCESS DATE RESET BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.Datereseticon.click();
					Thread.sleep(2000);
				} catch (Exception e) {
		...
		String Values = InprocessSamplePage.Datereseticon.getAttribute("Value");
