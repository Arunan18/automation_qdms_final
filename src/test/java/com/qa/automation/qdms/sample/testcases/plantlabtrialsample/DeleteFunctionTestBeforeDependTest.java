...
//* Description
//*------------
//* DELETE FUCNTIONALITY IN PLANT LAB TRAIL SAMPLE 
//***********************************************************************************
//*
...
public class DeleteFunctionTestBeforeDependTest extends DriverIntialization {
	...
	public static void FinishedProductFieldTest() throws InterruptedException, IOException {
		...
		DeleteFunctionMethod.Deleteselect() ;
		// CLICK DELETE ICON FOR SELECTED DATA

		extent.createTest("CHECK DELETE DUNCTIONALITY");
		ActionCommonMethod.actionS(2, 14, labtrailpage.tableContainer, "delete", "Samples Module.xlsx", "Plant Lab Trial Sample", "TC-P-LAB-SAM-0015-01"				, 1);
