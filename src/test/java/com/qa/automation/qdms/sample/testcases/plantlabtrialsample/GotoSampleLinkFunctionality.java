...
//* Description
//*------------
//* Go to Sample Link Functionality Plant Lab Trial Sample
//***********************************************************************************
//*
//* Author           : S Sayanthan
...
//* ================       ====         =====        ========
//* TC-P-LAB-SAM-0239   15/05/2023    Sayan     Original Version
//*
//************************************************************************************
...
public class GotoSampleLinkFunctionality extends DriverIntialization{
...
//	------------------------------------------------------
	...
	Thread.sleep(2000);	
	driver.findElement(By.xpath("//a[text()='Go To Samples']")).click();
...
//		--------------------------------------
	...
	String ExpectedText = "Plant-Lab Trial Sample";
...
// ____________________________________________________________________________________________
	...
	public static void selectSampleExcelData() throws InterruptedException, IOException {
		...
		int firstrow = CommonMethods.getFirstRowNum(
				System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx",
				"Plant Lab Trial Sample", "TC-P-LAB-SAM-0239");
