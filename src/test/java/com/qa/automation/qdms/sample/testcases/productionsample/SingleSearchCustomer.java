...
//* Description
//*------------
//* Production Sample Customer Field Single Search
//* 
//*************************************************************************************************
//*
...
//* ================       ====         =====        ========
//*  TC-PRODUCT-SAM-0104   26/04/2023   Priyanka     Orginal Version
//*  TC-PRODUCT-SAM-0106         
//*  TC-PRODUCT-SAM-0108
//*  TC-PRODUCT-SAM-0110
//************************************************************************************
...
public class SingleSearchCustomer extends DriverIntialization {
	...
	public static void SampleDateFieldSingleSearch() throws InterruptedException, IOException {
		...
		SampleSingleSearchMethods.singleSearch(ProductionSamplePage.CUSsearchicon,
				ProductionSamplePage.CUSsearchtextbox, ProductionSamplePage.CUSsearchbutton,
				"Production Sample- Plant Field", "Samples Module", "Production Sample", "TC-PRODUCT-SAM-0104", 1, 2,
				ProductionSamplePage.colummCUS, "//tbody[@class='ant-table-tbody']/tr[", "]/td[7]", customer);
		...
		// **********************************************************************************
		Thread.sleep(3000);
		SampleActionMethods.clicking(ProductionSamplePage.CUSResetbutton, 2, "STEP-06 CHECKING RESET BUTTON");
