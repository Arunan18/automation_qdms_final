...
//* Description
//*------------
//* Test Trial Validation In Process Sample
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*  TC-INC-SAM-0317     18/05/2023    Sayan     Orginal Version
//*
//************************************************************************************
...
public class TestTrialValidationInProcessSample extends DriverIntialization{
	...
	public static void inProcessSampleTrialValidation() throws InterruptedException, IOException {
...
//__________________________________________________________________________________________________
	...
	public static void excel() throws InterruptedException, IOException {
		...
		String testCaseId = "TC-PRO-SAM-0316-TD";
	...
	public static void validation() throws InterruptedException, IOException {
		...
		String excelPath = System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx";
		String excelSheetName = "Process Sample";
		String testCaseId = "TC-PRO-SAM-0316";
...
//			first field
			...
			try {
				if (InprocessSamplePage.firstTrialTextBox.isDisplayed()) {
					if (InprocessSamplePage.firstTrialTextBox.isEnabled()) {
						InprocessSamplePage.firstTrialTextBox.click();
						InprocessSamplePage.firstTrialTextBox.sendKeys(Keys.CONTROL,"a",Keys.DELETE);
						Thread.sleep(2000);
						InprocessSamplePage.firstTrialTextBox.sendKeys(String.valueOf(trialValue1), Keys.ENTER);
					}
				}
...
//	Second Field
			...
			Thread.sleep(2000);
			try {
				if (InprocessSamplePage.secondTrialTextBox.isDisplayed()) {
					if (InprocessSamplePage.secondTrialTextBox.isEnabled()) {
						InprocessSamplePage.secondTrialTextBox.click();
						InprocessSamplePage.secondTrialTextBox.sendKeys(Keys.CONTROL,"a",Keys.DELETE);
						Thread.sleep(2000);
						InprocessSamplePage.secondTrialTextBox.sendKeys(String.valueOf(trialValue2), Keys.ENTER);
					}
				}
...
//			Third Field
			...
			Thread.sleep(2000);
			try {
				if (InprocessSamplePage.thirdTrialTextBox.isDisplayed()) {
					if (InprocessSamplePage.thirdTrialTextBox.isEnabled()) {
						InprocessSamplePage.thirdTrialTextBox.click();
						InprocessSamplePage.thirdTrialTextBox.sendKeys(Keys.CONTROL,"a",Keys.DELETE);
						Thread.sleep(2000);
						InprocessSamplePage.thirdTrialTextBox.sendKeys(String.valueOf(trialValue3), Keys.ENTER);
					}
				}
			...
			InprocessSamplePage.trialButton.click();

			if (InprocessSamplePage.trialButton.isDisplayed()) {

				
					try {
						testCase = extent.createTest(forReporttrialValue);
						String ActualValidation = InprocessSamplePage.trialValueValidation.getText();
