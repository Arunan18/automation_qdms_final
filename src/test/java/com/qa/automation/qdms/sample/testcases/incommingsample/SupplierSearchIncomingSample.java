...
//* Description
//*------------
//* Supplier Search Functionality in Incoming Samples
//***********************************************************************************
//*
...
//* ================                      ====         =====        ========
//* TC-INC-SAM-0033, TC-INC-SAM-0035      18/04/2023   Sayan     Orginal Version
//* TC-INC-SAM-0037
//************************************************************************************
...
public class SupplierSearchIncomingSample extends DriverIntialization{
	
	
	static String SearchSupplier = null;
...
//		 THE METHOD IS FOR GENERATING REPORT 
	...
	public static void singleSearch() throws InterruptedException, IOException {
		...
		int firstrow = CommonMethods.getFirstRowNum(
				System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx",
				"Incoming Sample", "TC-INC-SAM-0037");
		...
		for (int i = firstrow; i <= lastrow; i++) {
			...
			SearchSupplier = (String) row.getCell(1).getStringCellValue();
...
//		        	STEP-03--INCOMING SAMPLE BUTTON IS DISPLAYED &	STEP-04--INCOMING SAMPLE BUTTON IS ENABLED
		...
		// ****************************************************************************************
//	       	STEP-05--SUPPLIER SEARCH ICON IS DISPLAYED &	STEP-06--SUPPLIER SEARCH ICON IS ENABLED
		// ****************************************************************************************

		if (driver.findElement(By.xpath("//th[2]//div[1]//span[2]")).isDisplayed()) {
			testCase = extent.createTest("STEP-05--SUPPLIER SEARCH ICON IS DISPLAYED");
			testCase.log(Status.PASS, "TEST PASS ☑");
			if (driver.findElement(By.xpath("//th[2]//div[1]//span[2]")).isEnabled()) {
				testCase = extent.createTest("STEP-06--SUPPLIER SEARCH ICON IS ENABLED");
				testCase.log(Status.PASS, "TEST PASS ☑");
				try {
					driver.findElement(By.xpath("//th[2]//div[1]//span[2]")).click();
					Thread.sleep(2000);
		...
		// ************************************************************************************************************
//	       	STEP-07--CHECKING SUPPLIER SEARCH TEXTBOX DISPLAYED &	STEP-08--CHECKING SUPPLIER SEARCH TEXTBOX ENABLED
		// ************************************************************************************************************

		if (driver.findElement(By.xpath("//div[@class='ant-table-filter-dropdown']//input[@placeholder=' Supplier']"))
				.isDisplayed()) {
			testCase = extent.createTest("STEP-07--SUPPLIER SEARCH BOX IS DISPLAYED");
			testCase.log(Status.PASS, "TEST PASS ☑");
			if (driver.findElement(By.xpath("//div[@class='ant-table-filter-dropdown']//input[@placeholder=' Supplier']"))
					.isEnabled()) {
				testCase = extent.createTest("STEP-08--SUPPLIER SEARCH BOX IS ENABLED");
				testCase.log(Status.PASS, "TEST PASS ☑");
				try {
					driver.findElement(
							By.xpath("//div[@class='ant-table-filter-dropdown']//input[@placeholder=' Supplier']"))
							.sendKeys(SearchSupplier);
				...
				testCase = extent.createTest("STEP-08--SUPPLIER SEARCH ICON IS ENABLED");
				testCase.log(Status.PASS, "TEST FAIL ❎");
			}
		} else {
			testCase = extent.createTest("STEP-07--SUPPLIER SEARCH ICON IS DISPLAYED");
			testCase.log(Status.PASS, "TEST FAIL ❎");
		}
		...
		// ************************************************************************************************************
//	       	STEP-08--CHECKING SUPPLIER SEARCH BUTTON DISPLAYED &	STEP-09--CHECKING SUPPLIER SEARCH BUTTON ENABLED
		// ************************************************************************************************************
			...
			if (driver.findElement(By.xpath(
				...
				try {
					...
					String Code = driver.findElement(By.xpath(
							"//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div/div[1]/div/div/div/div/div[2]/div[2]/table/tbody/tr[2]/td[2]"))
							.getText();
		...
		while (clickNextPage) {
			for (int i = 2; i < 750; i++) {
				try {
					...
					if (!text.contains(SearchSupplier)) {
						passorfail = false;
					}
					if (text.contains(SearchSupplier)) {
