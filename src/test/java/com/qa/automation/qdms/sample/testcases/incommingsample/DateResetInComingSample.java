...
//* Description
//*------------
//* Date Reset Functionality in Incoming Samples
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*  TC-INC-SAM-0075                    20/04/2023   Sayan     Orginal Version
//*
//************************************************************************************
...
public class DateResetInComingSample extends DriverIntialization{
...
//				System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx",
//				"Incoming Sample", "TC-INC-SAM-0075");
...
//			date = (String) row.getCell(1).getStringCellValue();
//		
//			
//		}
...
//			STEP-01--RAW MATERIAL TAB IS DISPLAYED & STEP-02--RAW MATERIAL TAB IS ENABLED
		...
		String CodeXpath_lastPart = "]/td[6]";
		while (clickNextPage) {
		...
		try {
			Thread.sleep(1000);
			driver.findElement(By.xpath("//div[@class='ant-table-filter-dropdown']//input[@placeholder=' Date ']")).click();
			driver.findElement(By.xpath("//div[@class='ant-table-filter-dropdown']//input[@placeholder=' Date ']")).sendKeys(date);
			Thread.sleep(2000);
