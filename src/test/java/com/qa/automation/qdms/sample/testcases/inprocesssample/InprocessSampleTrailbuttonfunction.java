...
//		DESCRIPTION
//------------------
//					IN-PROCESS TRAIL BUTTON CHECK FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   16:05:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0308  	   16:05:2023     @SASIKALA     Original Version
//* 
//****************************************************************************************************************

/*
* TC-PRO-SAM-0308	Check when do the Test trial Check the Trial button Functionality
*/
...
public class InprocessSampleTrailbuttonfunction extends DriverIntialization {
...
//************************************TEST TRAIL BUTTON*************************
	@Test(priority = 9)
	public static void TRAILBUTTON() throws InterruptedException, IOException {
		PageFactory.initElements(driver, InProPg);

		// driver.navigate().refresh();
		Thread.sleep(3000);
		if (InprocessSamplePage.TrailBtn.isDisplayed()) {
			testCase = extent.createTest("TEST TRAIL BUTTON IS DISPLAYED");
			testCase.log(Status.PASS, "TEST PASS â˜‘");

			if (InprocessSamplePage.TrailBtn.isEnabled()) {
				testCase = extent.createTest("TEST TRAIL BUTTON IS ENABLED");
				testCase.log(Status.PASS, "TEST PASS â˜‘");

				InprocessSamplePage.TrailBtn.click();

			} else {
				testCase = extent.createTest("TEST TRAIL BUTTON FIELD IS NOT ENABLED");
				testCase.log(Status.PASS, "TEST FAIL â�Ž");
			}
		} else {
			testCase = extent.createTest("TEST TRAIL BUTTON IS NOT DISPLAYED");
			testCase.log(Status.PASS, "TEST FAIL â�Ž");
		}
	}
//****************************************LOGOUT FUNCTION************************************ 
