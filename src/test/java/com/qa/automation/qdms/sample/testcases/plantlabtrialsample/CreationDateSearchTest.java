...
//* Description
//*------------
//* SINGLESEARCH- CREATION DATE FIELD FUNCTIONALITY 
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*TC-P-LAB-SAM-0079   20/04/2023   NILUXY.K    Orginal Version
//*TC-P-LAB-SAM-0082
//TC-P-LAB-SAM-0084
//TC-P-LAB-SAM-0086
//************************************************************************************
...
public class CreationDateSearchTest extends DriverIntialization {
	...
	static boolean CreationdateTabledata = true;
	...
	public static void SamplecodeFieldTest() throws InterruptedException, IOException {
		...
		SampleSingleSearchMethods.singleSearch(labtrailpage.creationdatesearchicon,
				labtrailpage.creationdatesearchTextbox, labtrailpage.PlantfieldsearchButton,
				"Plant Lab Trail Sample-CreationdateField", "Samples Module", "Plant Lab Trial Sample",
				"TC-P-LAB-SAM-0079", 1, 2, labtrailpage.columnCreationdate, "//tbody[@class='ant-table-tbody']/tr[",
				"]/td[7]", CreationdateTabledata);
