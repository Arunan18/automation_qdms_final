...
public class SingleSearchCommodity extends DriverIntialization {
	...
	public static void StatusFieldSingleSearch() throws InterruptedException, IOException {
		...
		SampleSingleSearchMethods.singleSearch(ProductionSamplePage.commoditysearchicon,
				ProductionSamplePage.commoditysearchtextbox, ProductionSamplePage.commoditysearchbutton,
				"Production Sample- Commodity Field", "Samples Module", "Production Sample", "TC-PRODUCT-SAM-0140", 1,
				2, ProductionSamplePage.colummcommodity, "//tbody[@class='ant-table-tbody']/tr[", "]/td[14]",
				commodity);
		...
		SampleActionMethods.clicking(ProductionSamplePage.commodityResetbutton, 3, "STEP-06 CHECKING RESET BUTTON");
