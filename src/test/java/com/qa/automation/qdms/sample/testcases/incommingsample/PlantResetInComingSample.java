...
//* Description
//*------------
//* Plant Reset Functionality in Incoming Samples
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*  TC-INC-SAM-0048                    19/04/2023   Sayan     Orginal Version
//*
//************************************************************************************
...
public class PlantResetInComingSample extends DriverIntialization{
...
static String plant = null;
	...
	public static void resetContactSearch() throws InterruptedException, IOException {
		...
		int firstrow = CommonMethods.getFirstRowNum(
				System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx",
				"Incoming Sample", "TC-INC-SAM-0048");
...
//			STEP-01--RAW MATERIAL TAB IS DISPLAYED & STEP-02--RAW MATERIAL TAB IS ENABLED
		...
		String CodeXpath_lastPart = "]/td[3]";
		while (clickNextPage) {
		...
		try {
			Thread.sleep(1000);
			driver.findElement(By.xpath("//div[@class='ant-table-filter-dropdown']//input[@placeholder=' Plant']")).click();
			driver.findElement(By.xpath("//div[@class='ant-table-filter-dropdown']//input[@placeholder=' Plant']")).sendKeys(plant);
			Thread.sleep(2000);
