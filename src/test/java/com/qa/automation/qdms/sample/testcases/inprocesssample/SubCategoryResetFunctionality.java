...
//		DESCRIPTION
//------------------
//					IN-PROCESS SAMPLE SUB CATEGORY RESET TEST FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   20:04:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0065	 	 20:04:2023     @SASIKALA     Original Version
//* 
//*****************************************************************************************

/*
* Process Sample  "Sub Category"  Reset Button UI Functionality - TC-PRO-SAM-0065
*/
...
public class SubCategoryResetFunctionality extends DriverIntialization {
...
// ***************In-Process Sample Sub Category Search Screen Method ****************************************
...
// ***************In-Process Sample Sub Category Search Data Text Box Method ***************************************
		...
		if (InprocessSamplePage.Scsearchtextbox.isDisplayed()) {
			...
			if (InprocessSamplePage.Scsearchtextbox.isEnabled()) {
				...
				try {
					...
					String testCaseId = "TC-PRO-SAM-0065";
					...
					for (int i = firstRow; i <= lastRow; i++) {
						...
						TestCasePrint("CONFIRM SUB CATEGORY SEARCH DATA", SampleCodeSearchconfirmData,
...
// ***************In-Process Sample Sub Category Reset button Method ****************************************
	@Test(priority = 5)
	public static void InProcessSubCategoryResetbuttonMethod() throws InterruptedException, IOException {
		PageFactory.initElements(driver, inprocesssample);

		Thread.sleep(2000);
		if (InprocessSamplePage.SCreseticon.isDisplayed()) {
			testCase = extent.createTest("INPROCESS SUB CATEGORY RESET BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.SCreseticon.isEnabled()) {
				testCase = extent.createTest("INPROCESS SUB CATEGORY RESET BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.SCreseticon.click();
					Thread.sleep(2000);
				} catch (Exception e) {
		...
		String Values = InprocessSamplePage.SCreseticon.getAttribute("Value");
