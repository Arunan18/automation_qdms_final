...
//* Description
//*------------
//* CANCEL  BUTTON FUNCTIONALITY TEST AND TRAIL INCOMING SAMPLE
//***********************************************************************************
//*
...
//* ================      ====       =====      ========
//*TC-INC-SAM-0238   	11/05/2023   @SASI     	Original Version
//*  
//************************************************************************************

/*
 * TC-INC-SAM-0238	Incoming sample Test & Result Cancel button Functionality
 */
...
//  ******************* EXCEL SHEET DATA ****************************
	...
	public static void selectSampleExcelData() throws InterruptedException, IOException {
		...
		int firstrow = CommonMethods.getFirstRowNum(
				System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx",
				"Incoming Sample", "TC-INC-SAM-0238");
...
// ***************************** CANCEL BUTTON FUNCTIONALITY **********************************	
	...
	public static void okbuttonfunction() throws InterruptedException, IOException {
		PageFactory.initElements(driver, incomingPg);
		if (IncomingSamplePage.cancelbtn.isDisplayed()) {
			testCase = extent.createTest("CANCEL BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (IncomingSamplePage.cancelbtn.isEnabled()) {
				testCase = extent.createTest("CANCEL BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					IncomingSamplePage.cancelbtn.click();
				} catch (Exception e) {
