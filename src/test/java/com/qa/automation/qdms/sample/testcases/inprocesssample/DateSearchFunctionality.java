...
//		DESCRIPTION
//------------------
//					IN-PROCESS SAMPLE DATE SEARCH TEST FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   20:04:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0068	 	 20:04:2023     @SASIKALA     Original Version
//* TC-PRO-SAM-0070
//* TC-PRO-SAM-0072
//*****************************************************************************************

/*
* Process Sample  "Date"  Search Icon UI Functionality - TC-PRO-SAM-0068
* Process Sample  "Date" Text Box UI Functionality - TC-PRO-SAM-0070
* Process Sample  "Date"  Search Button UI Functionality -TC-PRO-SAM-0072 
*/
...
public class DateSearchFunctionality extends DriverIntialization {
	static InprocessSamplePage inprocesssample = new InprocessSamplePage();

	static int ExpectedData = 0;
	static String SampledateSearchconfirmData = "";
...
// ***********************************Excel Method***********************************
	...
	public static void ExcelMethod() throws InterruptedException, IOException {
		...
		String testCaseId = "TC-PRO-SAM-0068";
		...
		for (int i = firstRow; i <= lastRow; i++) {
			...
			SampledateSearchconfirmData = (String) row.getCell(1).getStringCellValue();
...
// ****************IN-PROCESS SAMPLE COUNT NUMBER OF ELEMENTS BEFORE SEARCH*********************
	...
	public static void SampleSearchCountBeforeMethod() throws InterruptedException {
		...
		String NameXpath_lastPart = "]/td[6]";
		while (clickNextPage) {
...
// ***************IN-PROCESS SAMPLE "DATE" SEARCH ICON METHOD************************************
	...
	public static void InProcessSubCategorySearchiconMethod() throws InterruptedException, IOException {
		...
		if (InprocessSamplePage.Datesearchicon.isDisplayed()) {
			...
			if (InprocessSamplePage.Datesearchicon.isEnabled()) {
				...
				try {
					...
					for (int i = 0; i < 100; i++) {
						if (!pass) {
							try {
								InprocessSamplePage.Datesearchicon.click();
								pass = true;
							} catch (Exception e) {
							}
						}
...
// ***************IN-PROCESS SAMPLE "DATE" SEARCH SCREEN METHOD*********************************
	...
	public static void InProcessSubCategorySearchScreenMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		if (InprocessSamplePage.Datesearchpopup.isDisplayed()) {
			testCase = extent.createTest("INPROCESS DATE SEARCH SCREEN VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.Datesearchpopup.isEnabled()) {
				testCase = extent.createTest("INPROCESS DATE SEARCH SCREEN ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.Datesearchpopup.click();
					Thread.sleep(2000);
				} catch (Exception e) {
				...
				testCase = extent.createTest("INPROCESS DATE SEARCH TEXTBOX ENABLED");
				testCase.log(Status.PASS, "TEST FAIL");
			}
		} else {
			testCase = extent.createTest("INPROCESS DATE SEARCH TEXTBOX VISIBLE");
			testCase.log(Status.FAIL, "TEST FAIL");
		}

	}

// ***************IN-PROCESS SAMPLE "DATE" SEARCH DATA TEXT BOX METHOD************************
	...
	public static void InProcessDateSearchdataboxMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		if (InprocessSamplePage.Datesearchtextbox.isDisplayed()) {
			testCase = extent.createTest("DATE SEARCH TEXTBOX IS VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.Datesearchtextbox.isEnabled()) {
				testCase = extent.createTest("DATE SEARCH TEXTBOX IS ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.Datesearchtextbox.click();
					InprocessSamplePage.Datesearchtextbox.sendKeys(SampledateSearchconfirmData);
					Thread.sleep(1000);
					String Value = InprocessSamplePage.Datesearchtextbox.getAttribute("value");
					TestCasePrint("CONFIRM DATE SEARCH", String.valueOf(SampledateSearchconfirmData),
			...
			testCase = extent.createTest("DATE SEARCH TEXTBOX VISIBLE");
			testCase.log(Status.FAIL, "TEST FAIL");
		}

	}

// ***************IN-PROCESS SAMPLE "DATE" SEARCH BUTTON METHOD***********************************
	...
	public static void InProcessDateSearchbuttonMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		if (InprocessSamplePage.Datesearchbutton.isDisplayed()) {
			testCase = extent.createTest("INPROCESS DATE SEARCH BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.Datesearchbutton.isEnabled()) {
				testCase = extent.createTest("INPROCESS DATE SEARCH BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.Datesearchbutton.click();
					Thread.sleep(2000);
				} catch (Exception e) {
...
// ***************IN-PROCESS SAMPLE "DATE" SEARCH AFTER COUNT METHOD**************************
	...
	public static void SampleAftersearchButton() throws InterruptedException, IOException {
		...
		while (clickNextPage) {
			...
			for (int i = 2; i < 103; i++) {
				...
				try {
					String text = driver.findElement(By.xpath(NameXpath_firstPart + i + NameXpath_lastPart)).getText();
					if (text.contains(SampledateSearchconfirmData)) {
		...
		TestCasePrint("CONFIRM DATE SEARCH DATA", String.valueOf(ExpectedData), String.valueOf(AfterCount));
