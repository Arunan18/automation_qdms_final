...
//* ================       ====         =====        ========
//*TC-INC-SAM-0315       16/05/2023   Priyanka     Orginal Version
//*  
//*
//************************************************************************************
...
public class IncSamTrialFailStatus extends DriverIntialization {

	static IncomingSamplePage incomingsample = new IncomingSamplePage();

	@Test
	public static void FailStatusIncSam() throws InterruptedException, IOException {
		...
		IncSamTestTrialInputValue.TestTrialInputValueIncSamFail();

		IncSamTestTrialInputValue.ClickTestResultTestFail();
		...
		Thread.sleep(2000);
		IncSamTestTrialInputValue.FailStatus();
