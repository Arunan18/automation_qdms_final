...
//		DESCRIPTION
//------------------
//					IN-PROCESS SAMPLE SUPPLIER RESET TEST FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   19:04:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0038	 	 19:04:2023     @SASIKALA     Original Version
//* 
//*****************************************************************************************

/*
* Process Sample  "Supplier"  Reset Button UI Functionality - TC-PRO-SAM-0038
*/
...
public class SupplierresetFunctionality extends DriverIntialization {
		...
		if (InprocessSamplePage.Suppliersearchtextbox.isDisplayed()) {
			...
			if (InprocessSamplePage.Suppliersearchtextbox.isEnabled()) {
				...
				try {
					...
					String testCaseId = "TC-PRO-SAM-0038";
					...
					for (int i = firstRow; i <= lastRow; i++) {
						...
						TestCasePrint("CONFIRM SUPPLIER SEARCH DATA", SampleCodeSearchconfirmData,
...
// ***************In-Process Sample Supplier Reset button Method ****************************************
	@Test(priority = 5)
	public static void InProcessCodeResetbuttonMethod() throws InterruptedException, IOException {
		PageFactory.initElements(driver, inprocesssample);

		Thread.sleep(2000);
		if (InprocessSamplePage.Supplierreseticon.isDisplayed()) {
			testCase = extent.createTest("INPROCESS SUPPLIER RESET BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.Supplierreseticon.isEnabled()) {
				testCase = extent.createTest("INPROCESS SUPPLIER RESET BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.Supplierreseticon.click();
					Thread.sleep(2000);
				} catch (Exception e) {
		...
		String Values = InprocessSamplePage.Suppliersearchtextbox.getAttribute("Value");
		TestCasePrint("CONFIRM RESET", "", String.valueOf(Values));
		Thread.sleep(2000);
	}
