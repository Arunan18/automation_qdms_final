...
//		DESCRIPTION
//------------------
//					IN-PROCESS SAMPLE ARRIVAL DATE RESET TEST FUNCTIONALITY
//							Author :-		 @SASIKALA AMBALAVANAR
//							DATE Written:-   27:04:2023	
//****************************************************************************************
//* Test Case Number      	Date          Intis        Comments
//* =================       ======      ========       ========
//* TC-PRO-SAM-0083	 	 27:04:2023     @SASIKALA     Original Version
//* 
//*****************************************************************************************

/*
* Process Sample  "Arrival Date"  Reset Button UI Functionality - TC-PRO-SAM-0083
*/
...
public class ArrivalDateResetFunctionality extends DriverIntialization {
...
// ***************************Reach In-Process Sample**************
	...
	public static void ExcelMethod() throws InterruptedException, IOException {
		...
		String testCaseId = "TC-PRO-SAM-0083";
...
// ****************Count Number of elements Before search**************
	...
	public static void InProcessDateSearchdataboxMethod() throws InterruptedException, IOException {
		PageFactory.initElements(driver, inprocesssample);
		Thread.sleep(2000);
		System.out.println(InprocessSamplePage.ArrivalDatesearchtextbox.isDisplayed() + "*************************");
		if (InprocessSamplePage.ArrivalDatesearchtextbox.isDisplayed()) {
			...
			if (InprocessSamplePage.ArrivalDatesearchtextbox.isEnabled()) {
				...
				try {
					...
					SelectDate.dateSelect("Samples Module.xlsx", "Process Sample", "TC-PRO-SAM-0083-01", 1,
							InprocessSamplePage.ArrivalDatesearchtextbox);
					Thread.sleep(1000);
...
// ***************In-Process Sample Date Reset button Method ****************************************
	...
	public static void InProcessCodeResetbuttonMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		if (InprocessSamplePage.ArrivalDatereseticon.isDisplayed()) {
			testCase = extent.createTest("INPROCESS ARRIVAL DATE RESET BUTTON VISIBLE");
			testCase.log(Status.PASS, "TEST PASS");
			if (InprocessSamplePage.ArrivalDatereseticon.isEnabled()) {
				testCase = extent.createTest("INPROCESS ARRIVAL DATE RESET BUTTON ENABLED");
				testCase.log(Status.PASS, "TEST PASS");
				try {
					InprocessSamplePage.ArrivalDatereseticon.click();
					Thread.sleep(2000);
				} catch (Exception e) {
		...
		String Values = InprocessSamplePage.ArrivalDatereseticon.getAttribute("Value");
		TestCasePrint("CONFIRM ARRIVAL DATE RESET", "null", String.valueOf(Values));
		Thread.sleep(2000);
	}
