...
//* Description
//*------------
//* BL/LC No Reset Functionality in Incoming Samples
//***********************************************************************************
//*
...
//* ================       ====         =====        ========
//*  TC-INC-SAM-0138       25/04/2023   Sayan     Orginal Version
//*
//************************************************************************************
...
public class BLNoResetInComingSample extends DriverIntialization {
	...
	public static void resetContactSearch() throws InterruptedException, IOException {
		...
		int firstrow = CommonMethods.getFirstRowNum(
				System.getProperty("user.dir") + "\\src\\test\\resources\\Excel\\Samples Module.xlsx",
				"Incoming Sample", "TC-INC-SAM-0138");
...
//			STEP-01--RAW MATERIAL TAB IS DISPLAYED & STEP-02--RAW MATERIAL TAB IS ENABLED
		...
		String CodeXpath_lastPart = "]/td[13]";
		while (clickNextPage) {
		...
		try {
			Thread.sleep(1000);
			driver.findElement(
					By.xpath("//div[@class='ant-table-filter-dropdown']//input[@placeholder=' BL/LC No']")).click();
			driver.findElement(
