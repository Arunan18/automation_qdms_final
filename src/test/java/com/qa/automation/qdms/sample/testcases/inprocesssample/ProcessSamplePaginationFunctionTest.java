...
//* Description
//*------------
//* ProcessSamplePaginationFunctionTest
//***********************************************************************************
//*
...
public class ProcessSamplePaginationFunctionTest extends DriverIntialization {
	...
	public static String com= "INPROCESS";
	...
	public static void inCommingPagination() throws InterruptedException, IOException {
  	  ...
  	  Thread.sleep(2000);
		Paginationmethods.pagination("Samples Module", "Process Sample", "TC-PRO-SAM-0016", previousbt, nextbt, pag2nd, pag1st, pagdrp, bef, 4, aft, com);
