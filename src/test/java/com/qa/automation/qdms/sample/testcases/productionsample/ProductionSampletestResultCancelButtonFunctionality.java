...
public class ProductionSampletestResultCancelButtonFunctionality extends DriverIntialization {
  ...
  //************************************************************************************************************			
		 ...
		 if (ProductionSamplePage.teststatuCancelbutton.isDisplayed()) {
				testCase = extent.createTest("STEP-03--TEST STATUS BUTTON CANCEL IS DISPLAYED");
				testCase.log(Status.PASS, "TEST PASS");
					if (ProductionSamplePage.teststatuCancelbutton.isEnabled()) {
					...
					try {
					  	...
					  	Thread.sleep(3000);
					  	ProductionSamplePage.teststatuCancelbutton.click();
